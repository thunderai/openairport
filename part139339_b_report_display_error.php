...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139339_b_discrepancy_report_display_archieved.php
//
//	Purpose of Page			:	View Part 139.339 (b) NOTAM Error History
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "NOTAM Report - Error Summary";								// Name of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
		...
		$dutylogevent	= "NOTAM Report View Error ID ".$_POST['recordid']." summary was viewed.";
