...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_t_p";									// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_sub_vp_name";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_t_p";									// What is the name of the table used for text sorting ?
	...
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_t_p";
		$adatafieldtable[1]		= "tbl_maintenance_sub_t_p";
		$adatafieldtable[2]		= "tbl_maintenance_sub_t_p";
		$adatafieldtable[3]		= "tbl_maintenance_sub_t_p";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_t_p";		
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[1]			= "inventoryfueltankcombobox";
		$adataselect[2]			= "";
