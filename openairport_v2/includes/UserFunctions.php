...
function flogheader() {
	...
	if ($_SESSION["user_id"] == "") {
			...
			?>
<table id="table3" cellspacing="5">
	<tr>
		<td id="login" 		class="headeroption" onMouseOver="this.bgColor='#6D84B4' " onMouseOut="this.bgColor='#3B5998'" onclick="javascript:call_server_contentsection('login.php')" 			style="cursor:hand;">login</td>
		<td id="lregister" 	class="headeroption" onMouseOver="this.bgColor='#6D84B4' " onMouseOut="this.bgColor='#3B5998'" onclick="javascript:call_server_contentsection('register.php')" 			style="cursor:hand;">register</td>
		<td id="help" 		class="headeroption" onMouseOver="this.bgColor='#6D84B4' " onMouseOut="this.bgColor='#3B5998'" onclick="javascript:call_server_contentsection('help.php')"				style="cursor:hand;">help</td>
		</tr>
	</table>
			<?
			}
			...
			?>		
<table border="0" id="table3" cellspacing="5">
	<tr>
		<td id="login" 		class="headeroption" onMouseOver="this.bgColor='#6D84B4' " onMouseOut="this.bgColor='#3B5998'" onclick="window.location='newlogin.php'" 								style="cursor:hand;">log out</td>
		<td id="lregister" 	class="headeroption" onMouseOver="this.bgColor='#6D84B4' " onMouseOut="this.bgColor='#3B5998'" onclick="loadintoIframe('layouttableiframecontent', 'usersettings.php')" style="cursor:hand;">change settings</td>
		<td id="help" 		class="headeroption" onMouseOver="this.bgColor='#6D84B4' " onMouseOut="this.bgColor='#3B5998'" onclick="javascript:call_server_contentsection('help.php')" 				style="cursor:hand;">help</td>
		</tr>
	</table>
			<?
