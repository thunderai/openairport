...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	preflights_tbl_leases_main.php
//
//	Purpose of Page		:	...
//
...
function preflight_tbl_leases_main_a_yn($recordid,$tblarchivedsort) {

		$sql2 = "SELECT * FROM tbl_leases_main WHERE leases_id = ".$recordid." AND lease_archived_yn = 1";												
...
function preflight_tbl_leases_main_c_yn($recordid,$tblarchivedsort) {

		$sql2 = "SELECT * FROM tbl_leases_main WHERE leases_id = ".$recordid." AND lease_treason <> ''";												
		$objconn2 = mysqli_connect("localhost", "webuser", "limitaces", "openairport");						
		if (mysqli_connect_errno()) {
				printf("connect failed: %s\n", mysqli_connect_error());
				exit();
