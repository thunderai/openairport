...
$tmpuserid = $_SESSION["user_id"];
	...
	if (mysqli_connect_errno()) {
			...
			$sql = 	"SELECT 
					...
					WHERE tbl_systemusers.emp_record_id = '".$tmpuserid."' and tbl_navigational_control.menu_item_slaved_to_id = '".$tmpnull."' and tbl_navigational_control.menu_item_name_long <> 'Root' and tbl_navigational_control.menu_item_archived_yn = 0 AND tbl_navigational_control_g_a.navigational_archived_yn = 0  
		...
		<div class="menu">
			<ul>
					...
					?>
				<li class="sub" style="margin-top: 0px;"><a href="javascript:call_server_menuitem_feeder(<?=$tmpmenuitemidl1;?>,'<?=$tmpmenuitemlocl1;?>')" ><?=$tmpmenusshortnl1;?>
				<!--[if IE 7]><!--></a><!--<![endif]-->
					...
					<ul>
										...
										while ($layer2array = mysqli_fetch_array($layer2menures, MYSQLI_ASSOC)) {
											...
											if ($tmpmenuitemlocl2=="unslaved") {
													?>
						<!--maybe-->	<li class="menuitem" style="<!--[if lte IE 6]>margin-top:-4px;<![endif]-->"><a href="javascript:call_server_menuitem_feeder(<?=$tmpmenuitemidl2;?>,'<?=$tmpmenuitemlocl2;?>')" ><?=$tmpmenusshortnl2;?>
													<?
												}
												else {
													?>
							...
							<ul>
															...
															while ($layer3array = mysqli_fetch_array($layer3menures, MYSQLI_ASSOC)) {
																...
																if ($tmpmenuitemlocl3=="unslaved") {
																		?>
						<!--maybe-->	<li class="menuitem" style="<!--[if lte IE 6]>margin-top:-3px;<![endif]-->"><a href="javascript:call_server_menuitem_feeder(<?=$tmpmenuitemidl3;?>,'<?=$tmpmenuitemlocl3;?>')" ><?=$tmpmenusshortnl3;?>
																		<?
																	}
																	else {
																		?>
						<!--maybe-->	<li class="menuitemselect" style="<!--[if lte IE 6]>margin-top:-3px;<![endif]-->">
									<form style="margin: 0px; margin-bottom:0px; margin-top:-1px;" name="menuitem<?=$tmpmenuitemidl3;?>" method="POST" action="<?=$tmpmenuitemlocl3;?>" target="layouttableiframecontent">
										...
										<a href="#" onclick="javascript:document.menuitem<?=$tmpmenuitemidl3;?>.submit()"><?=$tmpmenusshortnl3;?></a>
										</form>
																		<?
																	}	
							...
							<ul>
																				...
																				while ($layer4array = mysqli_fetch_array($layer4menures, MYSQLI_ASSOC)) {
																						...
																						if ($tmpmenuitemlocl4=="unslaved") {
																								?>
						<!--maybe-->	<li class="menuitem" style="<!--[if lte IE 6]>margin-top:-3px;<![endif]-->"><a href="javascript:call_server_menuitem_feeder(<?=$tmpmenuitemidl4;?>,'<?=$tmpmenuitemlocl4;?>')" ><?=$tmpmenusshortnl4;?>
																								<?
																							}
																							else {
																								?>
						<!--maybe-->	<li class="menuitemselect" style="<!--[if lte IE 6]>margin-top:-3px;<![endif]-->">
									<form style="margin: 0px; margin-bottom:0px; margin-top:-1px;" name="menuitem<?=$tmpmenuitemidl4;?>" method="POST" action="<?=$tmpmenuitemlocl4;?>" target="layouttableiframecontent">
										...
										<a href="#" onclick="javascript:document.menuitem<?=$tmpmenuitemidl4;?>.submit()"><?=$tmpmenusshortnl4;?></a>
										</form>
																								<?
																							}	
