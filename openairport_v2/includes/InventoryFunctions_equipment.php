<?
function inventoryequipmentcombobox($suppliedid, $archived, $nameofinput, $showcombobox, $default) {
	...
	$sql = "SELECT * FROM tbl_inventory_sub_e INNER JOIN tbl_organization_main ON tbl_inventory_sub_e.equipment_manufac_cb_int = tbl_organization_main.Organizations_id ";											// start the SQL Statement with the common syntax
	...
	$nsql = "ORDER BY equipment_modelyear, org_name ";
	$sql = $sql.$nsql;
	//echo $sql;
	...
	<SELECT class="Commonfieldbox" name="<?=$nameofinput?>">
					...
					while ($objfields = mysqli_fetch_array($objrs_support, MYSQLI_ASSOC)) {
							...
							$tmpsuppliedyear 	= $objfields['equipment_modelyear'];
