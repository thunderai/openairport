...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Vehicle Parts Data Browse.php			The purpose of this page is to browse Vehicle Parts
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_v_p";									// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_sub_vp_name";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_v_p";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_sub_vp_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Vehicle Part Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_v_p";
		$adatafieldtable[1]		= "tbl_maintenance_sub_v_p";
		$adatafieldtable[2]		= "tbl_maintenance_sub_v_p";
		$adatafieldtable[3]		= "tbl_maintenance_sub_v_p";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_v_p";
		$adatafieldtable[5]		= "tbl_maintenance_sub_v_p";
		$adatafieldtable[6]		= "tbl_maintenance_sub_v_p";	
		$adatafieldtable[7]		= "tbl_maintenance_sub_v_p";		
