...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Timesheet Main Browse.php			The purpose of this page is to list of all the users Timesheets
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblarchivedfield		= "timesheet_archieved_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Timesheets Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functioneditpage 		= "timesheet_main_edit.php";									// Name of page used to edit the record
		$functionsummarypage 		= "summary_report_general.php";									// Name of page used to display a summary of the record
		$functionprinterpage 		= "timesheet_main_report.php";									// Name of page used to display a printer friendly report
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "timesheet_month_cb_int";
		$adatafield[1]			= "timesheet_archived_yn";
	...
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "timesheet_month_cb_int";
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[1]		= "No special characters";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "timesheetmonthscombobox";
		$adataselect[1]			= "";
...
if ($tbltextsort==1) {
	...
	$sql = $sql." WHERE timesheet_systemuser_id_cb_int ='".$_SESSION['user_id']."' ";
