...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Pavement Layers (parts) entry.php		The purpose of this page is to browse Pavement Parts (Layers)
								...
								THIS PAGE CREATES A FIEL RECORDS AUTOMATICALLY. IT CREATES UNSCHEDULED MAINTENANCE AND CRACK SEALING
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "pavement_id";										// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "pavement_dateborn";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_pv";									// What table  is that field part of ?
		$tbltextsortfield		= "pavement_name";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_pv";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "pavement_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Pavement Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "pavement_dateborn";
		$adatafield[1]			= "pavement_name";
		$adatafield[2]			= "pavement_remarks";
		$adatafield[3]			= "pavement_xpoints";
		$adatafield[4]			= "pavement_ypoints";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_inventory_sub_pv";
		$adatafieldtable[1]		= "tbl_inventory_sub_pv";
		$adatafieldtable[2]		= "tbl_inventory_sub_pv";
		$adatafieldtable[3]		= "tbl_inventory_sub_pv";
		$adatafieldtable[4]		= "tbl_inventory_sub_pv";
	...
	// what do you want to name the columns
		...
		$aheadername[0]			= "Date";
		$aheadername[1]			= "Name";
		$aheadername[2]			= "Remarks";
		$aheadername[3]			= "Xpoints";
		$aheadername[4]			= "Ypoints";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the date this pavement was created";
		$ainputcomment[1]		= "Please enter the name of this pavement section";
		$ainputcomment[2]		= "Please enter any remarks";
		$ainputcomment[3]		= "Please enter the Xpoints";
		$ainputcomment[4]		= "Please enter the Ypoints";
...
if (!isset($_POST["formsubmit"])) {
		...
		for ($i=0; $i<count($aheadername); $i=$i+1) {
				...
				?>
										<tr>
											...
											<td class="formanswers">
												<INPUT class="formsubmit" TYPE="button" VALUE="Map Pavement Location" onClick="openChild2('mapdrawit.php?xpoints=<?=$adatafield[3]?>&ypoints=<?=$adatafield[4];?>','Win2')">
												</td>
											</tr>	
										<tr>
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent		= "New Pavement ID:".$lastid." Was Created";
		$tmplastid			= $lastid;
		
		autodutylogentry($tmpsqldate,$tmpsqltime,$tmpsqlauthor,$dutylogevent);
		
		$pavement_id		= $tmplastid;
		$event_id			= 10;																	// HACK to provide this auto enty the ID of the Un-Scheduled Maintenance Event ID
		$years			= 0;
		
		autocmxevent_pavement($tmpsqldate,$pavement_id,$event_id,$years);
		
		$pavement_id		= $tmplastid;
		$event_id			= 12;																	// HACK to provide this auto enty the ID of the Un-Scheduled Maintenance Event ID
		$years			= 5;
