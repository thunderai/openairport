...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	FuelFlow Sub V Distribution.php
//
...
if (!isset($_POST["formsubmit"])) {
		...
		?>
		<form name="Show" action="fuelflow_sub_v_distribution_report.php" method="POST" name="linechartform" id="linechartform" target="linechartWindow" onsubmit="window.open('', 'linechartWindow', 'width=750,height=550,status=no,resizable=yes,scrollbars=yes')">
