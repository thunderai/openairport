...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.337 Sub AN Browse.php		The purpose of this page is to list the Actions used in the Wildlife Management Form
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "139337_sub_ay_id";													// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";																// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_139_337_sub_ay";													// What table  is that field part of ?
		$tbltextsortfield		= "139337_sub_ay_name";													// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_139_337_sub_ay";													// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "13337_sub_ay_archived_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Activity Types Summary Report";										// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "139337_sub_ay_name";
		$adatafield[1]			= "139337_sub_ay_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_337_sub_ay";
		$adatafieldtable[1]		= "tbl_139_337_sub_ay";			
