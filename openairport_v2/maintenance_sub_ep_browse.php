...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Equipment Parts Data Browse.php			The purpose of this page is to browse Vehicle Parts
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "maintenance_sub_vp_id";										// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_maintenance_sub_e_p";									// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_sub_vp_name";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_e_p";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_sub_vp_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Equipment Part Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "maintenance_sub_vpp_cb_int";
		$adatafield[1]			= "maintenance_sub_vpv_cb_int";
		$adatafield[2]			= "maintenance_sub_vp_name";
		$adatafield[3]			= "maintenance_sub_vpo_cb_int";
		$adatafield[4]			= "maintenance_sub_vp_modelnumber";
		$adatafield[5]			= "maintenance_sub_vp_serialnumber";
		$adatafield[6]			= "maintenance_sub_vp_vinnumber";
		$adatafield[7]			= "maintenance_sub_vp_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_e_p";
		$adatafieldtable[1]		= "tbl_maintenance_sub_e_p";
		$adatafieldtable[2]		= "tbl_maintenance_sub_e_p";
		$adatafieldtable[3]		= "tbl_maintenance_sub_e_p";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_e_p";
		$adatafieldtable[5]		= "tbl_maintenance_sub_e_p";
		$adatafieldtable[6]		= "tbl_maintenance_sub_e_p";	
		$adatafieldtable[7]		= "tbl_maintenance_sub_e_p";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "maintenance_sub_vpp_cb_int";
		$adatafieldid[1]		= "maintenance_sub_vpv_cb_int";
		$adatafieldid[2]		= "justsort";
		$adatafieldid[3]		= "maintenance_sub_vpo_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[0]			= "Part Type";
		$aheadername[1]			= "Equipment";
		$aheadername[2]			= "Name";
		$aheadername[3]			= "Supplier";
		$aheadername[4]			= "Model #";
		$aheadername[5]			= "Serial #";
		$aheadername[6]			= "VIN #";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "maintenancepartscombobox";
		$adataselect[1]			= "inventoryequipmentcombobox";
		$adataselect[2]			= "";
