...
// Establish Page Name			
		$pagename = 'ADMIN - Hide a Current User';		
...
// Load Saved Search Data
	$sql = "UPDATE tbl_users SET user_archived_yn = 1 WHERE user_id = '".$tmp_searchid."' ";
	...
	if (mysqli_connect_errno()) {
			...
			<tr>
				<td class="newTopicNames">
					Selected User has been deleted. You may continue on your way.
					</td>
				</tr>
			<?
