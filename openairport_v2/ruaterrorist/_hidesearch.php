...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	_hidesearch.php
//
//	Purpose of Page		:	FORM SIDE 	- Allows User to Hide selected Saved Searchs
...
// Establish Page Name			
		$pagename = 'Hide Selected Saved Search';
	...
	<BODY>
		<table width="100%" Class="windowMain" CELLSPACING=1 CELLPADDING=2>
			<tr>
				<td>
					<?
					breadcrumbs('_hidesearch.php', $pagename);
...
// Load Saved Search Data
	$sql = "UPDATE tbl_users_searchs SET user_s_archived_yn = 1 WHERE user_s_id = ".$_POST['searchid']." ";
	...
	if (mysqli_connect_errno()) {
			...
			<tr>
				<td class="newTopicNames">
					The Query has been deleted<br><br>You may now close this window
					</td>
				</tr>
			<?
	...
	$function = "Made Changes to Saved Search with the following SQL Statement [ ".$sql." ]";
	put_systemactivity($_SESSION["user_id"],$function);
