	...
	<BODY bgcolor="#FFFFFF">
		<table width="100%" Class="windowMain" CELLSPACING=1 CELLPADDING=2>
			...
			$sql = "SELECT * FROM tbl_users_notice 
					WHERE user_n_parent_id = '".$_POST['userid']."' AND user_n_archived_yn = 0";
							...
							while ($objfields = mysqli_fetch_array($objrs_support, MYSQLI_ASSOC)) {			
									...
									<tr>
										<td class="newTopicBoxes">
											<table>
												<tr>
													<form action="nimba_runsearch.php" METHOD="POST" target="layouttableiframecontent" style="margin: 0px; margin-bottom:0px; margin-top:-1px;">
														<td>
														<input type="hidden" name="userid" 		value="<?=$_POST['userid'];?>">
										...
										if (mysqli_connect_errno()) {
												...
												if ($objrs_support2) {
														...
														if ($number_of_rows2 == 0) {
																...
																<tr>
																	<td class="newTopicNames" colspan="5" align="center">
																		There is an Error. The related search that was run has been deleted or unavilable.
																		</td>
																	</tr>
																<?
															}
