...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	nimba_hideallapplicants.php
//
...
// Establish Page Name			
		$pagename = 'ADMIN - Hide all unprocessed Applicants';		
...
// Load Saved Search Data
	$sql = "UPDATE tbl_users_applicants SET user_a_archived_yn = 1 ";
	...
	if (mysqli_connect_errno()) {
			...
			<tr>
				<td class="newTopicNames">
					All unprocessed Applicants have been removed. You may continue on your way.
					</td>
				</tr>
			<?
