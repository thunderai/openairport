...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Pavement Maintenance Event Browse.php	The purpose of this page is to browse Pavement Maintenance Events
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_pv_e";									// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_pv_e";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_sub_ve_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Pavement Mx Events Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[2]			= "maintenance_sub_ve_date";
		$adatafield[3]			= "maintenance_sub_ve_years";
		$adatafield[4]			= "maintenance_sub_ve_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_pv_e";
		$adatafieldtable[1]		= "tbl_maintenance_sub_pv_e";
		$adatafieldtable[2]		= "tbl_maintenance_sub_pv_e";
		$adatafieldtable[3]		= "tbl_maintenance_sub_pv_e";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_pv_e";			
	...
	// what do you want to name the columns
		...
		$aheadername[0]			= "Event";
		$aheadername[1]			= "Pavement Panel";
		$aheadername[2]			= "Date";
		$aheadername[3]			= "Years";
		$aheadername[4]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please select the type of maintennace event from the list to the right";
		$ainputcomment[1]		= "Please select the pavement panel for this maintenance event from the list to the right";
		$ainputcomment[2]		= "Please enter a date for when this event is set to occure";
		$ainputcomment[3]		= "Please enter the number of years this event is scheduled to occure";
