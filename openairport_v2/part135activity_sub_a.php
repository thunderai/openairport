...
*/	
	// Load Required Include Files
		...
		$tblsubname	= "For the current Part 135 Monthly Summary Report";
	...
	<tr>
		<td colspan="3" class="tablesubcontent">
			<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
				<tr>
					<?
					$sql = "SELECT * FROM tbl_activity_135_main WHERE activity_135_id = '".$_POST['recordid']."' ";
					...
					if (mysqli_connect_errno()) {
							...
							if ($res) {
									...
									while ($objfields = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
											$tmpdate	= $objfields['activity_135_date'];
											$tmpoper	= $objfields['activity_135_operator_cb_int'];
											$tmptland	= $objfields['activity_135_totallandings'];									
											}
								}
						}
						?>
			...
			<table border="0" width="100%" cellspacing="4">
				<tr>
					<td class="formresultscount">
						...
						$sql = "SELECT * FROM tbl_activity_135_sub_a  WHERE aircraft_activity_main_id = '".$_POST['recordid']."' ";
						...
						<table cellspacing="0" width="100%">
							...
							<tr>
								<td class="formoptionsavilablebottom">
									<table>
										<tr>
											<form style="margin-bottom:0;" action="part135activity_sub_a_entry.php"method="POST" name="addaircraftform" id="addaircraftform" target="addaircraftWindow" onsubmit="window.open('', 'addaircraftWindow', 'width=600,height=250,status=no,resizable=no,scrollbars=yes')">
						...
						<table border="0" width="100%" id="table1" cellpadding="0" cellspacing="1"  style="border-collapse: collapse">
							...
							<tr>
								<td height="32" align="center" class="formresults">
									<?
									$tmpid = $objarray['aircraft_activity_135_id'];
									?>
									<?=$objarray['aircraft_activity_135_id'];?>
									</td>
								<td align="center" class="formresults">
									<table border="1" width="50" cellspacing="0" id="table1" class="formsubmit cellpadding="0">
										<tr>
											<form style="margin-bottom:0;" action="part135activity_sub_a_a_entry.php" method="POST" name="editform" id="editform">
											<td class="formoptionsubmit">
											...
											<form style="margin-bottom:0;" action="part135activity_sub_a_e_entry.php" method="POST" name="editform" id="editform">
											<td class="formoptionsubmit">
												<input type="hidden" name="conditionid" 		value="<?=$_POST['conditionid'];?>">
												<input type="hidden" name="recordid" 			value="<?=$_POST['recordid'];?>">
												<input type="hidden" name="checklistid" 		value="<?=$_POST['checklistid'];?>">
								...
								<td align="center" class="formresults">
									<? 
									$tmptype = $objarray['aircraft_activity_135_type_cb_int'];
									aircraftcombobox($tmptype, "all", "all", "hide", "all");
									?>
									</td>
								<td height="32" align="center" class="formresults">
									<?=$objarray['aircraft_activity_135_landings'];?>
									</td>
								<td height="32" align="center" class="formresults">
									<?=$objarray['aircraft_activity_135_overnight'];?>
									</td>
								</tr>
								<?
											}
