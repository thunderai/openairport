...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_p_p";									// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_sub_vp_name";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_p_p";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_sub_vp_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Property Part Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "maintenance_sub_vpv_cb_int";
		$adatafield[1]			= "maintenance_sub_vp_name";
		$adatafield[2]			= "maintenance_sub_vp_widthfeet";
		$adatafield[3]			= "maintenance_sub_vp_lengthfeet";
		$adatafield[4]			= "maintenance_sub_vp_squarefeet";
		$adatafield[5]			= "maintenance_sub_vp_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_p_p";
		$adatafieldtable[1]		= "tbl_maintenance_sub_p_p";
		$adatafieldtable[2]		= "tbl_maintenance_sub_p_p";
		$adatafieldtable[3]		= "tbl_maintenance_sub_p_p";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_p_p";
		$adatafieldtable[5]		= "tbl_maintenance_sub_p_p";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "maintenance_sub_vpv_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[0]			= "Property";
		$aheadername[1]			= "Property Part Name";
		$aheadername[2]			= "Width";
		$aheadername[3]			= "Length";
		$aheadername[4]			= "Square Feet";
		$aheadername[5]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please select the property from the list to the right";
		$ainputcomment[1]		= "Please enter a name for this part of the property";
		$ainputcomment[2]		= "Please enter the width of this property";
		$ainputcomment[3]		= "Please enter the length of this property";
		$ainputcomment[4]		= "Please enter the total square feet for this property";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "inventorypropertycombobox";
		$adataselect[1]			= "";
		$adataselect[2]			= "";
		$adataselect[3]			= "";
		$adataselect[4]			= "";
