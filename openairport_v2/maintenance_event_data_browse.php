...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Maintenance event Browse.php		The purpose of this page is to browse Maintenance Events
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "mxevent_id";													// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_maintenance_sub_e";										// What table  is that field part of ?
		$tbltextsortfield		= "mxevent_name";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_e";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "mxevent_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Maintenance Event Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "mxevent_name";
		$adatafield[1]			= "mxevent_ascpart_cb_int";
		$adatafield[2]			= "mxevent_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_e";
		$adatafieldtable[1]		= "tbl_maintenance_sub_e";
		$adatafieldtable[2]		= "tbl_maintenance_sub_e";				
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		= "mxevent_ascpart_cb_int";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "maintenancepartscombobox";
		$adataselect[2]			= "";
