...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	Part139327 Main Browse.php
//
//	Purpose of Page		:	This page allows a user to look at all of the Part 327 Inspections
//							
//							
//
								...
								<td class="formoptionsavilablebottom">
									<table>
										<tr>
											...
											?>
											<td class="formoptionsubmit" onclick="window.open('part139327_main_calendar.php?frmurl=<?=$encoded;?>&frmstartdate=<?=$uifrmstartdate ;?>&frmenddate=<?=$uifrmenddate ;?>','printerfriendlyreport','width=750,height=550');">
												&nbsp;Calendar Printout&nbsp;
												</td>
											...
											<td class="formoptionsubmit" onclick="window.open('part139327_main_Inspcalendar.php?frmurl=<?=$encoded;?>&frmstartdate=<?=$uifrmstartdate ;?>&frmenddate=<?=$uifrmenddate ;?>','printerfriendlyreport','width=750,height=550,scrollbars=1');">
												&nbsp;Hard Coded Insp Calc&nbsp;
												</td>
											</tr>
										</table>
									</td>
