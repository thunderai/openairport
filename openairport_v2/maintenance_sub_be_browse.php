...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Building Maintenance Event Browse.php	The purpose of this page is to browse Building Maintenance Events
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_b_e";									// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_b_e";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_sub_ve_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Fuel Tank Events Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[3]			= "maintenance_sub_ve_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_b_e";
		$adatafieldtable[1]		= "tbl_maintenance_sub_b_e";
		$adatafieldtable[2]		= "tbl_maintenance_sub_b_e";
		$adatafieldtable[3]		= "tbl_maintenance_sub_b_e";		
