...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "menu_item_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_quickinfo_control";											// What table  is that field part of ?
		$tbltextsortfield		= "menu_item_purpose";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_quickinfo_control";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "menu_item_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Quick Info Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_quickinfo_control";
		$adatafieldtable[1]		= "tbl_quickinfo_control";
		$adatafieldtable[2]		= "tbl_quickinfo_control";
		$adatafieldtable[3]		= "tbl_quickinfo_control";
	...
	// what do you want to name the columns
		...
		$aheadername[1]			= "Name (Long)";
		$aheadername[2]			= "Name (Short)";
		$aheadername[3]			= "Purpose";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Location:<br><br>In this field please provide the name of the function that will load this quickinfo item";
		$ainputcomment[1]		= "Name (Long):<br><br>In this field please provide the name of the quick info item that will be displayed on reports, etc.";
		$ainputcomment[2]		= "Name (Short):<br><br>In this field please provide the name of the quick info item that will be displayed on the computer screen";
		$ainputcomment[3]		= "Purpose:<br><br>What does this quick info item do?";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Quick Info Item Added";
