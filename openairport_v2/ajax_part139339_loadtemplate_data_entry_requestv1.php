...
//	0--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--90--3--6--9
	...
	// Step 6: If checklist is not no, then we need to build the real tmpstring variable with all of the proper connections
		...
		$sql = "SELECT 139339_main_t_purpose FROM tbl_139_339_main_t WHERE `139339_main_t_id` = ".$InspCheckList." ";														// start the SQL Statement with the common syntax
		//echo $sql;
		...
		$sql = "SELECT 139339_main_t_notes FROM tbl_139_339_main_t WHERE `139339_main_t_id` = ".$InspCheckList." ";														// start the SQL Statement with the common syntax
		//echo $sql;
		...
		WHERE `139339_main_t_id` = ".$InspCheckList." ";														// start the SQL Statement with the common syntax
		//echo $sql;
							...
							while ($objfields = mysqli_fetch_array($objrs_support, MYSQLI_ASSOC)) {
								...
								if($element_type==1) {
										...
										if ($tmpvalue!=1) {
												...
												$tmpnewstring 	= "<input class='Commonfieldbox' type='checkbox' name=".$tmpcondnamestr." value='1'>";												
												$tmpstring 	= $tmpstring.$tmpnewstring;												
												$tmpstring 	= $tmpstring."|";
											}
											else {
												$tmpstring		= ($tmpstring."1|".$tmpcondnamestr."_td|");												
												$tmpnewstring 	= "<input class='Commonfieldbox' type='checkbox' name=".$tmpcondnamestr." value='1' CHECKED>";												
												$tmpstring 	= $tmpstring.$tmpnewstring;												
												$tmpstring 	= $tmpstring."|";
											}
									}
