...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	TimeSheet Main Save.php			The purpose of this page is to save a timesheet based on the data provided on the main page
...
*/	
	...
	// STEP ONE : SAVE TIMESHEET TO tbl_timesheet_main
		...
		$sql = "INSERT INTO tbl_timesheets_main (timesheet_systemuser_id_cb_int, timesheet_month_cb_int ) VALUES ('".$_POST['inspector']."','".$_POST['timesheetmonthid']."')";
												...
												<table cellspacing="0" width="100%">
													...
													<tr>
														...
														<td class="formoptionsubmit">
															<input type="hidden" name="recordid" 			value="<?=$k;?>">
