...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Accounting Payment Entry.php			The purpose of this page is to enter new Payment Items for the Accounting system
...
*/	
	...
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "leases_budget_t_id_cb_int";
		$adatafieldid[3]		= "leases_budget_f_id_cb_int";
...
if (!isset($_POST["formsubmit"])) {
		...
		for ($i=0; $i<count($aheadername); $i=$i+1) {
				...
				switch ($ainputtype[$i]) {
						...
						case "SELECT":	// if user entered "SELECT" as the input type make a select box
								...
								switch ($aheadername[$i]) {	
										case "Type of Lease":
												$adataselect[$i]("all", "all", $adatafield[$i], "show", "",$adatafield[$i+1]);
												break;
										case "Budget Type":	
												budget_category_with_funds_comboboxs("all", "all", $adatafield[$i],$adatafield[$i+1], "show", "");
												break;
										default:
	...
	//$adataselect[2]			= "leasetypescomboboxnoajax";
	//$adataselect[2]			= "leasetypescomboboxnoajax";
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent		= "New Lease ID:".$lastid." Was Created";
