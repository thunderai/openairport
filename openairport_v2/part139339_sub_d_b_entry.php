...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.327 D B Entry.php			The purpose of this page is to enter new Discrepancies which have been bounced
...
*/	
	// Load Required Include Files
		...
		$tblname		= "Add New Discrepancy Bounce";
...
if (!isset($_POST["formsubmit"])) {
		...
		?>
						<form action="<?=$_SERVER["PHP_SELF"];?>" method="post" name="edittable" id="edittable">
							...
							<input type="hidden" name="did" 			value="<?=$_POST['did'];?>">
								...
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<td class="formanswers">
												<input type="checkbox" class="commonfieldbox" name="disbounce" CHECKED value="1">
												</td>
											</tr>												
										<tr>
		...
		VALUES ( '".$_POST['did']."', '".$_POST['disauthor']."', '".$_POST['discomments']."', '".$sqldate."', '".$_POST['distime']."', '".$_POST['disbounce']."' )";
		...
		$dutylogevent	= "Added New Discrepancy Bounce Record for Discrepancy ID ".$_POST['did'];
