...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Inventory Fuel Tanks Browse.php		The purpose of this page is to list of the different fuel tanks
...
*/	
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "inventory_tanks_dateinstalled";
		$adatafield[1]			= "inventory_tanks_type_cb_int";
		$adatafield[2]			= "inventory_tanks_manufac_cb_int";
		$adatafield[3]			= "inventory_tanks_serialnumber";
		$adatafield[4]			= "inventory_tanks_modelnumber";
		$adatafield[5]			= "inventory_tanks_totalcapacity";
		$adatafield[6]			= "inventory_tanks_currentcapacity";
		$adatafield[7]			= "inventory_tanks_archived_yn";
	// in each array specified above, what table does that field come from?
		...
		$adatafieldtable[3]		= "tbl_inventory_sub_tanks";
		$adatafieldtable[4]		= "tbl_inventory_sub_tanks";
		$adatafieldtable[5]		= "tbl_inventory_sub_tanks";
		$adatafieldtable[6]		= "tbl_inventory_sub_tanks";
		$adatafieldtable[7]		= "tbl_inventory_sub_tanks";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		= "inventory_tanks_type_cb_int";
		$adatafieldid[2]		= "inventory_tanks_manufac_cb_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Date";
		$aheadername[1]			= "Type";
		$aheadername[2]			= "Manufactuer";
		$aheadername[3]			= "Serial";
		$aheadername[4]			= "Model";
		$aheadername[5]			= "Total Capacity";
		$aheadername[6]			= "Current Capacity";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "inventoryfueltanktypescombobox";
