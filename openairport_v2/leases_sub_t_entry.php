...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "tbl_gtr_t_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_general_tblrlshp";											// What table  is that field part of ?
		$tbltextsortfield		= "tbl_gtr_t_name";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_general_tblrlshp";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "tbl_gtr_t_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Lease Types Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "tbl_gtr_t_name";
		$adatafield[1]			= "tbl_gtr_t_tablename";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_leases_terms";
		$adatafieldtable[1]		= "tbl_leases_terms";		
	...
	// what do you want to name the columns
		$aheadername[0]			= "Name";
		$aheadername[1]			= "Function Name";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the name of this lease type";
		$ainputcomment[1]		= "Please enter the name of the function that will display the content of this type";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Aircraft Type ID: ".$lastid." Was Created";
