...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "conditions_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_139_327_sub_c";											// What table  is that field part of ?
		$tbltextsortfield		= "condition_name";											// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_139_327_sub_c";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "conditions_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Summary of Inspection Conditions";								// What is the name of the table ? (used on edit/summary/printer report pages)
		...
		$dutylogevent			= "";															// What will the auto duty log entry say
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "condition_name";
		$adatafield[1]			= "condition_facility_cb_int";
		$adatafield[2]			= "condition_type_cb_int";
		$adatafield[3]			= "condition_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_327_sub_c";
		$adatafieldtable[1]		= "tbl_139_327_sub_c";
		$adatafieldtable[2]		= "tbl_139_327_sub_c";
		$adatafieldtable[3]		= "tbl_139_327_sub_c";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		= "condition_facility_cb_int";
		$adatafieldid[2]		= "condition_type_cb_int";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "part139327facilitycombobox";
