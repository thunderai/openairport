...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "access_pc_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "access_pc_date";												// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_access_sub_a_pc";												// What table  is that field part of ?
		$tbltextsortfield		= "";											// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_access_sub_a_pc";												// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "access_pc_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Access Control Proxy Card Summary Log";									// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "access_pc_date";
		$adatafield[1]			= "access_pc_time";
		$adatafield[2]			= "access_pc_by_cb_int";
		$adatafield[3]			= "access_pc_towhom_cb_int";
		$adatafield[4]			= "access_pc_fromwhom_cb_int";
		$adatafield[5]			= "access_pc_numberpc_in";
		$adatafield[6]			= "access_pc_numberpc_out";
		$adatafield[7]			= "access_pc_number";
		$adatafield[8]			= "access_pc_keytype_cb_int";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_access_sub_a_pc";
		$adatafieldtable[1]		= "tbl_access_sub_a_pc";
		$adatafieldtable[2]		= "tbl_access_sub_a_pc";
		$adatafieldtable[3]		= "tbl_access_sub_a_pc";
		$adatafieldtable[4]		= "tbl_access_sub_a_pc";
		$adatafieldtable[5]		= "tbl_access_sub_a_pc";
		$adatafieldtable[6]		= "tbl_access_sub_a_pc";
		$adatafieldtable[7]		= "tbl_access_sub_a_pc";
		$adatafieldtable[8]		= "tbl_access_sub_a_pc";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "access_pc_by_cb_int";
		$adatafieldid[3]		= "access_pc_towhom_cb_int";
		$adatafieldid[4]		= "access_pc_fromwhom_cb_int";
		$adatafieldid[5]		= "notjoined";
		$adatafieldid[6]		= "notjoined";
		$adatafieldid[7]		= "notjoined";
		$adatafieldid[8]		= "access_pc_keytype_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "pc To";
		$aheadername[4]			= "pc From";
		$aheadername[5]			= "# pc In";
		$aheadername[6]			= "# pc Out";
		$aheadername[7]			= "# on Card";
		$aheadername[8]			= "Type of pc";
	// Any special comments to make after the input box?
		...
		$ainputcomment[7]		= "Please enter the number on the PC Card or Range of Cards";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[4]			= "organizationcombobox";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
		$adataselect[7]			= "";
		$adataselect[8]			= "inventoryaccesspctypescombobox";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Access Proxy Card Transaction ID:".$lastid." Was Created";
		...
		$tmpsqltime		= date("H:i:s");
		$tmpsqlauthor	= $_SESSION["user_id"];
		$tmpsqltype		= $_POST[$adatafield[8]];
		

		$tmpsqlnumbpc	= ($_POST[$adatafield[5]]) + ($_POST[$adatafield[6]] * -1);
		
		
		// Add or subtract from Not Programmed
		// Add or subtract from the given account.
		
					
		$dutylogevent		= "Auto Entry to adjust the amount of Proxy Cards in inventory. Total adjusted".$tmpsqlnumbpc."";
		autoinventoryaccesspcentry($tmpsqldate,$tmpsqltime,$tmpsqlauthor,$dutylogevent,$tmpsqltype,$tmpsqlnumbpc);
		?>
