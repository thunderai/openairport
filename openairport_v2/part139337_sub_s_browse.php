...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.337 Sub S Browse.php		The purpose of this page is to list the Species used in the Wildlife Management Form
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "139337_sub_s_id";													// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";																// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_139_337_sub_s";													// What table  is that field part of ?
		$tbltextsortfield		= "139337_sub_s_name";													// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_139_337_sub_s";													// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "13337_sub_s_archived_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Species Types Summary Report";										// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "139337_sub_s_name";
		$adatafield[1]			= "139337_sub_s_statepermit";
		$adatafield[2]			= "139337_sub_s_federalpermit";
		$adatafield[3]			= "139337_sub_s_category";
		$adatafield[4]			= "139337_sub_s_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_337_sub_s";
		$adatafieldtable[1]		= "tbl_139_337_sub_s";	
		$adatafieldtable[2]		= "tbl_139_337_sub_s";
		$adatafieldtable[3]		= "tbl_139_337_sub_s";	
		$adatafieldtable[4]		= "tbl_139_337_sub_s";			
	...
	// what do you want to name the columns
		$aheadername[0]			= "Name";
		$aheadername[1]			= "State Permit";
		$aheadername[2]			= "Federal Permit";
		$aheadername[3]			= "Category";
		$aheadername[4]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the name of the species";
		$ainputcomment[1]		= "If this species requires a state permit, please check the box";
		$ainputcomment[2]		= "If this species requires a federal permit, please check the box";
		$ainputcomment[3]		= "Please type the cateogry this species of animal belongs in";
		$ainputcomment[4]		= "( Checked = Archived )";
	// what type of input is this field?
		// this can be any type of input
		// text, textarea, select, etc.
		$ainputtype[0]			= "TEXT";
		$ainputtype[1]			= "CHECKBOX";
