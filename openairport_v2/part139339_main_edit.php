...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Edit Part 139.339 Inspections.php		The purpose of this file is to edit Inspections
...
if (!isset($_POST["inspectionid"])) {
		...
		if (!isset($_POST["formsubmit"])) {
				...
				// Connect to Database
				$nsql =" WHERE 139339_main_id = ".$_POST["inspectionid"]."";
				$sql = $sql.$nsql;
				//echo $sql;
				...
				if (mysqli_connect_errno()) {
						...
						<table border="0" width="100%" id="tblbrowseformtable" cellspacing="0" cellpadding="0">
											...
											<td class="formoptionsavilablebottom">
												<table>
													<tr>
														...
														?>
														<form style="margin-bottom:0;" action="part139339_main_a_entry.php" method="POST" name="archiveform" id="archiveform" target="ArchiveWindow" onsubmit="window.open('', 'ArchiveWindow', 'width=600,height=500,status=no,resizable=no,scrollbars=yes')">
														<td class="formoptionsubmit">
															<input type="hidden" name="inspectionid" 		value="<?=$objarray['139339_main_id'];?>">
															<input type="submit" value="Mark Archived" name="b1" class="formsubmit">
															</td>
														</form>
														<form style="margin-bottom:0;" action="part139339_main_e_entry.php" method="POST" name="archiveform" id="archiveform" target="ArchiveWindow" onsubmit="window.open('', 'ArchiveWindow', 'width=600,height=550,status=no,resizable=no,scrollbars=yes')">
														<td class="formoptionsubmit">
															<input type="hidden" name="inspectionid" 		value="<?=$objarray['139339_main_id'];?>">
							...
							<tr>
								...
								<td class="formanswers">
									<input class="Commonfieldbox" type="text" name="distime" size="10" value="<?=$objarray['139339_time'];?>">
									</td>
								</tr>	
							<tr>
								...
								<td class="formanswers">
									<?
									systemusercombobox($objarray['139339_by_cb_int'], "all", "disauthor", "show", $objarray['139339_by_cb_int']);
									?>
									</td>
								</tr>											
							<tr>
								...
								<td class="formanswers">
									<?
									part139339typescombobox($objarray['139339_type_cb_int'], "all", "distype", "show", $objarray['139339_type_cb_int']);
									?>
									</td>
								</tr>
							<tr>
								...
								<td class="formanswers">
									<input class="Commonfieldbox" type="text" name="frmmetar" size="30" value="<?=$objarray['139339_metar'];?>">
									</td>
								</tr>
							<tr>
								<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('24 Hour Time')"; onMouseout="hideddrivetip()">
								...
								<td class="formanswers">
									<textarea name="frmnotes" Rows="5" cols="60"><?=($objarray['139339_notes']);?></textarea>
									</td>
								</tr>
							<tr>
								<td colspan="2">
				...
				?>
						...
						<table border="0" width="100%" id="tblbrowseformtable" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="tableheaderright">
									(Use to make changes to the Field Condition Report)
									</td>
								</tr>
							<tr>
								<td colspan="3" class="tablesubcontent">
		...
		$sql = "UPDATE tbl_139_339_main SET 139339_type_cb_int='".$_POST['distype']."', 139339_by_cb_int='".$_POST['disauthor']."', 139339_date='".$tmpdate."', 139339_time='".$_POST['distime']."', 139339_metar='".$_POST['frmmetar']."', 139339_notes='".$_POST['frmnotes']."' WHERE 139339_main_id=".$_POST['inspectionid'];
		//echo $sql;
		...
		$objcon = mysqli_connect("localhost", "webuser", "limitaces", "openairport");
				...
				if (mysqli_connect_errno()) {
						...
						while ($objfields = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {
							...
							$sql2 = "UPDATE tbl_139_339_sub_c_c SET 139339_cc_c_cb_int='".$tmpchecklistconditionid."', 139339_cc_ficon_cb_int='".$_POST['inspectionid']."', 139339_cc_d_yn='".$_POST[$tmpcondnamestr]."' WHERE 139339_cc_id=".$tmpchecklistid;
		...
		$dutylogevent		= "Edited record ID:".$_POST["inspectionid"]." in table tbl_139_339_main";
