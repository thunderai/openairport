...
// There is a Record ID Supplied, Do work
											...
											<td colspan="2">
												<table cellspacing="0" width="100%">
													...
													<tr>
														...
														?>
														<form style="margin-bottom:0;" action="part121activity_sub_a.php" method="POST" name="manageaircraftform" id="manageaircraftform" target="manageaircraftformWindow" onsubmit="window.open('', 'manageaircraftformWindow', 'width=511,height=550,status=no,resizable=no,scrollbars=yes')">
		...
		$dutylogevent	= "Edited record ID:".$_POST["recordid"]." in Part 121 Aircraft Operations";
