...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	part139339_c_report_browse.php
//
...
// Load Page Specific Includes
	...
	// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		$function_archivedsort		= 'preflights_tbl_139_339_c_main_a_yn';				// The Name of the function to call to sort out ARCHIEVED Records.
		...
		$functionprinterpage 		= "part139339_c_report_display_new.php";				// Name of page used to display a printer friendly report
		$functionworkorderpage		= '';

		$functionduplicatepage		= '';
		$functionarchievedepage		= "part139339_c_report_archieved.php";
		$functionerrorpage			= "part139339_c_report_error.php";
		$functionbouncepage			= '';
		$functionrepairpage			= '';		
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblname				= "Part 139.339 (c) Inspection Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "";
		$adataselect[2]			= "part139339_c_templatescombobox";
