...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Condition Report - Error Summary";							// Name of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
		...
		$dutylogevent	= "Condition Report View Error ID ".$_POST['recordid']." summary was viewed.";
