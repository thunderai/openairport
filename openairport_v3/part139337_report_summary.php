...
// Define Variables	
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Wildlife Hazard Report - Summary Report";					// Name of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
		...
		$dutylogevent	= "Wildlife Hazard Management Reocrd ID ".$_POST['recordid']." summary was viewed.";
