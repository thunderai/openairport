...
<?php 
	...
	<form style="margin: 0px; margin-bottom:0px; margin-top:-1px;display:inline;" name="qac_menuitem<?php echo $tmpmenuitemid;?>" method="POST" action="<?php echo $tmpmenuurl;?>" target="layouttableiframecontent">
		<td width="50" class="buttons_quickaccess" onclick="javascript:document.qac_menuitem<?php echo $tmpmenuitemid;?>.submit()" style="cursor:hand" onMouseover="ddrivetip('<?php echo $tmpmenuitemloc;?>')"; onMouseout="hideddrivetip()">
