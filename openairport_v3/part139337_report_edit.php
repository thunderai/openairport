...
if (!isset($_POST['recordid'])) {
				...
				<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
					...
					<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" name="<?php echo $formname;?>" id="<?php echo $formname;?>">
						...
						<input type="hidden" name="recordid"	ID="recordid" 	value="<?php echo $objarray['139337_id'];?>">
										...
										form_new_control("Mouse"		,"Location"			, "Where was the action located"					,"Click the Map It button"																						,"(open in new window)"		,4				,0				,""				,$objarray['139337_locationx'].",".$objarray['139337_locationy'],"");
	...
	//------------------------------------------------------------------------------------------\\
		...
		$sql = $sql."139337_locationx='".$_POST['MouseX']."', 139337_locationy='".$_POST['MouseY']."' WHERE 139337_id = '".$_POST['recordid']."' ";
