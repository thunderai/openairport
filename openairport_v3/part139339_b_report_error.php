...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139339_b_report_error.php
//
//	Purpose of Page			:	Enter new Part 139.339 (b) NOTAM Error Report
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark NOTAM Report witn an Error";								// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark the NOTAM with an error";			// Subt title of the FORM, shown to the user
	...
	form_new_control("disdate"		,"Date"			, "Enter the date this NOTAM was marked as a error"		,"The current date has automatically been provided!"			,"(mm/dd/yyyy)"			,1,10,0,"current",0);
	form_new_control("distime"		,"Time"			, "Enter the time this NOTAM was marked as a error"		,"The current time has automatically been provided!"			,"(hh:mm:ss) - 24 hours",1,10,0,"current",0);
	...
	form_new_control("disduplicate"	,"Mark Error"	, "Checking this box will mark the NOTAM with an error"	,"Only do this if you are sure the NOTAM is a duplicate"	,"(checked = error)"	,5,35,4,"current",0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark NOTAM Error - Summary Report";						// Name of the FORM, shown to the user
	...
	//																																																																				 v								v		
	form_new_control("disdate"		,"Date"			, "Enter the date this NOTAM was marked as a error"		,"The current date has automatically been provided!"			,"(mm/dd/yyyy)"			,1,0,0,'post',0);
	form_new_control("distime"		,"Time"			, "Enter the time this NOTAM was marked as a error"		,"The current time has automatically been provided!"			,"(hh:mm:ss) - 24 hours",1,0,0,'post',0);
	...
	form_new_control("disduplicate"	,"Mark Error"	, "Checking this box will mark the NOTAM with an error"	,"Only do this if you are sure the NOTAM is a duplicate"	,"(checked = error)"	,5,0,4,'post',0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// DO SQL Work			
		...
		$dutylogevent	= "NOTAM ID ".$_POST['recordid']." was marked with an error.";
