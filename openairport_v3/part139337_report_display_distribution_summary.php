...
// Define Variables	
		...
		$tblname		= "Hot Spot Wildlife Summary Reports";
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			...
			$subtitle 			= "Wildlife Hazard Management Report - Summary Actions";		// Subt title of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
		...
		$dutylogevent	= "Wildlife Hazard Management Hot Spot Summary Report was viewed.";
