...
//
//	Purpose of Page			:	Enter new Part 139.339 (b) Archieved Report
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark NOTAM Archieved";									// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark the NOTAM archieved";				// Subt title of the FORM, shown to the user
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark NOTAM Achieved - Summary Report";					// Name of the FORM, shown to the user
	...
	form_new_control("disarchive"	,"Mark Archieved"	, "Checking this box will mark the NOTAM as archieved"	,"Only do this if you are sure you need to archieve it"	,"(checked = archieved)"	,5,0,4,'post',0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// DO SQL Work				
		...
		$sql = "INSERT INTO tbl_139_339_sub_n_a (139339_n_a_inspection_id, 139339_n_a_by_cb_int, 139339_n_a_reason, 139339_n_a_date, 139339_n_a_time, 139339_n_a_yn)
		...
		$dutylogevent	= "NOTAM ID ".$_POST['recordid']." was marked as archieved.";
