...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139303_a_report_browse.php
//
//	Purpose of Page			:	Browse Part 139.303(a) Personnel Records
//
...
// Start Procedures		
	...
	// Show Controls (Interface)
		$tbl_show_datesort 			= 0;												// 1: Allow User to Sort Records by Date; 		0: Prevent User from sorting records by Date.
	...
	// Preflight Settings	
		...
		$function_archivedsort		= 'preflights_tbl_139_303_a_main_a_yn';				// The Name of the function to call to sort out ARCHIEVED Records.
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functioneditpage 			= "part139303_a_report_edit.php";								// Name of page used to edit the record
		$functionsummarypage 		= "part139303_a_report_summary.php";							// Name of page used to display a summary of the record
		$functionprinterpage 		= "part139303_a_report_display.php";							// Name of page used to display a printer friendly report		
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbltextsortfield		= "emp_firstname";													// What is the name of the field used in text sorting ?
		...
		$tblname				= "Part 139.303(a) Personnel Records";								// What is the name of the table ? (used on edit/summary/printer report pages)
		$tblsubname				= "List of Employees";												// What is the subname of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[4]			= "emp_organiation_cb_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "First Name";
		$aheadername[1]			= "Last Name";
		$aheadername[2]			= "Initials";
		$aheadername[3]			= "Username";
		$aheadername[4]			= "Organization";	
...
// DISPLAY BROWSE TEMPLATE ENGINE
