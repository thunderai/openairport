...
function _tp_control_sortby_archieved($tbl_show_datesort,$tbldatesort,$language_on,$language_off,$language_active,$language_inactive,$fieldname,$controlfieldname,$defaultvalue,$calender) {
	...
	<table border="0" cellpadding="0" cellspacing="0" class="table_bottom_right_container_button" onclick="javascript:updatecontrolform('<?php echo $fieldname;?>');" style="cursor:hand;">
		<tr>
			<td class="table_button_bullet_right_light1_yellow" onMouseover="ddrivetip('<b><?php echo $language_on;?></b><br>Use this control to show or hide archieved reports.<br>');" onMouseout="hideddrivetip();" />
				&nbsp;
				</td>
			<td class="table_button_bullet_lead_light1_yellow" onMouseover="ddrivetip('<b><?php echo $language_on;?></b><br>Use this control to show or hide archieved reports.<br>');" onMouseout="hideddrivetip();"/>
				<?php
				echo $language_on;
				?>
			...
			<td class="table_button_bullet_left_light1_yellow" onMouseover="ddrivetip('<b><?php echo $language_on;?></b><br>Use this control to show or hide archieved reports.<br>');" onMouseout="hideddrivetip();"/>
				&nbsp;
				</td>
			</tr>
		</table>
