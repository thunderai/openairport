...
function getnameofmenuitemid_return($menuitemidsupplied,$displayfield,$fontsize,$fontcolor,$session_user) {
			...
			$layer3menures = mysqli_query($layer3menuconn, $sql);
				...
				if ($layer3menures) {
						...
						while ($layer3array = mysqli_fetch_array($layer3menures, MYSQLI_ASSOC)) {
								...
								$returnHTML = "<font color=".$fontcolor." face='arial narrow' size=".$fontsize.">".$tmpfieldname."</font>";
							}
