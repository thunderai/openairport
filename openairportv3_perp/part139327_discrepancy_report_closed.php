...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139327_discrepancy_report_closed.php
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Closed";									// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark a discrepancy closed";					// Subt title of the FORM, shown to the user
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Closed - Summary Report";					// Name of the FORM, shown to the user
	...
	// DO SQL Work
		...
		$sql = "INSERT INTO tbl_139_327_sub_d_c (discrepancy_closed_inspection_id, discrepancy_closed_by_cb_int, discrepancy_closed_reason, discrepancy_closed_date, discrepancy_closed_time, discrepancy_closed_yn)
