...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139339_b_report_closed.php
//
//	Purpose of Page			:	Enter new Part 139.339 (b) Report Closed
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark NOTAM Closed";											// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark NOTAM closed";							// Subt title of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
			$displaysummaryfunction 	= 1;													// 1: Display Summary of Record, 0: Do not show summary
				...
				$detailtodisplay		= 8;													// See Summary Function for how to use this number
	...
	form_new_control("diswx"			,"WX Intitials"				, "Provide the Intitis of who you talked to"											,"Do not use any special characters!"					,"(use only initials)"		,1			,5				,4				,""						,0);
	form_new_control("disairline"		,"Airline Intitials"		, "Provide the Intitis of who you talked to"											,"Do not use any special characters!"					,"(use only initials)"		,1			,5				,4				,""						,0);
	form_new_control("disfbo"			,"FBO Intitials"			, "Provide the Intitis of who you talked to"											,"Do not use any special characters!"					,"(use only initials)"		,1			,5				,4				,""						,0);
	...
	//------------------------------------------------------------------------------------------\\
			$display_submit 		= 1;															// 1: Display Submit Button,	0: No
				$submitbuttonname	= 'Save Closure Report';										// Name of the Submit Button
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark NOTAM Closed - Summary Report";							// Name of the FORM, shown to the user
			$form_subh			= "Here is the information you entered";						// Sub Name of the FORM, shown to the user
			$subtitle 			= "Here is the information about the selected closed Report";// Subt title of the FORM, shown to the user
	...
	form_new_control("diswx"		,"WX Intitials"		, "Provide the Intitis of who you talked to"				,"Do not use any special characters!"						,""							,1				,0				,4				,'post'					,0);
	form_new_control("disairline"	,"Airline Intitials", "Provide the Intitis of who you talked to"				,"Do not use any special characters!"						,""							,1				,0				,4				,'post'					,0);
	form_new_control("disfbo"		,"FBO Intitials"	, "Provide the Intitis of who you talked to"				,"Do not use any special characters!"						,""							,1				,0				,4				,'post'					,0);
