...
<table 	name="MenuItem_<?php echo $fieldname;?>" id="MenuItem_<?php echo $fieldname;?>" 
		...
		<tr>
			...
			<td name="<?php echo $OSpace_name;?>" id="<?php echo $OSpace_name;?>" 
				...
				onclick="<?php echo $formname;?>_var=dhtmlwindow.open('<?php echo $formname;?>_win', 'iframe', '<?php echo $action;?>', 'Add Record', 'top=75px,left=175px,width=500px,height=300px,resize=1,scrolling=1,center=1', 'recal');" 
				/>
