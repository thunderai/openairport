<?php
function _tp_control_function_button_mode($formname,$label,$icon,$action = '',$target = '') {
	// Variables
...
<table 	name="MenuItem_<?php echo $fieldname;?>" id="MenuItem_<?php echo $fieldname;?>" 
		...
		cellpadding="0" 
		cellspacing="0" 
		class="perp_menubutton" width="100%" />
		<tr>
			<?php 
			...
			<td name="<?php echo $OSpace_name;?>" id="<?php echo $OSpace_name;?>" 
				...
				onclick="javascript:modeselectionswitch();"
				/>
			...
			<td name="<?php echo $Name_name;?>" id="<?php echo $Name_name;?>" 
				...
				onclick="javascript:modeselectionswitch();"
				/>
				<input type="button" value="<?php echo $label;?>" width="10" class="makebuttonlooklikelargetext" id="modeswitch_label" name="modeswitch_label" />
				</td>		
