...
// Start Procedures			
	...
	// Preflight Settings	
		...
		$function_archivedsort		= 'preflights_tbl_139_333_main_a_yn';				// The Name of the function to call to sort out ARCHIEVED Records.
	...
	// Aditional Commands Settings
		...
		$array_archivedcontrol		= array("SELECT * FROM tbl_139_333_main_a WHERE 139333_a_inspection_id = ",	"139333",	"part139333_report_display_archived.php");
		...
		$array_errorcontrol			= array("SELECT * FROM tbl_139_333_main_e WHERE 139333_e_inspection_id = ",	"139333",	"part139333_report_display_error.php");
		...
		$functionarchievedepage		= "part139333_report_archieved.php";
		$functionerrorpage			= "part139333_report_error.php";
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functioneditpage 			= "part139333_report_edit.php";									// Name of page used to edit the record
		$functionsummarypage 		= "part139333_report_summary.php";								// Name of page used to display a summary of the record
		$functionprinterpage 		= "part139333_report_display.php";								// Name of page used to display a printer friendly report		
		$function_calendar			= 'part139333_report_calendar.php';								// The URL of the webpage to load to display the Calendar.
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "139333_main_id";													// What is the Auto Increment Field for this table ?
		...
		$tblname				= "NavAid Inspection Reports";										// What is the name of the table ? (used on edit/summary/printer report pages)
		$tblsubname				= "NavAid Results";													// What is the subname of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "139333_date";
		$adatafield[1]			= "139333_time";
		$adatafield[2]			= "139333_by_cb_int";
		$adatafield[3]			= "139333_type_cb_int";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[3]			= "part139333typescombobox";
