...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139337_report_export_makekml_loader.php
//
//	Purpose of Page			:	View Part 139.337 Wildlife Report Locations
//
...
//	Start Form Set Variables
	...
	// -----------------------------------------------------------------------------------------\\
			...
			$formaction			= "part139337_report_export_makekml.php";						// Page Form will submit information to. Leave valued at '' for the form to point to itself.
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Map Wildlife Reports Loader";								// Name of the FORM, shown to the user
			$form_subh			= "please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Wildlife Hazard Management Report - Chart Actions";			// Subt title of the FORM, shown to the user
