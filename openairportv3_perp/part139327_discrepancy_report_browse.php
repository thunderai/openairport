...
// Build the BreadCrum trail which shows the user their current location and how to navigate to other sections.
		...
		//	Not loaded here as this is a browse page and the template browse page loads its own
...
// Start Procedures			
	...
	// Aditional Commands Settings
		...
		$functionerrorpage			= "part139327_discrepancy_report_error.php";
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functioneditpage 			= "part139327_discrepancy_report_edit.php";						// Name of page used to edit the record
		$functionsummarypage 		= "part139327_discrepancy_report_summary.php";					// Name of page used to display a summary of the record
		$functionprinterpage 		= "part139327_discrepancy_report_display.php";					// Name of page used to display a printer friendly report		
		$function_calendar			= 'part139327_discrepancy_report_calendar.php';					// The URL of the webpage to load to display the Calendar.
		$function_printout			= '_general_printouts_get.php';									// The URL of the webpage to load to display the Printout.
		$function_distribution		= 'part139327_discrepancy_display_distribution_loader.php';		// The URL of the webpage to load to display the Distribition Chart.
		$function_linechart			= '';															// The URL of the webpage to load to display the Line Chart.
		$function_mapit				= 'part139327_discrepancy_report_display_mapit_loader.php';		// The URL of the webpage to load to display the Mapit.		
		$function_googleearthit		= 'part139327_discrepancy_report_export_makekml_loader.php';			// The URL of he webpage used to generate this information.	
		$function_mapit_push		= 'call_server_MapIt_327D_t';
	// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	//	^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	//	THE CONTAIN CONTENTS IS THE SAME FORMAT FOR ALL BROWSE DOCUMENTS, ALTHOUGH THE DATA MAY BE DIFFERENT
	// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblname				= "Discrepancy Monitor Report";										// What is the name of the table ? (used on edit/summary/printer report pages)
		$tblsubname				= "Discrepancy Information";										// What is the subname of the table ? (used on edit/summary/printer report pages)
