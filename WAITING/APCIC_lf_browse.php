...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Lost and Found Browse.php			The purpose of this file is to list lost and found items.
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "website_lostandfound_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "website_lostandfound_datefound";										// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_website_lostandfound";											// What table  is that field part of ?
		$tbltextsortfield		= "website_lostandfound_description";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_website_lostandfound";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "website_lostandfound_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Lost and Found";													// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "website_lostandfound_datefound";
		$adatafield[1]			= "website_lostandfound_foundby";
		$adatafield[2]			= "website_lostandfound_foundlocation";
		$adatafield[3]			= "website_lostandfound_description";
		$adatafield[4]			= "website_lostandfound_pickedup";
		$adatafield[5]			= "website_lostandfound_pickedup_by";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_website_lostandfound";
		$adatafieldtable[1]		= "tbl_website_lostandfound";
		$adatafieldtable[2]		= "tbl_website_lostandfound";
		$adatafieldtable[3]		= "tbl_website_lostandfound";
		$adatafieldtable[4]		= "tbl_website_lostandfound";	
		$adatafieldtable[5]		= "tbl_website_lostandfound";	
	...
	// what do you want to name the columns
		$aheadername[0]			= "Date";
		$aheadername[1]			= "Found by";
		$aheadername[2]			= "Location Found";
		$aheadername[3]			= "Description";
		$aheadername[4]			= "Pickedup?";
		$aheadername[5]			= "Pickedup By";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "( mm/dd/yyyy )";
		$ainputcomment[1]		= "Enter the name of the person who found the item";
		$ainputcomment[2]		= "Enter the location the item was found in";
		$ainputcomment[3]		= "Enter a decription of the item, but do not make it too descriptive";
		$ainputcomment[4]		= "Has the item been picked up>";
		$ainputcomment[5]		= "Who cam and picked up the item?";
