...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Inventory Equipment Entry.php			The purpose of this page is to enter new Equipment in Inventory
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "equipment_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_e";									// What table  is that field part of ?
		$tbltextsortfield		= "equipment_name";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_e";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "equipment_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "equipment Summary Report";									// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "equipment_modelyear";
		$adatafield[1]			= "equipment_name";
		$adatafield[2]			= "equipment_modelnumber";
		$adatafield[3]			= "equipment_type_cb_int";
		$adatafield[4]			= "equipment_manufac_cb_int";
		$adatafield[5]			= "equipment_serialnumber_a";
		$adatafield[6]			= "equipment_serialnumber_b";
		$adatafield[7]			= "equipment_serialnumber_c";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_inventory_sub_e";
		$adatafieldtable[1]		= "tbl_inventory_sub_e";
		$adatafieldtable[2]		= "tbl_inventory_sub_e";
		$adatafieldtable[3]		= "tbl_inventory_sub_e";
		$adatafieldtable[4]		= "tbl_inventory_sub_e";
		$adatafieldtable[5]		= "tbl_inventory_sub_e";
		$adatafieldtable[6]		= "tbl_inventory_sub_e";
		$adatafieldtable[7]		= "tbl_inventory_sub_e";	
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[3]		= "equipment_type_cb_int";
		$adatafieldid[4]		= "equipment_manufac_cb_int";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[1]			= "";
		$adataselect[2]			= "";
		$adataselect[3]			= "equipmenttypescombobox";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Equipment ID:".$lastid." Was Created";
		?>
