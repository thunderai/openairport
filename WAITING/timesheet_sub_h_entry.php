...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Timesheet Holiday Entry.php			The purpose of this page is to enter new Fuel Flow Operations
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "holiday_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_timesheets_sub_h";											// What table  is that field part of ?
		$tbltextsortfield		= "holiday_name";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_timesheets_sub_h";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "holiday_archived_yn";										// What is the name of the field used to mark the record archived ?
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "holiday_name";
		$adatafield[1]			= "holiday_name_short";
		$adatafield[2]			= "holiday_month_cb_int";
		$adatafield[3]			= "holiday_day";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_timesheets_sub_h";
		$adatafieldtable[1]		= "tbl_timesheets_sub_h";
		$adatafieldtable[2]		= "tbl_timesheets_sub_h";
		$adatafieldtable[3]		= "tbl_timesheets_sub_h";	
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "holiday_month_cb_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Name (Full)";
		$aheadername[1]			= "Name (Short: Initials)";
		$aheadername[2]			= "Month";
		$aheadername[3]			= "Day of Month";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the full name of this holiday";
		$ainputcomment[1]		= "Please enter a short name or the initials of this holiday";
		$ainputcomment[2]		= "Please select from the list to the right, the month this holiday is in";
		$ainputcomment[3]		= "Please enter the day of the month this holiday is on";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "";
		$adataselect[2]			= "gs_monthscombobox";
		$adataselect[3]			= "";
