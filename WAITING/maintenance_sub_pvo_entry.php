...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Building Operation Entry.php			The purpose of this page is to enter new Building Operations
...
*/	
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[3]			= "pavement_combobox";
		$adataselect[4]			= "maintenanceeventscomboboxwall";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
						...
						case "SELECT":	// if user entered "SELECT" as the input type make a select box
								switch ($aheadername[$i]) {	
										...
										case "F.B.O.":
												...
												break;
										case "Pavement":	
												pavement_with_eventscomboboxs("all", "all", $adatafield[$i],$adatafield[$i+1], "show", "");
												break;
										default:
