...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	State Posion Main Entry.php		The purpose of this page is to enter new Part 139.337 Wildlife Hazard Management Reports
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "st_p_id";													// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "st_p_date";																// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_state_poison_main";													// What table  is that field part of ?
		$tbltextsortfield		= "st_p_spurpose";													// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_state_poison_main";													// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "st_p_archived_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Spraying Operation Summary Report";										// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "st_p_by_int";
		$adatafield[1]			= "st_p_date";
		$adatafield[2]			= "st_p_time";
		$adatafield[3]			= "st_p_chem_1_int";
		$adatafield[4]			= "st_p_chem_2_int";
		$adatafield[5]			= "st_p_bname_txt";
		$adatafield[6]			= "st_p_baddress_txt";
		$adatafield[7]			= "st_p_custname_txt";
		$adatafield[8]			= "st_p_custaddress_txt";
		$adatafield[9]			= "st_p_plocations_txt";
		$adatafield[10]			= "st_p_spurpose_txt";
		$adatafield[11]			= "st_p_totalgallons";
		$adatafield[12]			= "st_p_acrestreated";
		$adatafield[13]			= "st_p_spraylocation_x";
		$adatafield[14]			= "st_p_spraylocation_y";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_state_poison_main";
		$adatafieldtable[1]		= "tbl_state_poison_main";	
		$adatafieldtable[2]		= "tbl_state_poison_main";	
		$adatafieldtable[3]		= "tbl_state_poison_main";	
		$adatafieldtable[4]		= "tbl_state_poison_main";	
		$adatafieldtable[5]		= "tbl_state_poison_main";	
		$adatafieldtable[6]		= "tbl_state_poison_main";	
		$adatafieldtable[7]		= "tbl_state_poison_main";	
		$adatafieldtable[8]		= "tbl_state_poison_main";	
		$adatafieldtable[9]		= "tbl_state_poison_main";
		$adatafieldtable[10]	= "tbl_state_poison_main";	
		$adatafieldtable[11]	= "tbl_state_poison_main";	
		$adatafieldtable[12]	= "tbl_state_poison_main";	
		$adatafieldtable[13]	= "tbl_state_poison_main";	
		$adatafieldtable[14]	= "tbl_state_poison_main";	
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "st_p_by_int";
		$adatafieldid[1]		= "justsort";
		$adatafieldid[2]		= "justsort";
		$adatafieldid[3]		= "st_p_chem_1_int";
		$adatafieldid[4]		= "st_p_chem_2_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Entry By";
		$aheadername[1]			= "Date";
		$aheadername[2]			= "Time";
		$aheadername[3]			= "Chemical One";
		$aheadername[4]			= "Chemical Two";
		$aheadername[5]			= "Business Name";
		$aheadername[6]			= "Business Address";
		$aheadername[7]			= "Customer Name";
		$aheadername[8]			= "Customer Address";
		$aheadername[9]			= "Locations Treated";
		$aheadername[10]		= "Purpose of Application";
		$aheadername[11]		= "Total Gallons";
		$aheadername[12]		= "Total Acres";
		$aheadername[13]		= "Xpoints";
		$aheadername[14]		= "Ypoints";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please select the author";
		$ainputcomment[1]		= "Please enter the date";
		$ainputcomment[2]		= "Please enter the time";
		$ainputcomment[3]		= "Please select the Chemical Applied";
		$ainputcomment[4]		= "Please select the Chemical Applied";
		$ainputcomment[5]		= "Please enter your business name";
		$ainputcomment[6]		= "Please enter your business address";
		$ainputcomment[7]		= "Please enter your customers name";
		$ainputcomment[8]		= "Please enter your customers address";
		$ainputcomment[9]		= "Please enter the locations treated";
		$ainputcomment[10]		= "Please enter the purpose of the application";
		$ainputcomment[11]		= "Please enter the total gallons applied";
		$ainputcomment[12]		= "Please enter the total acres treated";
		$ainputcomment[13]		= "Please enter the Cords X";
		$ainputcomment[14]		= "Please enter the Cords Y";
	// what type of input is this field?
		...
		$ainputtype[4]			= "SELECT";
		$ainputtype[5]			= "TEXT";
		$ainputtype[6]			= "TEXTAREA";
		$ainputtype[7]			= "TEXT";
		$ainputtype[8]			= "TEXTAREA";
		$ainputtype[9]			= "TEXTAREA";
		$ainputtype[10]			= "TEXTAREA";
		$ainputtype[11]			= "TEXT";
		$ainputtype[12]			= "TEXT";
		$ainputtype[13]			= "TEXT";
		$ainputtype[14]			= "TEXT";
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "systemusercombobox";
		$adataselect[1]			= "";
		$adataselect[2]			= "";
		$adataselect[3]			= "listtypesofchemicals";
		$adataselect[4]			= "listtypesofchemicals";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
		$adataselect[7]			= "";
		$adataselect[8]			= "";
...
if (!isset($_POST["formsubmit"])) {
		...
		for ($i=0; $i<count($aheadername); $i=$i+1) {
				...
				switch ($ainputtype[$i]) {
						...
						case "TEXT":	// if the user entered "TEXT' as the input type make a ttext area box
								switch ($aheadername[$i]) {						
										...
										case "Location Y";
												...
												break;
										case "Business Name";
												$tmpvalue		= "City of Watertown - KATY";
												$uisize			= "60";
												$tmpname		= $adatafield[$i];
												break;		
										case "Customer Name";
						...
						?>					
												<input class="Commonfieldbox" type="text" name="<?=$tmpname;?>" size="<?=$uisize;?>" value="<?=$tmpvalue;?>">
						<?
								break;
						...
						case "TEXTAREA":	// if the user entered "TEXTAREA" as the input type make a text area box
								switch ($aheadername[$i]) {						
										case "Business Address";
												$tmpvalue		= "2416 Boeing Ave; Watertown, SD 57201";
												$uisize			= "60";
												$tmpname		= $adatafield[$i];
												break;			
						...
						?>
												<TEXTAREA class="Commonfieldbox" name="<?=$tmpname;?>" rows="10" cols="60"><?=$tmpvalue;?></TEXTAREA>
						<?	
								break;
						...
						case "SELECT":	// if user entered "SELECT" as the input type make a select box						
								...
								switch ($aheadername[$i]) {	
										case "Entry by":
												...
												break;								
										case "Operator":
												$adataselect[$i](2, "all", $adatafield[$i], "show", "");
												break;
										default:
				...
				?>
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('Please click the button to assign a location for this incident')"; onMouseout="hideddrivetip()">
												Map the Location
												</td>
											<td class="formanswers">
												<INPUT class="formsubmit" TYPE="button" VALUE="Map Pavement Location" onClick="openChild2('mapdrawit_small.php?xpoints=<?=$adatafield[13]?>&ypoints=<?=$adatafield[14];?>','Win2')">
												</td>
											</tr>				
										<tr>
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		for ($i=0; $i<count($adatafield); $i=$i+1) {
				switch ($aheadername[$i]) {
						...
						case "Archived":
								...
								break;
						case "Location X":
								$asubmit[$i]			= $_POST['MouseX'];
								break;
						case "Location Y":
								$asubmit[$i]			= $_POST['MouseY'];
								break;
						default:
		...
		$dutylogevent		= "New Wildlife Action ID: ".$lastid." Was Created";
