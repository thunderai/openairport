...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	General Settings - Conditions Browse.php	The purpose of this page is to list the General Settings - Conditions
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "geeral_condition_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_general_conditions";											// What table  is that field part of ?
		$tbltextsortfield		= "general_condition_name";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_general_conditions";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "general_condition_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "General Settings - Conditions Summary Report";									// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "general_condition_name";
		$adatafield[1]			= "general_condition_priority";
		$adatafield[2]			= "general_condition_archived_yn";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Name";
		$aheadername[1]			= "Priority";
		$aheadername[2]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the name of this general condition<br><br><br>This field should not have any special chars in it";
		$ainputcomment[1]		= "Please enter a priority for this condition. The priority may be any integer value, ordered 1 being heighest, and larger numbers lower. When two conditions have the same priority, they will be sorted by their alphabetic order.";
		$ainputcomment[2]		= "If you would like to archive this condition, please check the checkbox.";
