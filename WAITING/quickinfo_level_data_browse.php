...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Quick Info Level Data Browse.php		The purpose of this page is to list all of the menu items Levles and control edit, and printing of them.
...
*/	
	...
	// will the form use any of the following toggle switches	
		...
		// 1 : yes ; 0 : no;
		$tbldatesort 		= 0;
		// should the form have the ability to sort the data by some text?
		// 1 : yes ; 0 : no;
		$tbltextsort 		= 0;
		// should the form have the ability to sort of the data by the header in each column?
		// 1 : yes ; 0 : no;
		$tblheadersort		=1;	
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield		="navigational_access_id";
	...
	// this is an array of information, from [0] to [...], you may have an unlimited number of columns
		$adatafield[0]		="navigational_groups_id_cb_int";
		$adatafield[1]		="navigational_control_id_cb_int";
		$adatafield[2]		="navigational_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]	="tbl_quickinfo_control_g_a";
		$adatafieldtable[1]	="tbl_quickinfo_control_g_a";
		$adatafieldtable[2]	="tbl_quickinfo_control_g_a";
	...
	// the name of any field in any of the selected tables will cause only records that have that information to be displayed.
		$adatafieldid[0]	="navigational_groups_id_cb_int";
		$adatafieldid[1]	="navigational_control_id_cb_int";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]		="navigationalgroupbox";
		$adataselect[1]		="quickinfocombobox";
		$adataselect[2]		="";
	// Any special comments to make after the input box?
		$ainputcomment[0]	="(Select a group from the list)";
		$ainputcomment[1]	="(Select a Menu Item from the list)";
