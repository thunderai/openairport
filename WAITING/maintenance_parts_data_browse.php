...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Maintenance Parts Data Brwose.php		The purpose of this page is to browse Maintenance Parts
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "maintenance_part_id";										// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_maintenance_sub_p";										// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_part_name";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_p";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_part_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Maintenance Part Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "maintenance_part_name";
		$adatafield[1]			= "maintenance_part_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_p";
		$adatafieldtable[1]		= "tbl_maintenance_sub_p";			
