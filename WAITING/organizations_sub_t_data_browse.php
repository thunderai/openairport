...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Organizations Types Data Browse.php	The purpose of this page is to list of the Oranigations Types
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "org_types_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_organization_sub_t";										// What table  is that field part of ?
		$tbltextsortfield		= "org_types_name";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_organization_sub_t";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "org_types_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Oranizations Types Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "org_types_name";
		$adatafield[1]			= "org_types_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_organization_sub_t";
		$adatafieldtable[1]		= "tbl_organization_sub_t";
