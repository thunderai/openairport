...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "vehicles_sub_type_id";										// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_v_sub_t";							// What table  is that field part of ?
		$tbltextsortfield		= "vehicles_sub_type_name";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_v_sub_t";							// What is the name of the table used for text sorting ?
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "vehicles_sub_type_name";
		$adatafield[1]			= "vehicles_sub_type_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_inventory_sub_v_sub_t";
		$adatafieldtable[1]		= "tbl_inventory_sub_v_sub_t";			
