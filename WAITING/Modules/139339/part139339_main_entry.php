...
if (!isset($_POST["formsubmit"])) {
	...
	function openChild(file,window) {
	    childWindow=open(file,window,'resizable=yes,width=400,height=400,menubar=0,toolbar=0,status=0,scrollbars=1');
									...
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<td class="formoptions" align="center">
												<input class="formsubmit" type="button" name="button" value="Get Checklist" onClick="call_server_ficon(<?=$_SESSION['user_id'];?>);">&nbsp;&nbsp;&nbsp;&nbsp;<input class="formsubmit" type="button" name="button" value="submit" onclick="javascript:document.entryform.submit()">&nbsp;
												</td>
											</tr>
										<tr>
										...
										<tr>
											...
											<td class="formanswers" colspan="2">
												<SELECT name="frmtemplatesave" onchange="call_server_ficon_template(<?=$_SESSION['user_id'];?>);">
