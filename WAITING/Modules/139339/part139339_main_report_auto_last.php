...
<?
	...
	ORDER BY 139339_date DESC, 139339_time DESC LIMIT 1";
	...
	if (mysqli_connect_errno()) {
			...
			if ($objrs) {
					...
					while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {					
							...
							$tmpid_main	= $objarray['139339_main_id'];
...
<?
	...
	$a17_x	= array(483,485,486,488,489,490,492,494,496);
	$a17_y	= array(260,313,366,419,472,525,578,631,684);									
	$a12_x	= array(160,205,250,295,340,385,430,474,519);
	$a12_y	= array(222,251,280,309,338,367,396,424,453);
?>
					...
					<td colspan="1" align="middle" valign="center" width="30" style="border-style: solid; border-width: 1px" bordercolor="#000000" bgcolor="#808080">
						...
						<?
							...
							$sql = "SELECT * FROM tbl_139_339_sub_c_c 
									...
									WHERE 139339_cc_ficon_cb_int = '".$tmpid_main."' 
	...
	$tmpsqlauthor		= 65;	// Hardcoded # for the System UserAccount
	$dutylogevent		= "Someone on the Internet Printed Part 139 Field Condition Report ID:".$tmpid.", dated ".$tmpdate." at ".$tmptime."";	
