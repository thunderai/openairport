...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	Part 139 339 Main Browse.php
//
//	Purpose of Page		:	This page allows the user to view the FiCONs in the database and
//							make any changes to the system that the user needs to.
//							
//
				...
				<tr>
					<td class="formoptions" align="center">
						...
						if ($tbldatesort==1) {
								?>
						Start Date<br>
						<input class="commonfieldbox" type="text" name="frmstartdate" size="10" value="<?=$uifrmstartdate;?>" onchange="javascript:(isdate(this.form.frmstartdate.value,'mm/dd/yyyy'))">
								<?
							}
							else {
								?>
