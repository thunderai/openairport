...
if (!isset($_POST["formsubmit"])) {
								...
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<td class="formanswers">
												<?
												systemusercombobox("all", "all", "distudent", "show", "all");
												?>
												</td>
											</tr>
										<tr>
		...
		$sql = "INSERT INTO tbl_139_303_sub_sa (discrepancy_checklist_id, discrepancy_inspection_id, discrepancy_by_cb_int, discrepancy_student_cb_int)
		VALUES ( '".$_POST['checklistid']."', '".$_POST['recordid']."', '".$_POST['disauthor']."', '".$_POST['distudent']."')";
								...
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<td class="formanswers">
												<?
												systemusercombobox($_POST['distudent'], "all", "distudent", "hide", "");
												?>
												</td>
											</tr>
										<tr>
		...
		$dutylogevent		= "Added New Student ".$lastid." for Training Session ID ".$_POST['recordid']."";
