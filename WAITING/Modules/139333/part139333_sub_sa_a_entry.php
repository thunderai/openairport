...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.327 D A Entry.php			The purpose of this page is to enter new Discrepancies Archived information.
...
<HTML>
	<HEAD>
		...
		<title>Mark Student Archived</title>
...
if (!isset($_POST["formsubmit"])) {
		...
		$sql = "INSERT INTO tbl_139_303_sub_sa_a (discrepancy_archeived_inspection_id, discrepancy_archieved_by_cb_int, discrepancy_archieved_reason, discrepancy_archieved_date, discrepancy_archieved_time, discrepancy_archieved_yn)
							...
							<tr>
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										<tr>
											<td colspan="2" class="formoptionsavilabletop">
												The Following Discrepancy was sucsessfully archived in the Database, you may close this window now.
												</td>
											</tr>
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
		...
		$dutylogevent	= "Student Attenance ID ".$_POST['discrepancyid']." was archived.";
