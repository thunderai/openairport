									...
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										<tr>
											<td colspan="3" class="formoptionsavilabletop">
												Please enter the start and end date of your search and then select the type of training session.
												</td>
											</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="2" class="formanswers">
												<input class="commonfieldbox" type="text" name="frmtime" size="10" value="<?echo date('m/d/Y');?>" nchange="javascript:(isdate(this.form.frmstartdate.value,'mm/dd/yyyy'))">
												</td>
											</tr>
										<tr>
