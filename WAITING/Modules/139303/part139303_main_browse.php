...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	part 139.327 Main Browse.php			The purpose of this page is to list all of the Airport Safety Self Inspections, given the search critera.
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblname				= "Part 139.303 Training Session Summary";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[4]			= "139_303_sylabus";
		$adatafield[5]			= "139_303_attendance";		
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_303_main";
		$adatafieldtable[1]		= "tbl_139_303_main";
		$adatafieldtable[2]		= "tbl_139_303_main";
		$adatafieldtable[3]		= "tbl_139_303_main";
		$adatafieldtable[4]		= "tbl_139_303_main";
		$adatafieldtable[5]		= "tbl_139_303_main";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "139_303_type_cb_int";
		$adatafieldid[3]		= "139_303_by_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[4]			= "Document : Sylabus";
		$aheadername[5]			= "Document : Attendance";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Date of Training Session (mm/dd/yyyy)";
		$ainputcomment[1]		= "Time Training Session Started (in 24 hour format)";
		$ainputcomment[2]		= "Please select the type of training session that was conducted";
		$ainputcomment[3]		= "Please select the teacher of this training session";
		$ainputcomment[4]		= "Included document showing what was trained that day";
		$ainputcomment[5]		= "Included document showing the student who were at the class";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "";
		$adataselect[2]			= "part139303typescombobox";
