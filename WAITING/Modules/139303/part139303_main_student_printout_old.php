...
*/	
	// Load Required Include Files
		...
		$tblsubname	= "For Selected Training Sessions";
					...
					<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
						<tr>
							<td class="formoptions" align="center">
								Please use this form to list students by the training sessions they have taken.
								</td>
							</tr>
						</table>
						...
						<tr>
							<td class="formresultscount">
								...
								$sql = "SELECT * FROM tbl_139_303_sub_sa 
										INNER JOIN tbl_139_303_main ON tbl_139_303_sub_sa.Discrepancy_inspection_id = tbl_139_303_main.139_303_id 
										INNER JOIN tbl_139_303_sub_t ON tbl_139_303_main.139_303_type_cb_int = tbl_139_303_sub_t.inspection_type_id 
										ORDER BY discrepancy_student_cb_int
									";
							...
							<td class="tabledatarow">
								<table border="0" width="100%" id="table1" cellpadding="0" cellspacing="1"  style="border-collapse: collapse">
									...
									<tr>
										...
										<td align="center" class="formresults">
											<?
											part139303typescombobox($objarray['discrepancy_student_cb_int'], "all", "disauthor", "hide", "");
											?>
											</td>
										<td align="center" class="formresults">
