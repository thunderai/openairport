...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 135 Activity Airport Entry.php		The purpose of this page is to enter new Aircraft Operations for Part 135 Monthly Reports
	
								Usage:
								For use only with pat135activity_sub_a.php
...
*/	
	// Load Required Include Files
		...
		$tblname		= "Add New Aircraft Operation";
...
<HTML>
	<HEAD>
		...
		<title>Add New Part 135 Aircraft Operation</title>
...
if (!isset($_POST["formsubmit"])) {
									...
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<td class="formanswers">
												<?
												aircraftcombobox("all", "all", "disaircraft", "show", "");
												?>
												</td>
											</tr>											
										<tr>
											...
											<td class="formanswers">
												<input class="Commonfieldbox" type="text" name="dislandings" size="60">
												</td>
											</tr>
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
											...
											<td class="formanswers">
												<input class="Commonfieldbox" type="text" name="disovernights" size="60">
												</td>
											</tr>										
										<tr>
		...
		$sql = "INSERT INTO tbl_activity_135_sub_a  (aircraft_activity_135_type_cb_int, aircraft_activity_main_id, aircraft_activity_135_landings, aircraft_activity_135_overnight)
		VALUES ( '".$_POST['disaircraft']."', '".$_POST['recordid']."', '".$_POST['dislandings']."', '".$_POST['disovernights']."')";
								...
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<td class="formanswers">
												<?
												aircraftcombobox($_POST['disaircraft'], "all", "disauthor", "hide", "");
												?>
												</td>
											</tr>											
										<tr>
		...
		$dutylogevent	= "Added New Aircraft Operation ID:".$lastid." for Part 135 Monthly Summary Report ID:".$_POST['recordid']."";
