...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	WEebsite Content Browse.php			The purpose of this file is to list lost and found items.
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "website_content_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";																// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_website_content";												// What table  is that field part of ?
		$tbltextsortfield		= "website_content_content";											// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_website_content";												// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "website_content_archieved_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Website Content";													// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "website_content_content";
		$adatafield[1]			= "website_content_archieved_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_website_content";
		$adatafieldtable[1]		= "tbl_website_content";	
	...
	// what do you want to name the columns
		$aheadername[0]			= "Content";
		$aheadername[1]			= "Archieve";
