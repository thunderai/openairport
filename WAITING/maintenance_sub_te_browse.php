...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Fuel Tank Maintenance Event Browse.php	The purpose of this page is to browse Fuel Tank Maintenance Events
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_t_e";									// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_t_e";									// What is the name of the table used for text sorting ?
	...
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_t_e";
		$adatafieldtable[1]		= "tbl_maintenance_sub_t_e";
		$adatafieldtable[2]		= "tbl_maintenance_sub_t_e";
		$adatafieldtable[3]		= "tbl_maintenance_sub_t_e";		
