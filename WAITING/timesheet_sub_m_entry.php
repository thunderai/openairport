...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Timesheet Months Entry.php			The purpose of this page is to enter new Fuel Flow Operations
...
*/	
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[4]		= "Please check this box if the month will have 5 weeks in it.";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Aircraft ID: ".$lastid." Was Created";
