...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Inventory Buildings Entry.php			The purpose of this page is to enter new Fuel Flow Operations
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Building ID:".$lastid." Was Created";
		$tmplastid			= $lastid;
		...
		autocmxevent_building($tmpsqldate,$building_id,$event_id,$years);	
		?>
