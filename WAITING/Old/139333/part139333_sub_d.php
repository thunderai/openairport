...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.333 Sub_D.php			The purpose of this page is to manage discrepancies entered on the Part 139.333 _Main Form
	
								Usage:
								This is a complete custom form for the purposes of entering Part 139.333 Discrepancies and should not be used as a template for another form
...
*/	
	// Load Required Include Files
		...
		$tblname		= "Manage Discrepancies";
		$tblsubname		= "For the current Navaid Inspection";
...
<HTML>
	<HEAD>
		...
		<title>Manage Discrepancies</title>
				...
				<td colspan="3" class="tablesubcontent">
					<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
						<tr>
							...
							<td class="formoptions" align="center">
								<?
								part139333facilitycombobox($_POST['facilityid'], "all", "notused", "hide", "all");
								?>
								</td>
							<td class="formoptions" align="center">
								<?
								part139333typescombobox($_POST['inspectiontypeid'], "all", "notused", "hide", "all");
								?>
								</td>
							</tr>
						</table>
					<table border="0" width="100%" cellspacing="4">
						<tr>
							<td class="formresultscount">
								...
								$sql = "SELECT * FROM tbl_139_333_sub_d WHERE discrepancy_checklist_id = '".$_POST['checklistid']."' ";
								...
								<table cellspacing="0" width="100%">
									...
									<tr>
										<td class="formoptionsavilablebottom">
											<table>
												<tr>
													<form style="margin-bottom:0;" action="part139333_sub_d_entry.php" method="POST" name="reportform" id="reportform" target="PrinterFriendlyWindow" onsubmit="window.open('', 'PrinterFriendlyWindow', 'width=600,height=400,status=no,resizable=no,scrollbars=yes')">
													<td class="formoptionsubmit">
														...
														<input type="submit" value="Add New Discrepancy" name="b1" class="formsubmit">
														</td>
													</form>	
													</tr>
												</table>
									...
									<tr>
										...
										<td align="center" class="formresults">
											<table border="1" width="50" cellspacing="0" id="table1" class="formsubmit cellpadding="0">
												<tr>
													<form style="margin-bottom:0;" action="part139333_sub_d_a_entry.php" method="POST" name="editform" id="editform">
													<td class="formoptionsubmit">
														<input type="hidden" name="conditionid" 		value="<?=$_POST['conditionid'];?>">
														<input type="hidden" name="recordid" 			value="<?=$_POST['recordid'];?>">
														<input type="hidden" name="checklistid" 		value="<?=$_POST['checklistid'];?>">
													...
													<form style="margin-bottom:0;" action="part139333_sub_d_e_entry.php" method="POST" name="editform" id="editform">
													<td class="formoptionsubmit">
														<input type="hidden" name="conditionid" 		value="<?=$_POST['conditionid'];?>">
														<input type="hidden" name="recordid" 			value="<?=$_POST['recordid'];?>">
														<input type="hidden" name="checklistid" 		value="<?=$_POST['checklistid'];?>">
													...
													<form style="margin-bottom:0;" action="part139333_sub_d_b_entry.php" method="POST" name="editform" id="editform">
													<td class="formoptionsubmit">
														<input type="hidden" name="conditionid" 		value="<?=$_POST['conditionid'];?>">
														<input type="hidden" name="recordid" 			value="<?=$_POST['recordid'];?>">
														<input type="hidden" name="checklistid" 		value="<?=$_POST['checklistid'];?>">
														...
														<input type="hidden" name="inspectiontypeid" 	value="<?=$_POST['inspectiontypeid'];?>">
														<input type="hidden" name="did" 				value="<?=$tmpid;?>">
														<input type="submit" value="B" name="b1" class="formsubmit">
														</td>
													</form>
													<form style="margin-bottom:0;" action="part139333_sub_d_d_entry.php" method="POST" name="editform" id="editform">
													<td class="formoptionsubmit">
														<input type="hidden" name="conditionid" 		value="<?=$_POST['conditionid'];?>">
														<input type="hidden" name="recordid" 			value="<?=$_POST['recordid'];?>">
														<input type="hidden" name="checklistid" 		value="<?=$_POST['checklistid'];?>">
														...
														<input type="hidden" name="inspectiontypeid" 	value="<?=$_POST['inspectiontypeid'];?>">
														<input type="hidden" name="did" 				value="<?=$tmpid;?>">
														<input type="submit" value="D" name="b1" class="formsubmit">
														</td>
													</form>
													<form style="margin-bottom:0;" action="part139333_sub_d_r_entry.php" method="POST" name="editform" id="editform">
													<td class="formoptionsubmit">
														<input type="hidden" name="conditionid" 		value="<?=$_POST['conditionid'];?>">
														<input type="hidden" name="recordid" 			value="<?=$_POST['recordid'];?>">
														<input type="hidden" name="checklistid" 		value="<?=$_POST['checklistid'];?>">
