...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139 337 Main Chart.php			The purpose of this page is to display Wildlife hazard Management Reports
...
*/	
	...
	// what columns should the datagrid display?
		...
		$adatafield[2]			="Species";
		$adatafield[3]			="Activity";
		$adatafield[4]			="Action";
	...
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		="species";
		$adatafieldid[3]		="activity";
		$adatafieldid[4]		="action";
	...
	// what do you want to name the columns
		$aheadername[0]			="Date";
		$aheadername[1]			="Date";
		$aheadername[2]			="Species";
		$aheadername[3]			="Activity";
		$aheadername[4]			="Action";
	// Any special comments to make after the input box?
		$ainputcomment[0]		="( Start Date : mm/dd/yyyy )";
		$ainputcomment[1]		="( End Date : mm/dd/yyyy )";
		$ainputcomment[2]		="Please select a species from the list to the right";
		$ainputcomment[3]		="Please select an activity the species was doing";
		$ainputcomment[4]		="Please select an action taken against the species";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			="";
		$adataselect[1]			="";
		$adataselect[2]			="wildlifespeciescomboboxwall";
		$adataselect[3]			="wildlifeactivitycomboboxwall";
		$adataselect[4]			="wildlifeactionscomboboxwall";
...
if (!isset($_POST["formsubmit"])) {
		...
		?>
						<form action="part139337_main_chart_report.php" method="post" name="edittable" id="edittable" target="PrinterFriendlyWindow" onsubmit="window.open('', 'PrinterFriendlyWindow', 'width=750,height=550,status=no,resizable=no,scrollbars=yes')">
				...
				?>
										<tr>
											<td colspan="2" class="formoptionsavilablebottom">
												<input type="submit" name="b1" 					value="Display Wildlife Chart"			class="formsubmit">
												</td>
											</tr>
										</table>
									</td>
