...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.337 Main Entry.php			The purpose of this page is to enter new Part 139.337 Wildlife Hazard Management Reports
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblarchivedfield		= "13337_archived_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Wildlife Hazard Management Summary Report";										// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[7]			= "139337_resultsofaction";
		$adatafield[8]			= "139337_weather";
		$adatafield[9]			= "139337_locationx";
		$adatafield[10]			= "139337_locationy";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_337_main";
		$adatafieldtable[1]		= "tbl_139_337_main";	
		$adatafieldtable[2]		= "tbl_139_337_main";	
		$adatafieldtable[3]		= "tbl_139_337_main";	
		$adatafieldtable[4]		= "tbl_139_337_main";	
		$adatafieldtable[5]		= "tbl_139_337_main";	
		$adatafieldtable[6]		= "tbl_139_337_main";	
		$adatafieldtable[7]		= "tbl_139_337_main";	
		$adatafieldtable[8]		= "tbl_139_337_main";	
		$adatafieldtable[9]		= "tbl_139_337_main";
		$adatafieldtable[10]		= "tbl_139_337_main";	
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "139337_author_by_cb_int";
		$adatafieldid[3]		= "139337_species_cb_int";
		$adatafieldid[4]		= "139337_activity_cb_int";
		$adatafieldid[5]		= "139337_action_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[6]			= "Number of Species";
		$aheadername[7]			= "Results";
		$aheadername[8]			= "Weather";
		$aheadername[9]			= "Location X";
		$aheadername[10]		= "Location Y";
	// Any special comments to make after the input box?
		...
		$ainputcomment[2]		= "Please select the author";
		$ainputcomment[3]		= "Please select the species affected by this wildlife management record";
		$ainputcomment[4]		= "Please select the type of activity the species was doing at the time";
		$ainputcomment[5]		= "Please select what type of action you took against the species";
		$ainputcomment[6]		= "Please enter the number of species affected";
		$ainputcomment[7]		= "Please enter what you happened to the species and any other important details";
		$ainputcomment[8]		= "Please enter what the weather was like at the time";
		$ainputcomment[9]		= "Please enter the horizontal location of the incident";
		$ainputcomment[10]		= "Please enter the vertical location of the incident";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[3]			= "wildlifespeciescombobox";
		$adataselect[4]			= "wildlifeactivitycombobox";
		$adataselect[5]			= "wildlifeactionscombobox";
		$adataselect[6]			= "";
		$adataselect[7]			= "";
		$adataselect[8]			= "";
		$adataselect[9]			= "";
				...
				?>
										<tr>
											...
											<td class="formanswers">
												...
												?>		
												<input type="hidden" name="139337_metar" 				value="<? readweathertxt("null");?>">
												</td>
											</tr>	
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('Please click the button to assign a location for this incident')"; onMouseout="hideddrivetip()">
											...
											<td class="formanswers">
												<INPUT class="formsubmit" TYPE="button" VALUE="Map Wildlife Hazard" onClick="openChild2('mapit.php','Win2')">
												</td>
											</tr>				
										<tr>
