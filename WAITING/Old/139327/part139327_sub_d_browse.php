...
*/	
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functionprinterpage 	= "part139327_sub_d_review.php";									// Name of page used to display a printer friendly report
	...
	<tr>
		<td colspan="3" class="tablesubcontent">
			<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
				<input class="commonfieldbox" 	type="hidden" size="1" 	name="frmurl" 			ID="frmurl"				value="<?=$frmurl;?>" >
				<input class="combobox" 		type="hidden" size="4" 	name="intfrmjoined" 	ID="intfrmjoined"		value="<?=$intfrmjoined;?>" >
				<input class="combobox" 		type="hidden" size="40" name="strsqlwhereaddon" ID="strsqlwhereaddon"	value="<?=$strsqlwhereaddon;?>" >
				...
				<tr>
					<td class="formoptions" align="center">
						...
						if ($tbldatesort==1) {
								?>
						Start Date<br><input class="commonfieldbox" type="text" name="frmstartdate" ID="frmstartdate" size="10" value="<?=$uifrmstartdate;?>" onchange="javascript:(isdate(this.form.frmstartdate.value,'mm/dd/yyyy'))">
								<?
							}
							else {
								?>
					...
					<td class="formoptions" align="center">
						...
						if ($tbldatesort==1) {
								?>
						End Date<br><input class="commonfieldbox" type="text" name="frmenddate" ID="frmenddate" size="10" value="<?=$uifrmenddate;?>" onchange="javascript:(isdate(this.form.frmenddate.value,'mm/dd/yyyy'))">
								<?
							}
							else {
								?>
					...
					<td class="formoptions" align="center" onMouseover="ddrivetip('If you want to narrow down the discrepancies displayed to a name contining cetain text, enter that text here')"; onMouseout="hideddrivetip()">
						...
						if ($tbltextsort==1) {
								?>
						Text Like<br><input class="commonfieldbox" type="text" name="frmtextlike" ID="frmtextlike" size="25" value="<?=$frmtextlike;?>">
								<?
							}
							else {
								?>
							...
							<tr>
									...
									<table border="1" width="50" cellspacing="0" id="table1" class="formsubmit cellpadding="0">
										<tr>
											...
											<td class="formoptionsubmit">
												...
												<input type="submit" value="E" NAME="b1" ID="b1" class="formsubmit" onMouseover="ddrivetip('Edit this Discrepancy')"; onMouseout="hideddrivetip()">
												</td>
											</form>
											...
											<td class="formoptionsubmit">
												...
												<input type="hidden" name="summarypage" 		value="<?=$functionsummarypage;?>">
												<input type="hidden" name="printerpage" 		value="<?=$functionprinterpage;?>">
												<input type="hidden" NAME="recordid" ID="recordid" 			value="<?=$objarray[$tblkeyfield];?>">
												<input type="hidden" name="menuitemid" 			value="<?=$strmenuitemid?>">
												<input type="hidden" name="aheadername" 		value="<?=$saheadername;?>">
												<input type="hidden" name="adatafield" 			value="<?=$sadatafield;?>">
												<input type="hidden" name="adatafieldtable" 	value="<?=$sadatafieldtable;?>">
												...
												<input type="hidden" name="tbltextsortfield" 	value="<?=$tbltextsortfield;?>">
												<input type="hidden" name="tbltextsorttable" 	value="<?=$tbltextsorttable;?>">
												<input type="submit" value="S" NAME="b1" ID="b1" class="formsubmit" onMouseover="ddrivetip('Get a Summary of this Discrepancy')"; onMouseout="hideddrivetip()">
												</td>
											</form>
											...
											<td class="formoptionsubmit">
												...
												<input type="hidden" name="tbltextsortfield" 	value="<?=$tbltextsortfield;?>">
												<input type="hidden" name="tbltextsorttable" 	value="<?=$tbltextsorttable;?>">
												<input type="submit" value="R" NAME="b1" ID="b1" class="formsubmit" onMouseover="ddrivetip('Printer Friendly Report of this Discrepancy')"; onMouseout="hideddrivetip()">
												</td>
											</form>
											</tr>
										</table>
								...
								<?
									...
									if (mysqli_connect_errno()) {
											...
											<td class="formoptionsubmit">
												<input type="hidden" NAME="recordid" ID="recordid" 			value="<?=$tmpid;?>">
												<input type="hidden" name="discrepancyid" 		value="<?=$objarray[$tblkeyfield];?>">
												<input type="submit" value="D" NAME="b1" ID="b1" class="formsubmit" alt="Discrepancy is a Duplicate" onMouseover="ddrivetip('Discrepancy is a Duplicate')"; onMouseout="hideddrivetip()">
												</td>
											</form>
														<?	
														}
									...
									if (mysqli_connect_errno()) {
											...
											<td class="formoptionsubmit">
												<input type="hidden" NAME="recordid" ID="recordid" 			value="<?=$tmpid;?>">
												<input type="hidden" name="discrepancyid" 		value="<?=$objarray[$tblkeyfield];?>">
												<input type="submit" value="A" NAME="b1" ID="b1" class="formsubmit" alt="Discrepancy is archived" onMouseover="ddrivetip('Discrepancy is Archived')"; onMouseout="hideddrivetip()">
												</td>
											</form>
														<?	
														}
									...
									if ($discrepancyrepairid == "") {							// There is no repair history. Without being repaired you by definition cant bounce so we give the user the workorder button
											...
											<td class="formoptionsubmit">
												<input type="hidden" NAME="recordid" ID="recordid" 			value="<?=$objarray[$tblkeyfield];?>">
												<input type="submit" value="Work Order" NAME="b1" ID="b1" class="formsubmit" onMouseover="ddrivetip('Discrepancy needs to be repaired click this button to generate a printer friendly workorder for distribution to maintenance crew')"; onMouseout="hideddrivetip()">
												</td>
											</form>
											<?
										}
											...
											<td class="formoptionsubmit">
												<input type="hidden" NAME="recordid" ID="recordid" 			value="<?=$discrepancyrepairid;?>">
												<input type="submit" value="R" NAME="b1" ID="b1" class="formsubmit" alt="Discrepancy is Repaired" onMouseover="ddrivetip('Discrepancy is Repaired')"; onMouseout="hideddrivetip()">
												</td>
											</form>
													<?
												}
											...
											<td class="formoptionsubmit">
												<input type="hidden" NAME="recordid" ID="recordid" 			value="<?=$discrepancybouncedid;?>">
												<input type="submit" value="B" NAME="b1" ID="b1" class="formsubmit" alt="Discrepancy is Bounced" onMouseover="ddrivetip('Discrepancy is Bounced')"; onMouseout="hideddrivetip()">
												</td>
											</form>
											<form style="margin-bottom:0;" action="part139327_sub_d_workorder.php" method="POST" name="reportform" id="reportform" target="PrinterFriendlyWindow" onsubmit="window.open('', 'PrinterFriendlyWindow', 'width=750,height=550,status=no,resizable=no,scrollbars=yes')">
											<td class="formoptionsubmit">s
												<input type="hidden" NAME="recordid" ID="recordid" 			value="<?=$objarray[$tblkeyfield];?>">
												<input type="submit" value="Work Order" NAME="b1" ID="b1" class="formsubmit" alt="Discrepancy needs to be repaired click this button to generate a printer friendly workorder for distribution to maintenance crew" onMouseover="ddrivetip('Discrepancy needs to be repaired click this button to generate a printer friendly workorder for distribution to maintenance crew')"; onMouseout="hideddrivetip()">
												</td>
											</form>
															<?
														}
