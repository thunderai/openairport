				...
				<tr>
					<td align="center" valign="top">
						<table border="0" cellpadding="1" width="90%" id="table1" cellpadding="0" style="border-collapse: collapse">
							...
							$sql2 = $sql2."INNER JOIN tbl_systemusers ON tbl_139_327_sub_d_b.discrepancy_bounced_by_cb_int = tbl_systemusers.emp_record_id ";
							$sql2 = $sql2."WHERE discrepancy_bounced_inspection_id = '".$_POST['recordid']."' AND discrepancy_bounced_archived_yn = 0";
				...
				<tr>
					<td align="center" valign="top">
						<table border="0" cellpadding="1" width="90%" id="table1" cellpadding="0" style="border-collapse: collapse">
							...
							$sql2 = $sql2."INNER JOIN tbl_systemusers ON tbl_139_327_sub_d_r.discrepancy_repaired_by_cb_int = tbl_systemusers.emp_record_id ";
							$sql2 = $sql2."WHERE discrepancy_repaired_inspection_id = '".$_POST['recordid']."' AND discrepancy_repaired_archived_yn = 0 ";
