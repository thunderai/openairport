...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Inventory Access Keys Main Browse.php	The purpose of this page is to list of the Number of different types of keys that are currently in inventory or in a known location.
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "inventory_keys_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";											// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_a_k";										// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_a_k";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "inventory_keys_archived";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Access Keys in Inventory";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "inventory_keys_cb_int";
		$adatafield[1]			= "inventory_keys_cb_count";
		$adatafield[2]			= "inventory_keys_archived";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_inventory_sub_a_k";
		$adatafieldtable[1]		= "tbl_inventory_sub_a_k";
		$adatafieldtable[2]		= "tbl_inventory_sub_a_k";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "inventory_keys_cb_int";
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[1]		= "Please enter the number of keys currently in inventory";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "inventoryaccesskeystypescombobox";
		$adataselect[1]			= "";
		$adataselect[2]			= "";
								...
								<td class="formoptionsavilablebottom">
									<table>
										<tr>
											...
											?>
											<td class="formoptionsubmit" onclick="window.open('openairport_php/part121activity_Distribution.php?startdate=<?=$uifrmstartdate;?>&enddate=<?=$uifrmenddate;?>','Distributionsetupreport','width=550,height=300');">
												&nbsp;Distribution&nbsp;
												</td>
											<td class="formoptionsubmit" onclick="window.open('openairport_php/part121activity_linechart.php?startdate=<?=$uifrmstartdate;?>&enddate=<?=$uifrmenddate;?>','linechartsetupreport','width=550,height=300');">
												&nbsp;Line Chart&nbsp;
												</td>
