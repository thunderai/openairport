...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	News and Events Browse.php			The purpose of this file is to list lost and found items.
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "website_newsandevent_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "website_newsandevent_date";										// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_website_newsandevents";											// What table  is that field part of ?
		$tbltextsortfield		= "website_newsandevent_description";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_website_newsandevents";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "website_newsandevent_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "News and Events";													// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "website_newsandevent_date";
		$adatafield[1]			= "website_newsandevent_topic_by";
		$adatafield[2]			= "website_newsandevent_description";
		$adatafield[3]			= "website_newsandevent_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_website_newsandevents";
		$adatafieldtable[1]		= "tbl_website_newsandevents";
		$adatafieldtable[2]		= "tbl_website_newsandevents";	
		$adatafieldtable[3]		= "tbl_website_newsandevents";
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		= "website_newsandevent_topic_by";
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[1]		= "Select the name of the person making the entry to the right";
		$ainputcomment[2]		= "Enter the content you wish to have displayed";
		$ainputcomment[3]		= "To hide this event from being displayed, click this checkbox";
