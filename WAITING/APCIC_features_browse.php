...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Features Browse.php				The purpose of this file is to list lost and found items.
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "website_features_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";																// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_website_features ";												// What table  is that field part of ?
		$tbltextsortfield		= "website_features_content";											// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_website_features ";												// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "website_features_archieved_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Website Features";													// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "website_features_name";
		$adatafield[1]			= "website_features_icon";
		$adatafield[2]			= "website_features_content";
		$adatafield[3]			= "website_features_linktitle";
		$adatafield[4]			= "website_features_linklocation";
		$adatafield[5]			= "website_features_linkinwindow";
		$adatafield[6]			= "website_features_archieved_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_website_features";
		$adatafieldtable[1]		= "tbl_website_features";
		$adatafieldtable[2]		= "tbl_website_features";
		$adatafieldtable[3]		= "tbl_website_features";
		$adatafieldtable[4]		= "tbl_website_features";	
		$adatafieldtable[5]		= "tbl_website_features";	
		$adatafieldtable[6]		= "tbl_website_features";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Name";
		$aheadername[1]			= "Icon";
		$aheadername[2]			= "Content";
		$aheadername[3]			= "Name of Link";
		$aheadername[4]			= "Link Location";
		$aheadername[5]			= "Link in New Window";
		$aheadername[6]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the name of this feature";
		$ainputcomment[1]		= "Enter the HTTP location of the icon";
		$ainputcomment[2]		= "Enter the Conent for this feature";
		$ainputcomment[3]		= "What should the link to feature say?";
		$ainputcomment[4]		= "Enter the HTTP Location of the link";
		$ainputcomment[5]		= "Should the link open in a new window";
		$ainputcomment[6]		= "Is this feature archived?";
	// what type of input is this field?
		// this can be any type of input
		// text, textarea, select, etc.
		$ainputtype[0]			= "TEXT";
		$ainputtype[1]			= "TEXT";
		$ainputtype[2]			= "TEXTAREA";
		$ainputtype[3]			= "TEXT";
		$ainputtype[4]			= "TEXT";
		$ainputtype[5]			= "CHECKBOX";
		$ainputtype[6]			= "CHECKBOX";
