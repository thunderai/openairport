...
//
//	Purpose of Page			:	View Part 139.339 (c) Linechart
//
...
//	Start Form Set Variables
	...
	// FORM HEADER
	// -----------------------------------------------------------------------------------------\\
			$formname			= "linechart_form";												// HTML Name for Form
			$formaction			= "part139339_c_report_display_linechart_chart.php";			// Page Form will submit information to. Leave valued at '' for the form to point to itself.
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Friction Linechart Loader";									// Name of the FORM, shown to the user
			$form_subh			= "please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Field Condition Reports - Chart Friction";					// Subt title of the FORM, shown to the user
