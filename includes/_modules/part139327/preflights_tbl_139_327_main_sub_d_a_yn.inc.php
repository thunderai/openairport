<?
function preflights_tbl_139_327_main_sub_d_a_yn($recordid,$tblarchivedsort) {
		
		$isarchived = 0;

		$sql2 = "SELECT * FROM tbl_139_327_sub_d_a WHERE discrepancy_archeived_inspection_id = '".$recordid."' ";
		//echo $sql2;
