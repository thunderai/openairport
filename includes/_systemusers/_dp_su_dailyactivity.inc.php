	...
	<tr>
		<td colspan="2" class='formresults'>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="formoptions" width="30">
						ID
						</td>
					<td class="formoptions" width="50">
						When
						</td>
					<td class="formoptions" width="200">
						Log Entry
						</td>
					</tr>
	<?php
		...
		$sql		= "SELECT * FROM tbl_duty_log WHERE duty_log_date = '".date('Y/m/d')."' AND duty_log_archived_yn = 0 ORDER BY duty_log_date, duty_log_time ";
