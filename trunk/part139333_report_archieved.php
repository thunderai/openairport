...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139333_report_archieved.php
//
//	Purpose of Page			:	Enter new Part 139.333 Archieved Report
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Inspection Archieved";									// Name of the FORM, shown to the user
	...
	// DO SQL Work				
		...
		$sql = "INSERT INTO tbl_139_333_main_a (139333_a_inspection_id, 139333_a_by_cb_int, 139333_a_reason, 139333_a_date, 139333_a_time, 139333_a_yn)
		...
		$dutylogevent	= "inspection ID ".$_POST['recordid']." was marked as archieved.";
