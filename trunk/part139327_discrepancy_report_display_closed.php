...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Discrepancy Closed Summary Report";							// Name of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
			$displaysummaryfunction 	= 1;													// 1: Display Summary of Record, 0: Do not show summary
				...
				$detailtodisplay		= 9;													// See Summary Function for how to use this number
	...
	//------------------------------------------------------------------------------------------\\
		...
		$dutylogevent	= "Discrepancy ID ".$_POST['recordid']." closed history was viewed.";
