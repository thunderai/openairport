...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139327_discrepancy_report_error.php
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy with an Error";								// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark the discrepancy with an error";		// Subt title of the FORM, shown to the user
	...
	form_new_control("diserror"		,"Mark Error"	, "Checking this box will mark the discrepancy with an error","Only do this if you are sure the discrepancy is a duplicate","(checked = error)",5,35,4,"current",0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Error - Summary Report";					// Name of the FORM, shown to the user
	...
	form_new_control("diserror"		,"Mark Error"	, "Checking this box will mark the discrepancy with an error"	,"Only do this if you are sure the discrepancy is a duplicate"	,"(checked = error)"		,5,0,4,'post',0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// DO SQL Work		
		...
		VALUES ( '".$_POST['recordid']."', '".$_POST['disauthor']."', '".$_POST['discomments']."', '".$sqldate."', '".$_POST['distime']."', '".$_POST['diserror']."' )";
		...
		$dutylogevent	= "Discrepancy ID ".$_POST['recordid']." was marked with an error.";
