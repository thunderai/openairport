...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139327__report_display_error.php
//
//	Purpose of Page			:	View Part 139.327 Error History
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Inspection Error Summary Report";							// Name of the FORM, shown to the user
			$form_subh			= "Summary Report";												// Sub Name of the FORM, shown to the user
			$subtitle 			= "Here is the information about the selected inpsection";		// Subt title of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
		...
		$dutylogevent	= "Inspectrion ID ".$_POST['recordid']." error history was viewed.";
