...
//	Start Form Set Variables
	...
	form_new_control("disusedfor"		,"Only Current Status"		, "Find by Dates Issued or Dates Closed"	,"Checking this box will use the dates above as issued, unchecked will use dates as closed by"		,""					,5			,50				,0				,"all"					,0);
