<?
function preflights_tbl_139_327_main_sub_d_r_yn($recordid,$tblarchivedsort) {
		
		$isarchived = 0;
		$displayrow	= 0;

		$sql2 = "SELECT * FROM tbl_139_327_sub_d_r WHERE discrepancy_repaired_inspection_id = '".$recordid."' ";
		//echo $sql2;
