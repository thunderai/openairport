...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	part139327_main_browse.php
//
...
// Start Procedures	
	...
	// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		$function_archivedsort		= 'preflights_tbl_139_327_main_a_yn';				// The Name of the function to call to sort out ARCHIEVED Records.
		...
		$array_archivedcontrol		= array("SELECT * FROM tbl_139_327_main_a WHERE inspection_archived_inspection_id = ",	"inspection",	"part139327_report_display_archived.php");
		$array_errorcontrol			= array("SELECT * FROM tbl_139_327_main_e WHERE inspection_error_inspection_id = ",		"inspection",	"part139327_report_display_error.php");
		...
		$function_calendar			= 'part139327_report_calendar.php';					// The URL of the webpage to load to display the Calendar.
		...
		$functionsummarypage 		= "part139327_report_summary.php";					// Name of page used to display a summary of the record
		...
		$functionarchievedepage		= "part139327_report_archieved.php";
		$functionerrorpage			= "part139327_report_error.php";
		$functionbouncepage			= '';
		$functionrepairpage			= '';		
