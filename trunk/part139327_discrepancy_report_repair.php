...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139327_discrepancy_report_repair.php
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Repaired";									// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark a discrepancy Repaired";				// Subt title of the FORM, shown to the user
	...
	form_new_control("discomments","Comments", "Provide information about the repair","Do not use any special characters!","",2,35,4,"",0);
	form_new_control("disrepaired","Mark Repaired", "Checking this box will mark the discrepancy repaired","Only do this if you are sure the discrepancy is a duplicate","(checked = repaired)",5,35,4,"current",0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Repaired - Summary Report";					// Name of the FORM, shown to the user
			$form_subh			= "Here is the information you entered";						// Sub Name of the FORM, shown to the user
			$subtitle 			= "Here is the information about the selected REpaired Report";// Subt title of the FORM, shown to the user
	...
	form_new_control("discomments"	,"Comments"			, "Provide information about the repair"						,"Do not use any special characters!"							,""							,2,0,4,'post',0);
	form_new_control("disrepaired"	,"Mark Repaired"	, "Checking this box will mark the discrepancy repaired"		,"Only do this if you are sure the discrepancy is a duplicate"	,"(checked = repaired)"		,5,0,4,'post',0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// DO SQL Work	
		...
		VALUES ( '".$_POST['recordid']."', '".$_POST['disauthor']."', '".$_POST['discomments']."', '".$sqldate."', '".$_POST['distime']."', '".$_POST['disrepaired']."' )";
		...
		$dutylogevent	= "Discrepancy ID ".$_POST['recordid']." was marked as repaired.";
