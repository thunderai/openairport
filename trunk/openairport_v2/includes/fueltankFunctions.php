...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Fuel Tank Functions.php				The purpose of this page is to load Functions used in theVehicle Module of the system
...
function fueltank_with_eventscomboboxs($suppliedid, $archived, $nameofinput_manufacturer, $nameofinput_model, $showcombobox, $default) {
	...
	$sql = "SELECT * FROM `tbl_inventory_sub_tanks` 
			INNER JOIN tbl_maintenance_sub_t_e 	ON inventory_tanks_id = maintenance_sub_vev_cb_int 
			INNER JOIN tbl_organization_main		ON inventory_tanks_manufac_cb_int = Organizations_id 
			INNER JOIN tbl_maintenance_sub_e		ON mxevent_id = maintenance_sub_vee_cb_int 
			ORDER BY org_name, inventory_tanks_dateinstalled, inventory_tanks_type_cb_int, mxevent_name ";
	...
	<select class="Commonfieldbox" NAME="<?=$nameofinput_manufacturer;?>" SIZE="10" STYLE="width: 380px" ONCHANGE="manuselected(this);" >
								...
								while ($objfields = mysqli_fetch_array($objrs_support, MYSQLI_ASSOC)) {
										...
										if ($sLastManufacturer <> $objfields['inventory_tanks_id'] ) {
												// if so, add an entry to the first listbox
												$sLastManufacturer 	= $objfields['inventory_tanks_id'];
												$sMan 			= $objfields['org_name'];
												$sName 			= $objfields['inventory_tanks_name'];
												$sModel 			= $objfields['inventory_tanks_totalcapacity'];
												$sYear 			= $objfields['inventory_tanks_dateinstalled'];
		...
		<OPTION VALUE="<?=$sLastManufacturer;?>"><?=$sMan;?>&nbsp;<?=$sName;?>&nbsp;<?=$sModel;?>&nbsp;(<?=$sYear;?>)</OPTION>
												...
												$sJavaScript = $sJavaScript."} \n if (elem.options[elem.selectedIndex].value==".$objfields['inventory_tanks_id']."){ \n";
    												}
