...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Fuel Tank Operation Entry.php			The purpose of this page is to enter new vehicle Operations
...
*/	
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[3]			= "inventoryfueltankcombobox";
						...
						case "SELECT":	// if user entered "SELECT" as the input type make a select box
								switch ($aheadername[$i]) {	
										...
										case "F.B.O.":
												...
												break;
										case "Fuel Tank":	
												fueltank_with_eventscomboboxs("all", "all", $adatafield[$i],$adatafield[$i+1], "show", "");
												break;
										default:
