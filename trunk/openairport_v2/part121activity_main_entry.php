...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 121 Activity Operation Entry.php	The purpose of this page is to enter new Part 121 Flight Operations (per month)
...
*/	
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[2]			= "organizationcomboboxgettype";
		$adataselect[3]			= "";
		$adataselect[4]			= "";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Part 121 Monthly Summary Report ID:".$lastid." Was Created";
		
		autodutylogentry($tmpsqldate,$tmpsqltime,$tmpsqlauthor,$dutylogevent);
		
		// Main Record has been added. Now we need to forward the user to the page where they can assoicate aircraft with this record
		?>

			<form name="redirect" action="part121activity_main_summary.php" method="POST">
