...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Requests for Proposals Browse.php		The purpose of this file is to list Requests for Proposals
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "website_RFP_id";													// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "website_RFP_dateadvertised";											// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_website_rfp";													// What table  is that field part of ?
		$tbltextsortfield		= "website_RFP_decription";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_website_rfp";													// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "website_RFP_archieved_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Requests for Proposals";												// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "website_RFP_dateadvertised";
		$adatafield[1]			= "website_RFP_datetoclose";
		$adatafield[2]			= "website_RFP_timetoclose";
		$adatafield[3]			= "website_RFP_name";
		$adatafield[4]			= "website_RFP_decription";
		$adatafield[5]			= "website_RFP_filelocation";
		$adatafield[6]			= "website_RFP_filestructure";
		$adatafield[7]			= "website_RFP_archieved_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_website_rfp";
		$adatafieldtable[1]		= "tbl_website_rfp";
		$adatafieldtable[2]		= "tbl_website_rfp";
		$adatafieldtable[3]		= "tbl_website_rfp";
		$adatafieldtable[4]		= "tbl_website_rfp";
		$adatafieldtable[5]		= "tbl_website_rfp";
		$adatafieldtable[6]		= "tbl_website_rfp";
		$adatafieldtable[7]		= "tbl_website_rfp";
	...
	// what do you want to name the columns
		...
		$aheadername[2]			= "Time";
		$aheadername[3]			= "Name";
		$aheadername[4]			= "Decription";
		$aheadername[5]			= "File Name";
		$aheadername[6]			= "Document Location";
		$aheadername[7]			= "Archieved?";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the date this RFP was requested ( mm/dd/yyyy )";
		$ainputcomment[1]		= "Please enter the date this RFP is scheduled to end ( mm/dd/yyyy )";
		$ainputcomment[2]		= "Please enter the date this RFP is scheduled to end ( mm/dd/yyyy )";
		$ainputcomment[3]		= "Please enter the title for this RFP";
		$ainputcomment[4]		= "Please enter what this RFP is about, when it is due, and why it is needed.";
		$ainputcomment[5]		= "Please enter the location of the file on the computer to upload";
		$ainputcomment[6]		= "Please enter the location of the file on the computer to upload";
		$ainputcomment[7]		= "Has this RFP been canceled or otherwise hidden?";
			...
			<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
				...
				<tr>
					<td class="formoptions" align="center">
						...
						if ($tbldatesort==1) {
								?>
						Start Date <input class="commonfieldbox" type="text" name="frmstartdate" size="10" value="<?=$uifrmstartdate;?>" onchange="javascript:(isdate(this.form.frmstartdate.value,'mm/dd/yyyy'))">
								<?
							}
							else {
								?>
					...
					<td class="formoptions" align="center">
						...
						if ($tbldatesort==1) {
								?>
						End Date <input class="commonfieldbox" type="text" name="frmenddate" size="10" value="<?=$uifrmenddate;?>" onchange="javascript:(isdate(this.form.frmenddate.value,'mm/dd/yyyy'))">
								<?
							}
							else {
								?>
					...
					<td class="formoptions" align="center">
						...
						if ($tbltextsort==1) {
								?>
						Text Like <input class="commonfieldbox" type="text" name="frmtextlike" size="25" value="<?=$frmtextlike;?>">
								<?
							}
							else {
								?>
