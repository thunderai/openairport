...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	nimba_hideallactivity.php
//
...
// Establish Page Name			
		$pagename = 'ADMIN - Hide all System Activity';		
...
<HTML>
	<HEAD>
		<TITLE>
			Transportation Security Administration SSI <?=$pagename;?>
			</TITLE>
...
// Load Saved Search Data
	$sql = "UPDATE tbl_system_activity SET activity_archived_yn = 1 ";
	...
	if (mysqli_connect_errno()) {
			...
			<tr>
				<td class="newTopicNames">
					All System Activity has been removed. You may continue on your way.
					</td>
				</tr>
			<?
