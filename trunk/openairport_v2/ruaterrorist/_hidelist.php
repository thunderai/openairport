...
// Establish Page Name			
		$pagename = 'Hide a Current Person';		
...
// Load Saved Search Data
	$sql = "UPDATE tbl_users_lists SET user_l_archived_yn = 1 WHERE user_l_id = '".$tmp_searchid."' ";
	...
	if (mysqli_connect_errno()) {
			...
			<tr>
				<td class="newTopicNames">
					Selected Person has been deleted. You may continue on your way.
					</td>
				</tr>
			<?
