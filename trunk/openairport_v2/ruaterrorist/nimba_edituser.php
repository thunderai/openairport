...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	nimba_edituser.php
//
//	Purpose of Page		:	FORM SIDE 	- Allows Administrator to edit a users profile
//							SERVER SIDE - Changes the Users data in the database.
//
//==============================================================================================
//3456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789
//		 1		   2		 3		   4		 5		   6		 7		   8	     9	
...
// Establish Page Name			
		$pagename = 'ADMIN - EDIT a Current User';		
...
if ($_POST['formsubmit']!="1") {
		// Not submited
		$sql = "SELECT * FROM tbl_users WHERE user_id = '".$_POST['userid']."' ";
		...
		if (mysqli_connect_errno()) {
				...
				<td colspan="2" class="newTopicNames">
					There was a problem with your request. Please try again or contact the administrator
						...
						while ($objfields = mysqli_fetch_array($objrs_support, MYSQLI_ASSOC)) {		
								?>
			<form action="nimba_edituser.php" METHOD="POST" name="editform">
			...
			if (mysqli_connect_errno()) {
					...
					//echo "FUNCTION is [ ".$function." ]<br><br>";
