...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "inspection_type_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_139_327_sub_t";											// What table  is that field part of ?
		$tbltextsortfield		= "inspection_type";											// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_139_327_sub_t";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "inspection_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Summary of Inspection Types";								// What is the name of the table ? (used on edit/summary/printer report pages)
		...
		$dutylogevent			= "Add New Part 139.327 Inspection Type";															// What will the auto duty log entry say
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "inspection_type";
		$adatafield[1]			= "inspection_type_short_name";
		$adatafield[2]			= "inspection_type_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_327_sub_t";
		$adatafieldtable[1]		= "tbl_139_327_sub_t";
		$adatafieldtable[2]		= "tbl_139_327_sub_t";	
	...
	// what do you want to name the columns
		$aheadername[0]			= "Name (L)";
		$aheadername[1]			= "Name (S)";
