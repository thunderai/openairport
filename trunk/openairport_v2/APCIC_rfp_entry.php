...
*/	
	...
	// what do you want to name the columns
		$aheadername[0]			= "Date";
		$aheadername[1]			= "Date (expected end)";
		$aheadername[2]			= "Time (expected end)";
		$aheadername[3]			= "Name";
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[3]		= "Please enter the title of this RFP";
		$ainputcomment[4]		= "Please enter what this RFP is about, when it is due, and why it is needed.";
		$ainputcomment[5]		= "Please enter a name for the file you will upload";
								...
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<form enctype="multipart/form-data" action="APCIC_rfp_summary.php" method="POST" name="uploaddocument">
												<td class="formanswers">
