...
<HTML>
	<HEAD>
		...
		<title>Manage Field Condition Anomalies</title>
	...
	<tr>
		...
		<td class="tableheadercenter">
			Manage Field Condition Anomalies
			</td>
		<td class="tableheaderright">
			(Add areas of Anomalies to the Field Condition Report)
			</td>
		</tr>
	<tr>
						...
						<table cellspacing="0" width="100%">
							...
							<tr>
								<td class="formoptionsavilablebottom">
									<table>
										<tr>
											<form style="margin-bottom:0;" action="part139339_sub_d_entry.php" method="POST" name="reportform" id="reportform" target="PrinterFriendlyWindow" onsubmit="window.open('', 'PrinterFriendlyWindow', 'width=600,height=600,status=no,resizable=no,scrollbars=yes')">
