...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	part 139.333 Main Browse.php			The purpose of this page is to list all of the Airport Safety Self Inspections, given the search critera.
	
								Usage:
								Customized from the default template in the following ways.
								1). Added Calendar Printout in the options feld
								2). and to allow for archived INNER JOIN
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "139333_id";																		// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "139333_date";																	// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_139_333_main";																// What table  is that field part of ?
		$tbltextsortfield		= "";																				// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_139_333_main";																// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "";																				// What is the name of the field used to mark the record archived ?
		$tblname				= "Part 139.333 Navaid Inspections";												// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functionprinterpage 		= "part139303_main_report.php";													// Name of page used to display a printer friendly report
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "13933_date";
		$adatafield[1]			= "13933_time";
		$adatafield[2]			= "13933_type_cb_int";
		$adatafield[3]			= "13933_by_cb_int";	
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_333_main";
		$adatafieldtable[1]		= "tbl_139_333_main";
		$adatafieldtable[2]		= "tbl_139_333_main";
		$adatafieldtable[3]		= "tbl_139_333_main";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "139_333_type_cb_int";
		$adatafieldid[3]		= "139_333_by_cb_int";
	...
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Date of Inspection (mm/dd/yyyy)";
		$ainputcomment[1]		= "Time of Inspection (in 24 hour format)";
		$ainputcomment[2]		= "Please select the type of Inspection that was conducted";
		$ainputcomment[3]		= "Please select the Inspector of this Inspection";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "";
		$adataselect[2]			= "part139333typescombobox";
								...
								<td class="formoptionsavilablebottom">
									<table>
										<tr>
											...
											?>
											<td class="formoptionsubmit" onclick="window.open('part139303_main_calendar.php?frmurl=<?=$encoded;?>&frmstartdate=<?=$uifrmstartdate ;?>&frmenddate=<?=$uifrmenddate ;?>','printerfriendlyreport','width=750,height=550');">
												&nbsp;Calendar Printout&nbsp;
												</td>
