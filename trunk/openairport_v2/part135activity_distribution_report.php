	...
	//for ($i=1; $i<=$maxcolumns; $i++) {
		$counter = 0;
			...
			if ($displaytypedata==1) {
					...
					$fieldtosearch = 'activity_135_totallandings';
					$chartname	= "Total Landings x10 i.e. 1 = 100";
				}
			if ($displaytypedata==2) {
					//echo $objfields['activity_135_sep'];
					$fieldtosearch = 'activity_135_totallbsout';
					$chartname	= "Lbs. Out x10 i.e. 1 = 100";
				}
			if ($displaytypedata==3) {
					$fieldtosearch = 'activity_135_totallbsin';
					$chartname	= "Lbs. In x10 i.e. 1 = 100";
				}		
			//echo "<br>";
			$sql = "SELECT * FROM tbl_activity_135_main WHERE activity_135_date >= '".$tmpsqlstartdate."' AND activity_135_date <= '".$tmpsqlenddate."' AND ".$fieldtosearch."<'".$tmpi."' AND ".$fieldtosearch.">='".($tmpie)."' ORDER BY activity_135_date";
			//echo $sql."<br><br>";
