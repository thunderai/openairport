...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139 337 Yearend.php			The purpose of this page is to display Wildlife hazard Management Reports
...
*/	
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			="Year";
		$adatafield[1]			="StatePermit";
		$adatafield[2]			="FederalPermit";
	...
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		="StatePermit";
		$adatafieldid[2]		="FederalPermit";
	...
	// Any special comments to make after the input box?
		$ainputcomment[0]		="Please enter the year you would like to see in the Year End Summary Report<br><br><br>This field will default to the previous year";
		$ainputcomment[1]		="Display Species which require a state permit ?<br><br><br>You will most likely want this option checked";
		$ainputcomment[2]		="Display species which require a federal permit ?<br><br><br>You will most likely want this option checked";
...
if (!isset($_POST["formsubmit"])) {
		...
		?>
						<form action="part139337_yearend_report.php" method="post" name="edittable" id="edittable" target="PrinterFriendlyWindow" onsubmit="window.open('', 'PrinterFriendlyWindow', 'width=750,height=550,status=no,resizable=no,scrollbars=yes')">
