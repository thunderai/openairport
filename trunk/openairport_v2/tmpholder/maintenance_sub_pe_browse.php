...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Vehicle Event Data Browse.php		The purpose of this page is to browse Vehicle Events
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "maintenance_sub_ve_id";										// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_maintenance_sub_v_e";									// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_v_e";									// What is the name of the table used for text sorting ?
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "maintenance_sub_vee_cb_int";
		$adatafield[1]			= "maintenance_sub_vev_cb_int";
		$adatafield[2]			= "maintenance_sub_ve_miles";
		$adatafield[3]			= "maintenance_sub_ve_hours";
		$adatafield[4]			= "maintenance_sub_ve_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_v_e";
		$adatafieldtable[1]		= "tbl_maintenance_sub_v_e";
		$adatafieldtable[2]		= "tbl_maintenance_sub_v_e";
		$adatafieldtable[3]		= "tbl_maintenance_sub_v_e";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_v_e";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "maintenance_sub_vee_cb_int";
		$adatafieldid[1]		= "maintenance_sub_vev_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[0]			= "Event";
		$aheadername[1]			= "Vehicle";
		$aheadername[2]			= "Do at Miles";
		$aheadername[3]			= "Do at Hours";
		$aheadername[4]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "( Select from list )";
		$ainputcomment[1]		= "( Select from list )";
		$ainputcomment[2]		= "( No Special Charactors )";
		$ainputcomment[3]		= "( No Special Charactors )";
		$ainputcomment[4]		= "( Checked = Archived )";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "maintenanceeventscombobox";
		$adataselect[1]			= "inventoryvehiclescombobox";
		$adataselect[2]			= "";
