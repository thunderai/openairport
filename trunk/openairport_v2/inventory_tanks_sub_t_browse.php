...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Fuel Tank Types Browse.php			The purpose of this page is to list the different types of fuel tanks
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "tanks_sub_type_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_tanks_sub_t";								// What table  is that field part of ?
		$tbltextsortfield		= "tanks_sub_type_name";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_tanks_sub_t";								// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "tanks_sub_type_archived_yn";									// What is the name of the field used to mark the record archived ?
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "tanks_sub_type_name";
		$adatafield[1]			= "tanks_sub_type_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_inventory_sub_tanks_sub_t";
		$adatafieldtable[1]		= "tbl_inventory_sub_tanks_sub_t";			
