...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Pavement Mx Operations Browse.php		The purpose of this page is to browse Pavement Maintenance Operations
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_pv_o";									// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_sub_vo_work";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_pv_o";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_sub_ve_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Pavement Maintenance Operations Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[5]			= "maintenance_sub_vo_work";
		$adatafield[6]			= "maintenance_sub_vo_problems";
		$adatafield[7]			= "maintenance_sub_vo_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_pv_o";
		$adatafieldtable[1]		= "tbl_maintenance_sub_pv_o";
		$adatafieldtable[2]		= "tbl_maintenance_sub_pv_o";
		$adatafieldtable[3]		= "tbl_maintenance_sub_pv_o";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_pv_o";
		$adatafieldtable[5]		= "tbl_maintenance_sub_pv_o";
		$adatafieldtable[6]		= "tbl_maintenance_sub_pv_o";
		$adatafieldtable[7]		= "tbl_maintenance_sub_pv_o";		
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "Event";
		$aheadername[4]			= "Pavement";
		$aheadername[5]			= "Work";
		$aheadername[6]			= "Problems";
		$aheadername[7]			= "Archived";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[4]			= "pavement_combobox";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
		$adataselect[7]			= "";
