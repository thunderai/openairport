...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.327 Main E Entry.php		The purpose of this page is to enter new errors in inspections information.
...
*/	
	// Load Required Include Files
		...
		$tblname		= "Mark Inspection with an Error";
...
<HTML>
	<HEAD>
		...
		<title>Mark Inspection with an Error</title>
...
if (!isset($_POST["formsubmit"])) {
		...
		$sql = "INSERT INTO tbl_139_327_sub_a (error_out_of_order_inspection_id, error_out_of_order_by_cb_int, error_out_of_order_reason, error_out_of_order_date, error_out_of_order_time, error_out_of_order_yn)
							...
							<tr>
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										<tr>
											<td colspan="2" class="formoptionsavilabletop">
												The Following Inspection was sucsessfully marked with an error in the Database, you may close this window now.
												</td>
											</tr>
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
										...
										<tr>
											...
											<td class="formanswers">
												Disrepancy has been marked with an error
												</td>
											</tr>												
										<tr>
											<td colspan="2" class="formoptionsavilablebottom">
