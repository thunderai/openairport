...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_t_o";									// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_sub_vo_work";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_t_o";									// What is the name of the table used for text sorting ?
	...
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_t_o";
		$adatafieldtable[1]		= "tbl_maintenance_sub_t_o";
		$adatafieldtable[2]		= "tbl_maintenance_sub_t_o";
		$adatafieldtable[3]		= "tbl_maintenance_sub_t_o";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_t_o";
		$adatafieldtable[5]		= "tbl_maintenance_sub_t_o";
		$adatafieldtable[6]		= "tbl_maintenance_sub_t_o";
		$adatafieldtable[7]		= "tbl_maintenance_sub_t_o";		
