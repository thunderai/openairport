...
<HTML>
	<HEAD>
		...
		<title>Add New Part 139.339 Field Condition Anomalies</title>
...
if (!isset($_POST["formsubmit"])) {
		...
		$dutylogevent		= "Added New Field Condition Anomalie ID ".$lastid." for Inspection ID ".$_POST['recordid']."";
