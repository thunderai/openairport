...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139 337 Activity Browse.php		The purpose of this page is to list of the Wildlife Managemet Reports
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbltextsortfield		= "st_p_spurpose_txt";													// What is the name of the field used in text sorting ?
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "st_p_date";
		$adatafield[1]			= "st_p_time";
		$adatafield[2]			= "st_p_chem_1_int";
		$adatafield[3]			= "st_p_chem_2_int";
		$adatafield[4]			= "st_p_bname_txt";
		$adatafield[5]			= "st_p_baddress_txt";
		$adatafield[6]			= "st_p_custname_txt";
		$adatafield[7]			= "st_p_custaddress_txt";
		$adatafield[8]			= "st_p_plocations_txt";
		$adatafield[9]			= "st_p_spurpose_txt";
		$adatafield[10]			= "st_p_totalgallons";
		$adatafield[11]			= "st_p_acrestreated";
		$adatafield[12]			= "st_p_spraylocation_x";
		$adatafield[13]			= "st_p_spraylocation_y";
	...
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "st_p_chem_1_int";
		$adatafieldid[3]		= "st_p_chem_2_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Date";
		$aheadername[1]			= "Time";
		$aheadername[2]			= "Chemical One";
		$aheadername[3]			= "Chemical Two";
		$aheadername[4]			= "Business Name";
		$aheadername[5]			= "Business Address";
		$aheadername[6]			= "Customer Name";
		$aheadername[7]			= "Customer Address";
		$aheadername[8]			= "Locations Treated";
		$aheadername[9]			= "Purpose of Application";
		$aheadername[10]		= "Total Gallons";
		$aheadername[11]		= "Total Acres";
		$aheadername[12]		= "Location X";
		$aheadername[13]		= "Location Y";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the date";
		$ainputcomment[1]		= "Please enter the time";
		$ainputcomment[2]		= "Please select the Chemical Applied";
		$ainputcomment[3]		= "Please select the Chemical Applied";
		$ainputcomment[4]		= "Please enter your business name";
		$ainputcomment[5]		= "Please enter your business address";
		$ainputcomment[6]		= "Please enter your customers name";
		$ainputcomment[7]		= "Please enter your customers address";
		$ainputcomment[8]		= "Please enter the locations treated";
		$ainputcomment[9]		= "Please enter the purpose of the application";
		$ainputcomment[10]		= "Please enter the total gallons applied";
		$ainputcomment[11]		= "Please enter the total acres treated";
		$ainputcomment[12]		= "Please enter the Cords X";
		$ainputcomment[13]		= "Please enter the Cords Y";
	// what type of input is this field?
		...
		$ainputtype[3]			= "SELECT";
		$ainputtype[4]			= "TEXT";
		$ainputtype[5]			= "TEXTAREA";
		$ainputtype[6]			= "TEXT";
		$ainputtype[7]			= "TEXTAREA";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "";
		$adataselect[2]			= "listtypesofchemicals";
				...
				<tr>
					<td>
						<table cellspacing="0" width="100%">
							<tr>
								<td align="left" style="border-left:1px solid #3b5998; border-right:1px solid #3b5998; border-top:1px solid #3b5998; border-bottom:1px dotted #3b5998; font-family: arial narrow; font-size: 10pt; color: #3b5998; background: #ffffff">
						...
						<table border="0" width="100%" id="table1" cellpadding="0" cellspacing="1"  style="border-collapse: collapse">
							...
							<tr>
								...
								for ($i=0; $i<count($aheadername); $i=$i+1) {
										...
										?>
								<?
								if ($aheadername[$i] == "Location X") {
										// We are about to display the cords for some object.
										// Get ready to display the click to display map of it button
										// Also combine two cells together since thats whast logical
										?>
								<td colspan="2" align="center" valign="middle" class="formresults">	
									<INPUT class="formsubmit" TYPE="button" VALUE="View Map" onClick="openChild2('mapit_drawn.php?x=<?=$objarray[$adatafield[$i]];?>&y=<?=$objarray[$adatafield[$i+1]];?>','Win2')">
									</td>
										<?
										}
										?>
