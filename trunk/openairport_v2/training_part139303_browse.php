...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Trainging / Part 139.303 / Browse.php		The purpose of this page is conduct Part 139.303 Training
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_training_139303_main";							// What table  is that field part of ?
		$tbltextsortfield		= "training_subjectmatter";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_training_139303_main";							// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "training_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Part 139.303 Training Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[3]			= "training_student_cb_int";
		$adatafield[4]			= "training_c1_duration";
		$adatafield[5]			= "training_c1_theme_cb_int";
		$adatafield[6]			= "training_c1_topics";
		$adatafield[7]			= "training_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_training_139303_main";
		$adatafieldtable[1]		= "tbl_training_139303_main";	
		$adatafieldtable[2]		= "tbl_training_139303_main";	
		$adatafieldtable[3]		= "tbl_training_139303_main";	
		$adatafieldtable[4]		= "tbl_training_139303_main";
		$adatafieldtable[5]		= "tbl_training_139303_main";
		$adatafieldtable[6]		= "tbl_training_139303_main";
		$adatafieldtable[7]		= "tbl_training_139303_main";
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[3]		= "training_student_cb_int";	
		$adatafieldid[4]		= "justsort";			
		$adatafieldid[5]		= "training_c1_theme_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "Employee";	
		$aheadername[4]			= "Duration";	
		$aheadername[5]			= "Theme";
		$aheadername[6]			= "Topics";
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[3]		= "Please enter the student";
		$ainputcomment[4]		= "Please enter the number of hours in this subject that were taught";
		$ainputcomment[5]		= "Please select the theme of this traing session from the list to the right";
		$ainputcomment[6]		= "Please enter the topics that were covered in this subject area";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[4]			= "";
		$adataselect[5]			= "part139303trainingtypescombobox";
		$adataselect[6]			= "";
		$adataselect[7]			= "";
