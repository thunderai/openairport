...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "vehicles_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_v";									// What table  is that field part of ?
		$tbltextsortfield		= "vehicles_name";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_v";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "vehicles_archived_yn";										// What is the name of the field used to mark the record archived ?
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "vehicles_modelyear";
		$adatafield[1]			= "vehicles_name";
		$adatafield[2]			= "vehicles_modelnumber";
		$adatafield[3]			= "vehicles_type_cb_int";
		$adatafield[4]			= "vehicles_manufac_cb_int";
		$adatafield[5]			= "vehicles_serialnumber_a";
		$adatafield[6]			= "vehicles_serialnumber_b";
		$adatafield[7]			= "vehicles_serialnumber_c";
		$adatafield[8]			= "vehicles_plate";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_inventory_sub_v";
		$adatafieldtable[1]		= "tbl_inventory_sub_v";
		$adatafieldtable[2]		= "tbl_inventory_sub_v";
		$adatafieldtable[3]		= "tbl_inventory_sub_v";
		$adatafieldtable[4]		= "tbl_inventory_sub_v";
		$adatafieldtable[5]		= "tbl_inventory_sub_v";
		$adatafieldtable[6]		= "tbl_inventory_sub_v";
		$adatafieldtable[7]		= "tbl_inventory_sub_v";
		$adatafieldtable[8]		= "tbl_inventory_sub_v";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[3]		= "vehicles_type_cb_int";
		$adatafieldid[4]		= "vehicles_manufac_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[1]			= "Name";
		$aheadername[2]			= "Model Number";
		$aheadername[3]			= "Type";
		$aheadername[4]			= "Manufacturer";
		$aheadername[5]			= "Serial A";
		$aheadername[6]			= "Serial B";
		$aheadername[7]			= "Serial C";
		$aheadername[8]			= "License Number";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[1]			= "";
		$adataselect[2]			= "";
		$adataselect[3]			= "vehicletypescombobox";
