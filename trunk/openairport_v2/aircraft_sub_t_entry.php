...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "aircraft_types_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_aircraft_sub_t";											// What table  is that field part of ?
		$tbltextsortfield		= "aircraft_types_name";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_aircraft_sub_t";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "aircraft_ypes_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Aircraft Types Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "aircraft_types_name";
		$adatafield[1]			= "aircraft_ypes_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_aircraft_sub_t";
		$adatafieldtable[1]		= "tbl_aircraft_sub_t";		
