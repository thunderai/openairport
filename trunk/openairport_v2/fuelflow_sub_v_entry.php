...
*/	
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[2]		= "The Systemuser currently logged in is always set as the default Author of a new record and can not be changed";
		$ainputcomment[3]		= "Select from the list to the right the vehicle you fueled";
		$ainputcomment[4]		= "Select from the list to the right the fuel tank from which you got the fuel";
		$ainputcomment[5]		= "Enter the number of miles on the odometer when you fueled the vehicle";
		$ainputcomment[6]		= "Enter the number of hours on the hobbs meter when you fueled the vehicle. <br> If vehicle does not have an hour meter, enter 0";
		$ainputcomment[7]		= "Enter the total number of gallons fueled into the vehicle";
		$ainputcomment[8]		= "Enter the price per gallon of fuel. <br> For fuel out of airport tanks, enter 1";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Vehicle FuelFlow Operation ".$lastid." Was Created";
		
		autodutylogentry($tmpsqldate,$tmpsqltime,$tmpsqlauthor,$dutylogevent);
		
		$tankid				= $_POST[$adatafield[4]];
		$gallonsexchanged	= ( $_POST[$adatafield[7]] * -1 );
