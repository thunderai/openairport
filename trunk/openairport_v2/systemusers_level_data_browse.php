...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Systemusers Level Data Browse.php		The purpose of this page is to list all of the systemusers access Levles and control edit, and printing of them.
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblarchivedfield	="navigational_groups_archived_yn";
		// what is the name of the main table in this query
		$tbldatesorttable	="tbl_systemusers_ncga";
		...
		$tblname			="System Users (Access Levels)";
	...
	// this is an array of information, from [0] to [...], you may have an unlimited number of columns
		$adatafield[0]		="navigational_user_id_cb_int";
		$adatafield[1]		="navigational_group_id_cb_int";
		$adatafield[2]		="navigational_groups_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]	="tbl_systemusers_ncga";
		$adatafieldtable[1]	="tbl_systemusers_ncga";
		$adatafieldtable[2]	="tbl_systemusers_ncga";
	...
	// the name of any field in any of the selected tables will cause only records that have that information to be displayed.
		$adatafieldid[0]	="navigational_user_id_cb_int";
		$adatafieldid[1]	="navigational_group_id_cb_int";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[1]		="navigationalgroupbox";
		$adataselect[2]		="";
