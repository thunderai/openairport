...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "facility_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_139_327_sub_c_f";											// What table  is that field part of ?
		$tbltextsortfield		= "facility_name";											// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_139_327_sub_c_f";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "facility_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Summary of Inspection Facility Types";								// What is the name of the table ? (used on edit/summary/printer report pages)
		...
		$dutylogevent			= "Add New Part 139.327 Inspection Facility Type";														// What will the auto duty log entry say
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "facility_name";
		$adatafield[1]			= "facility_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_327_sub_c_f";
		$adatafieldtable[1]		= "tbl_139_327_sub_c_f";	
