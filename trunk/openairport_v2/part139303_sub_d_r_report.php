...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139327 Sub D R Report.php		The Printer Report takes a provided sql statement or id and generates the report
...
if (!isset($_POST["sql"])) {																	// Test to see if $_POST['recordid'] exists, and if not do
		...
		$sql = "SELECT * FROM tbl_139_327_sub_d_r WHERE discrepancy_repaired_id = ".$_POST["recordid"]."";						// Add the record id POST value to the sql temporary string
...
<HTML>
	...
	<body>
				...
				<tr>
					...
					<td width="96%" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom-style: solid; border-bottom-width: 1px" height="29">
						<font face="Arial Narrow" size="5">
							Discrepancy Repair Print Report
							</font>
						</td>
					<td width="2%" height="29">&nbsp;</td>
					</tr>
				<tr>
					...
					<td width="96%" height="26">
						...
						<font face="Arial Narrow">
							(Here is a Printer Friendly report of the Repair)
							</font>
						</td>
					<td width="2%" height="26">&nbsp;</td>
					</tr>
		...
		Advanced Record Keeping System (c) 2006</font></td>
			...
			$dutylogevent	= "Printed record id:".$_POST["recordid"]." in table tbl_139_327_sub_d_r";
