...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbltextsorttable		= "tbl_139_303_sub_sa";												// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "";																// What is the name of the field used to mark the record archived ?
		$tblname				= "Student Training Records";											// What is the name of the table ? (used on edit/summary/printer report pages)
		$tblsubname			= "Here is the information you requested";								// What is the subname of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "discrepancy_student_cb_int";
		$adatafield[1]			= "inspection_type_id";
		$adatafield[2]			= "139_303_date";
		$adatafield[3]			= "Discrepancy_by_cb_int";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_303_sub_sa";
		$adatafieldtable[1]		= "tbl_139_303_sub_t";
		$adatafieldtable[2]		= "tbl_139_303_main";
		$adatafieldtable[3]		= "tbl_139_303_sub_sa";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "discrepancy_student_cb_int";
		$adatafieldid[1]		= "inspection_type_id";
		$adatafieldid[2]		= "justsort";
		$adatafieldid[3]		= "Discrepancy_by_cb_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Student";
		$aheadername[1]			= "Type of Training";
		$aheadername[2]			= "Date";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[1]			= "part139303typescombobox";
		$adataselect[2]			= "";
	...
	// The Limiting clauses will be left off, all we want to create at this point is the basic SELECT *,*,* FROM syntax
			...
			$sql = "SELECT * FROM tbl_139_303_sub_sa 
			INNER JOIN tbl_139_303_main ON Discrepancy_inspection_id = 139_303_id 
			INNER JOIN tbl_139_303_sub_t ON 139_303_type_cb_int = inspection_type_id 
			";																	// make it all one nice sql string for use
					...
					<td class="tabledatarow">
						<table border="0" width="100%" id="table1" cellpadding="0" cellspacing="1"  style="border-collapse: collapse">
							...
							<tr>
								...
								?>
								 <td align="center" valign="middle" class="formresults">
									<INPUT class="formsubmit" TYPE="button" VALUE="Attendance" onClick="openChild2('<?=$objarray['139_303_attendance'];?>','Win2')">
									<INPUT class="formsubmit" TYPE="button" VALUE="Sylabus" onClick="openChild2('<?=$objarray['139_303_sylabus'];?>','Win2')">
									</td>
								</tr>
											<?									
											}	// end of looped data
