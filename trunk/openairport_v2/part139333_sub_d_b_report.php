...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139327 Sub D B Report.php		The Printer Report takes a provided sql statement or id and generates the report
...
if (!isset($_POST["sql"])) {																	// Test to see if $_POST['recordid'] exists, and if not do
		...
		$sql = "SELECT * FROM tbl_139_327_sub_d_b WHERE discrepancy_bounced_id = ".$_POST["recordid"]."";						// Add the record id POST value to the sql temporary string
...
<HTML>
	...
	<body>
				...
				<tr>
					...
					<td width="96%" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom-style: solid; border-bottom-width: 1px" height="29">
						<font face="Arial Narrow" size="5">
							Discrepancy Bounce Print Report
							</font>
						</td>
					<td width="2%" height="29">&nbsp;</td>
					</tr>
								...
								?>
										<tr>
											...
											<td class="formanswers">
												<?=$objarray['discrepancy_bounced_date'];?>
												</td>
											</tr>
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
											...
											<td class="formanswers">
												<?=$objarray['discrepancy_bounced_time'];?>
												</td>
											</tr>	
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
											...
											<td class="formanswers">
												<?
												systemusercombobox($objarray['discrepancy_bounced_by_cb_int'], "all", "disauthor", "hide", "");
												?>
												</td>
											</tr>											
										<tr>
		...
		Advanced Record Keeping System (c) 2006</font></td>
			...
			$dutylogevent		= "Printed record id:".$_POST["recordid"]." in table tbl_139_327_sub_d_b";
