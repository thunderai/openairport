...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "activity_135_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "activity_135_date";											// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_activity_135_main";										// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_activity_135_main";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "activity_135_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Part 135 Operations Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functioneditpage 		= "part135activity_main_edit.php";								// Name of page used to edit the record
		$functionsummarypage 	= "part135activity_main_summary.php";							// Name of page used to display a summary of the record
		$functionprinterpage 	= "part135activity_main_report.php";							// Name of page used to display a printer friendly report
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "activity_135_date";
		$adatafield[1]			= "activity_135_author_cb_int";
		$adatafield[2]			= "activity_135_operator_cb_int";
		$adatafield[3]			= "activity_135_totallandings";
		$adatafield[4]			= "activity_135_totallbsin";
		$adatafield[5]			= "activity_135_totallbsout";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_activity_135_main";
		$adatafieldtable[1]		= "tbl_activity_135_main";
		$adatafieldtable[2]		= "tbl_activity_135_main";
		$adatafieldtable[3]		= "tbl_activity_135_main";
		$adatafieldtable[4]		= "tbl_activity_135_main";
		$adatafieldtable[5]		= "tbl_activity_135_main";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		= "activity_135_author_cb_int";
		$adatafieldid[2]		= "activity_135_operator_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "Landings";
		$aheadername[4]			= "Lbs. In";
		$aheadername[5]			= "Lbs. Out";
								...
								<td class="formoptionsavilablebottom">
									<table>
										<tr>
											...
											?>
											<td class="formoptionsubmit" onclick="window.open('openairport_php/part135activity_Distribution.php?startdate=<?=$uifrmstartdate;?>&enddate=<?=$uifrmenddate;?>','Distributionsetupreport','width=550,height=300');">
												&nbsp;Distribution&nbsp;
												</td>
											<td class="formoptionsubmit" onclick="window.open('openairport_php/part135activity_linechart.php?startdate=<?=$uifrmstartdate;?>&enddate=<?=$uifrmenddate;?>','linechartsetupreport','width=550,height=300');">
												&nbsp;Line Chart&nbsp;
												</td>
