...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 135 Activity Browse.php			The purpose of this page is to list of the Duty Logs for printing and editing
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "activity_121_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "activity_121_date";											// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_activity_121_main";										// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_activity_121_main";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "activity_121_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Part 121 Operations Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// What php pages are used to control the summary, printer reports, and edit functions?
		...
		$functionprinterpage 		= "part121activity_main_report.php";									// Name of page used to display a printer friendly report
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "activity_121_date";
		$adatafield[1]			= "activity_121_author_cb_int";
		$adatafield[2]			= "activity_121_operator_cb_int";
		$adatafield[3]			= "activity_121_sdp";
		$adatafield[4]			= "activity_121_sep";
		$adatafield[5]			= "activity_121_nrdp";
		$adatafield[6]			= "activity_121_nrep";
		$adatafield[7]			= "activity_121_avin";
		$adatafield[8]			= "activity_121_avout";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_activity_121_main";
		$adatafieldtable[1]		= "tbl_activity_121_main";
		$adatafieldtable[2]		= "tbl_activity_121_main";
		$adatafieldtable[3]		= "tbl_activity_121_main";
		$adatafieldtable[4]		= "tbl_activity_121_main";
		$adatafieldtable[5]		= "tbl_activity_121_main";
		$adatafieldtable[6]		= "tbl_activity_121_main";
		$adatafieldtable[7]		= "tbl_activity_121_main";
		$adatafieldtable[8]		= "tbl_activity_121_main";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		= "activity_121_author_cb_int";
		$adatafieldid[2]		= "activity_121_operator_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[0]			= "Date";
		$aheadername[1]			= "Entry by";
		$aheadername[2]			= "Operator";
		$aheadername[3]			= "S. Deplanements";
		$aheadername[4]			= "S. Enplanements";
		$aheadername[5]			= "Non-Rev Deplanements";
		$aheadername[6]			= "Non-Rev Enplanements";
		$aheadername[7]			= "Air Feight/VIP In";
		$aheadername[8]			= "Air Feight/VIP Out";
	// Any special comments to make after the input box?
		...
		$ainputcomment[4]		= "( no special charactors )";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "systemusercombobox";
		$adataselect[2]			= "organizationcombobox";
		$adataselect[3]			= "";
		$adataselect[4]			= "";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
								...
								<td class="formoptionsavilablebottom">
									<table>
										<tr>
											...
											?>
											<td class="formoptionsubmit" onclick="window.open('part121activity_Distribution.php?startdate=<?=$uifrmstartdate;?>&enddate=<?=$uifrmenddate;?>','Distributionsetupreport','width=550,height=300');">
												&nbsp;Distribution&nbsp;
												</td>
											<td class="formoptionsubmit" onclick="window.open('part121activity_linechart.php?startdate=<?=$uifrmstartdate;?>&enddate=<?=$uifrmenddate;?>','linechartsetupreport','width=550,height=300');">
												&nbsp;Line Chart&nbsp;
												</td>
								...
								<td align="center" class="formresults">
									<table border="1" width="50" cellspacing="0" id="table1" class="formsubmit cellpadding="0">
										<tr>
											...
											<form style="margin-bottom:0;" action="<?=$functionprinterpage;?>?recordid=<?=$objarray[$tblkeyfield];?>" method="POST" name="reportform" id="reportform" target="PrinterFriendlyWindow" onsubmit="window.open('', 'PrinterFriendlyWindow', 'width=750,height=550,status=no,resizable=no,scrollbars=yes')">
											<td class="formoptionsubmit">
												<input type="hidden" name="editpage" 			value="<?=$functioneditpage;?>">
												<input type="hidden" name="summarypage" 		value="<?=$functionsummarypage;?>">
												<input type="hidden" name="printerpage" 		value="<?=$functionprinterpage;?>">
