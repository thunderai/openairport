...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139303_c__report_display_distribution_loader.php
//
//	Purpose of Page			:	View Part 139.303 c Distribution Chart
//
...
//	Start Form Set Variables
	...
	// -----------------------------------------------------------------------------------------\\
			...
			$formaction			= "part139303_c_report_display_distribution_chart.php";			// Page Form will submit information to. Leave valued at '' for the form to point to itself.
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Topic Distribution Report";									// Name of the FORM, shown to the user
			$form_subh			= "please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Part 139.303 C Training Distribution Report";				// Subt title of the FORM, shown to the user
