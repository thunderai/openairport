...
// Define Variables	
	...
	// Determine which Date Grouping we are using
		...
		displaytxtonreport("DATE", 								1, 2, 13, "left", 	190, 	5, 		32, 11);	
		displaytxtonreport(date('Y-m-d'), 							1, 3, 13, "left", 	190, 	95, 	32, 11);	
		displaytxtonreport("START DATE",	 					1, 2, 13, "left", 	190, 	290, 	32, 11);		
		displaytxtonreport($use_start_date,						1, 2, 13, "left", 	190, 	395, 	32, 11);		
		displaytxtonreport("TIME",								1, 2, 13, "left", 	190, 	5, 		52, 11);		
		displaytxtonreport($tmptime,							1, 2, 13, "left", 	30, 	95, 	52, 11);	
		displaytxtonreport("END DATE",							1, 2, 13, "left", 	190, 	290, 	52, 11);
		displaytxtonreport($use_end_date,						1, 2, 13, "left", 	190, 	395, 	52, 11);		
					...
					while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {
							...
							if($displayrow == 1) {
									...
									if ($tmpcondition=="all") {
										...
										part139339_c_discrepancydisplaybox("Targets Only", 1, 2, 30, "left", 100, $tempX, $tempY, $tmpzindex, $disid, $disname, $disremarks, $disx, $disy);
								}
		...
		<table border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse" borderCOLOR="#000000" width="100%" id="AutoNumber1" />
			<tr>
				<td colspan="2" align="center" valign="middle" align="center" bgcolor="#FFFFFF" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="4" COLOR="#000000" /><b>Map Anomalies</b></font>
					</td>
				</tr>				
			<tr>
				<td colspan="2" align="left" valign="middle" width="100" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="2" COLOR="#000000" /><b>Time Lines </b></font>
					</td>
				</tr>
			<tr>
				<td colspan="2" align="left" valign="middle" width="100" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="2" COLOR="#000000" />
						<?php
						part139339typescomboboxwall($tmpcondition, "all", "all", "hide", "");
						?>
						</font>
					</td>
				</tr>			
