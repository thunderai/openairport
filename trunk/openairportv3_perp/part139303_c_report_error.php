...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139303_c_report_archieved.php
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Report Error";											// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark a report with an error";				// Subt title of the FORM, shown to the user

	// FORM SUMMARY information
	//------------------------------------------------------------------------------------------\\
			$displaysummaryfunction 	= 1;													// 1: Display Summary of Record, 0: Do not show summary
				$summaryfunctionname 	= '_303_c_display_report_summary';						// Function to display the summary, leave as '' if not using the summary function
	...
	form_new_control("disarchive"		,"Mark with Error"			, "Checking this box will mark the discrepancy as archieved","Only do this if you are sure you need to archieve it","(checked = archieved)",5,35,4,"current",0);
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Report Error - Summary Report";				// Name of the FORM, shown to the user
	...
	form_new_control("disarchive"	,"Mark with Error"	, "Checking this box will mark the discrepancy as archieved"	,"Only do this if you are sure you need to archieve it"															,"(checked = archieved)"	,5				,0				,4				,'post'					,0);
	// FORM UNIVERSAL CONTROL LOADING
	//------------------------------------------------------------------------------------------\\
	...
	// DO SQL Work
		...
		$sql = "INSERT INTO tbl_139_303_c_main_e (139303_c_e_inspection_id, 139303_c_e_by_cb_int, 139303_c_e_reason, 139303_c_e_date, 139303_c_e_time, 139303_c_e_yn)
