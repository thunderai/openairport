			...
			if ($objrs) {
					...
					while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {	
							...
							if($displayrow == 1) {
									...
									$location_x		= $objarray['139337_location_x'];
									$location_y 		= $objarray['139337_location_y'];
									
									//$location_x		= convertfromlargescale_to_smallscale_x($objarray['139337_location_x'],$maparray);
									//$location_y 		= convertfromlargescale_to_smallscale_y($objarray['139337_location_y'],$maparray);
									
									
									//echo "Location X ".$location_x."<br>";
									//echo "Location Y ".$location_y."<br>";
									//$location_x		= settype($location_x,'int');
									//$location_y		= settype($location_y,'int');
									
									$record_long 	= ($long0 + $delta_x * $location_x);
									$record_long 	= $record_long * -1;
									$record_lat 	= ($lat0 + $delta_y * $location_y);
									//=(C109+C100*F96)*-1
									//echo $record_long."<br>";
									//echo $record_lat."<br>";
