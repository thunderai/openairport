<?php
function _339_b_301_summaryfunction($systemuser = 0) {
	...
	$sql =" SELECT * FROM tbl_139_339_sub_n WHERE 139339_sub_n_by_cb_int = ".$systemuser." ORDER BY 139339_sub_n_date DESC, 139339_sub_n_time DESC";
		...
		if (mysqli_connect_errno()) {
				...
				if ($objrs) {
						...
						while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {
								...
								$record_date = $objarray['139339_sub_n_date'];
								$record_time = $objarray['139339_sub_n_time'];
							}
					}
			}
