...
//	Start Form Set Variables
	...
	// -----------------------------------------------------------------------------------------\\
			...
			$formaction			= "part139327_discrepancy_report_display_mapit_chart.php";		// Page Form will submit information to. Leave valued at '' for the form to point to itself.
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mapit! Discrepany Location Loader";							// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to map out discrepancy locations";				// Subt title of the FORM, shown to the user
