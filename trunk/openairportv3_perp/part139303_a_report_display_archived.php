...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139303_a_report_display_archieved.php
//
//	Purpose of Page			:	View Part 139.303 (a) Personnel Archieved History
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Personnel Archieved Summary Report";						// Name of the FORM, shown to the user
			$form_subh			= "Summary Report";												// Sub Name of the FORM, shown to the user
			$subtitle 			= "Here is the information about the selected person";		// Subt title of the FORM, shown to the user
