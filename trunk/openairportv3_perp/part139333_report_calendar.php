...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139333_report_calendar.php
//
//	Purpose of Page			:	Display's Part 139.333 Inspections in Calendar Format
//
			...
			// I forget!				
	         ...
	         for($day_counter = 1; $day_counter <= $days_in_this_month; $day_counter++) {
					...
					if (mysqli_connect_errno()) {
							...
							$sql = "SELECT * FROM  tbl_139_333_main WHERE  tbl_139_333_main.139333_date = '".$datetopull."' ORDER BY 139333_time";
							...
							if ($objrs) {
									...
									while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {
										$counter = $counter + 1;
											...
											$tmpdiscrepancyid			= $objarray['139333_main_id'];
											
											$displayrow_a				= preflights_tbl_139_333_main_a_yn($tmpdiscrepancyid,0);
