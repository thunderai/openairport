	...
	if (mysqli_connect_errno()) {
			...
			if ($objrs) {
					...
					while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {	
							...
							displaytxtonreport("Wildlife Hazard Action Report", 	1, 5, 30, "center", 713, 	0, 		0, 	4);	
			...
			<tr>
				...
				<td align="right" valign="middle" bgcolor="#FFFFFF" style="opacity:.7;" />
					&nbsp; <?php echo $objarray['139337_metar'];?>
						...
						$disx		= convertfromlargescale_to_smallscale_x($objarray['139337_location_x'],$maparray);
						$disy		= convertfromlargescale_to_smallscale_y($objarray['139337_location_y'],$maparray);
