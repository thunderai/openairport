...
function buildbreadcrumtrail($menuitemidsupplied,$frmstartdate = '01/01/2000',$frmenddate = '12/31/2010') {
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" height="50" />
		<tr>
			<td class="formresults">
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="50" id="table1" class="formsubmit">
					<tr>
	...
	if (mysqli_connect_errno()) {
			...
			<td class="formresults">
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="50" id="table1" class="formsubmit">
					<tr>
						<td class="formoptionsubmit" onMouseover="ddrivetip('Navigate to <?php echo $layer1name?>')"; onMouseout="hideddrivetip()" />
							<input type="hidden" name="menuitemid" value="<?php echo $layer1sid;?>">
							<a href="#" onclick="javascript:document.menuitemlayer1.submit()">
								<font color="#FFFFFF" size="2" /><?php echo $layer1name?></font>
								</a>
							</td>
						</tr>
					</table>
			...
			<td class="formresults">
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="50" id="table1" class="formsubmit">
					<tr>
						<td class="formoptionsubmit" onMouseover="ddrivetip('Navigate to <?php echo $layer2name?>')"; onMouseout="hideddrivetip()" />
							<input type="hidden" name="menuitemid" value="<?php echo $layer2sid;?>">
							<a href="#" onclick="javascript:document.menuitemlayer2.submit()">
								<font color="#FFFFFF" size="2" /><?php echo $layer2name?></font>
								</a>
							</td>
						</tr>
					</table>
			...
			<td class="formresults">
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="50" id="table1" class="formsubmit">
					<tr>
						<td class="formoptionsubmit" onMouseover="ddrivetip('Navigate to <?php echo $layer3name?>')"; onMouseout="hideddrivetip()" />
							<input type="hidden" name="menuitemid" value="<?php echo $layer3sid;?>">
							<a href="#" onclick="javascript:document.menuitemlayer3.submit()">
								<font color="#FFFFFF" size="2" /><?php echo $layer3name?></font>
								</a>
							</td>
						</tr>
					</table>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%" id="table1" class="formsubmit">
					<tr>
						<td class="formoptionsubmit" onMouseover="ddrivetip('Navigate to <?php echo $layer3name?>')"; onMouseout="hideddrivetip()" />
							...
							<a href="#" onclick="javascript:document.menuitemlayer4.submit()">
								<font color="#FFFFFF" size="2" /><?php echo $layer4name?></font>
								</a>
							</td>
						</tr>
					</table>
