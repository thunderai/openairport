...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	part139337.list.php
//
//	Purpose of Page		:	Lists all Part 139.337 Functions by include.
//
...
//		  1		    2		  3		    4		  5		    6		  7		    7	      8		
	...
	// Load Include Files
			...
			include("_337_combobox_actiontakenwall.inc.php");	
			
			include("_337_displaysummary.inc.php");	
			include("_337_displaybox.inc.php");	
			
			
	// Load PreFlight Files
			include("preflights_tbl_139_337_main_a_yn.inc.php");	
