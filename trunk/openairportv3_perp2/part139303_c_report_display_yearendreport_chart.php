	...
	if (mysqli_connect_errno()) {
		...
		<tr>
			...
			<td align="right" valign="middle">
				...
				//echo "Current Value of Student Time Array [".$ary_student_time[$i].']<br>';
				
				if (!isset($ary_student_time[$i])) {
						// Variable is not set. Push to it
						array_push($ary_student_time, '');
					}
