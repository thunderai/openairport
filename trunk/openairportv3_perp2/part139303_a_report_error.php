...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139303_a_report_error.php
//
//	Purpose of Page			:	Enter new Part 139.303(a) Error Report
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Personnel With Error";									// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark the Person with Error";					// Subt title of the FORM, shown to the user
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Personnel Error Summary";									// Name of the FORM, shown to the user
	...
	// DO SQL Work				
		...
		$sql = "INSERT INTO tbl_139_303_a_main_e (139303_a_e_inspection_id, 139303_a_e_by_cb_int, 139303_a_e_reason, 139303_a_e_date, 139303_a_e_time, 139303_a_e_yn)
