...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	generalsettings.list.php
//
//	Purpose of Page		:	Lists all General Settings Functions by include.
//
...
<?php
	// Load Include Files
			include("_gs_conditions.inc.php");
			include("_gs_conditions_js.inc.php");
			include("_gs_conditions_return.inc.php");
