...
function loadnavmenu_4($whoareyou) {
	...
	if ($whoareyou == '') {
			...
			?>
			<div class="cssplayMenu yellow">
				<ul >
					<li id="home"><a href="index.php"><b>Home</b></a></li>
					<li id="tools"><a href="index.php"><b>Tools</b></a></li>
					<li id="tools"><a href="index.php"><b>Ext.</b></a></li>
			<?php
							...
							if ($layer1menures) {
									...
									while ($layer1array = mysqli_fetch_array($layer1menures, MYSQLI_ASSOC)) {
											...
											if ($nor == 0) {
													...
													?>
					<li  style="margin: 0px; margin-bottom:0px; margin-top:-1px;"><a href="#" onMouseover="ddrivetip('<?php echo $tmpmenulongl1;?>')"; onMouseout="hideddrivetip()"><b><?php echo $tmpmenusshortnl1;?></b></a></li>
													<?php
												} 
												else {
													?>
					<li><a class="sub" style="margin: 0px; margin-bottom:0px; margin-top:-1px;" href="#" onMouseover="ddrivetip('<?php echo $tmpmenulongl1;?>')"; onMouseout="hideddrivetip()"><b><?php echo $tmpmenusshortnl1;?></b><!--[if gte IE 7]><!--></a><!--<![endif]-->
															...
															<li style="<!--[if lte IE 6]>margin-top:-3px;<![endif]-->">
																<form style="margin: 0px; margin-bottom:0px; margin-top:-1px;" name="menuitem<?php echo $tmpmenuitemidl2;?>" method="POST" action="<?php echo $tmpmenuitemlocl2;?>" target="layouttableiframecontent">
																	...
																	<a href="#" onclick="javascript:document.menuitem<?php echo $tmpmenuitemidl2;?>.submit()" onMouseover="ddrivetip('<?php echo $tmpmenulongl2; ?>')"; onMouseout="hideddrivetip()"><?php echo $tmpmenusshortnl2;?></a>
																							...
																							?>
															<li><a class="sub" style="margin: 0px; margin-bottom:0px; margin-top:-1px;" href="#" onMouseover="ddrivetip('<?php echo $tmpmenulongl2;?>')"; onMouseout="hideddrivetip()"><b><?php echo $tmpmenusshortnl2;?></b><!--[if gte IE 7]><!--></a><!--<![endif]-->
															<!--[if lte IE 6]><table><tr><td><![endif]-->
																<ul>
																							<?php
													//	//	//	Loop TWO : Root Structure	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..	..																
																									...
																									<li style="<!--[if lte IE 6]>margin-top:-3px;<![endif]-->">
																										<form style="margin: 0px; margin-bottom:0px; margin-top:-1px;" name="menuitem<?php echo $tmpmenuitemidl3;?>" method="POST" action="<?php echo $tmpmenuitemlocl3;?>" target="layouttableiframecontent">
																											...
																											<a href="#" onclick="javascript:document.menuitem<?php echo $tmpmenuitemidl3;?>.submit()" onMouseover="ddrivetip('<?php echo $tmpmenulongl3; ?>')"; onMouseout="hideddrivetip()"><?php echo $tmpmenusshortnl3;?></a>
																																	...
																																	?>
																									<li><a class="sub" style="margin: 0px; margin-bottom:0px; margin-top:-1px;" href="#" onMouseover="ddrivetip('<?php echo $tmpmenulongl3; ?>')"; onMouseout="hideddrivetip()"><b><?php echo $tmpmenusshortnl3;?></b><!--[if gte IE 7]><!--></a><!--<![endif]-->
																									<!--[if lte IE 6]><table><tr><td><![endif]-->
																										<ul>
																																	<?php
