...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139333_report_error.php
//
//	Purpose of Page			:	Enter new Part 139.333 Error Report
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Inspection with an Error";								// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark the inspection error";					// Subt title of the FORM, shown to the user

	// FORM SUMMARY information
	//------------------------------------------------------------------------------------------\\
			$displaysummaryfunction 	= 1;													// 1: Display Summary of Record, 0: Do not show summary
				$summaryfunctionname 	= '_333_display_report_summary';						// Function to display the summary, leave as '' if not using the summary function
	...
	form_new_control("disarchive"	,"Mark Error"		, "Checking this box will mark the inspection as archieved"	,"Only do this if you are sure you need to archieve it"	,"(checked = archieved)"	,5,0,4,'post',0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// DO SQL Work				
		...
		$sql = "INSERT INTO tbl_139_333_main_a (139333_e_inspection_id, 139333_e_by_cb_int, 139333_e_reason, 139333_e_date, 139333_e_time, 139333_e_yn)
		...
		$dutylogevent	= "inspection ID ".$_POST['recordid']." was marked with an error.";
