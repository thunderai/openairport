...
// Define Variables	
		...
		$tblname		= "Mark Wildlife Report as Archieved";
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Wildlife Hazard Report - Mark Archieved";					// Name of the FORM, shown to the user
			$form_subh			= "please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Please complete the form below is as much detail as possible";// Subt title of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
			$display_submit 		= 1;														// 1: Display Submit Button,	0: No
				$submitbuttonname	= 'Submit Archivial Report';								// Name of the Submit Button
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Wildlife Hazard Report - Archieved Summary";					// Name of the FORM, shown to the user
			$form_subh			= "please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Here is the information you entered";						// Subt title of the FORM, shown to the user
	...
	// DO SQL WORK !!!!!
		...
		$sql = "INSERT INTO tbl_139_337_main_a (139337_a_inspection_id, 139337_a_by_cb_int, 139337_a_reason, 139337_a_date, 139337_a_time, 139337_a_yn)
		...
		$dutylogevent	= "Wildlife Report ID ".$_POST['recordid']." was marked as archieved.";
