...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Archieved";									// Name of the FORM, shown to the user
			$form_subh			= "Please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to mark a discrepancy archieved";				// Subt title of the FORM, shown to the user
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Archieved - Summary Report";				// Name of the FORM, shown to the user
	...
	// DO SQL Work
		...
		$dutylogevent	= "Discrepancy ID ".$_POST['recordid']." was marked as archieved.";
