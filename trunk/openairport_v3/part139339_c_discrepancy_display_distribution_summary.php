...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			...
			$subtitle 			= "Anomaly Report - Summary Actions";						// Subt title of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
			$displaysummaryfunction 	= 1;													// 1: Display Summary of Record, 0: Do not show summary
				$summaryfunctionname 	= 'display_anomaly_summary';						// Function to display the summary, leave as '' if not using the summary function
