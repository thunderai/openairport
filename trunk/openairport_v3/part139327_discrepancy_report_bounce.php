...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139327_discrepancy_report_bounce.php
//
...
//	Start Form Set Variables
	...
	// -----------------------------------------------------------------------------------------\\
			...
			$formaction			= "part139327_discrepancy_report_bounce.php";					// Page Form will submit information to. Leave valued at '' for the form to point to itself.
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Bounced";									// Name of the FORM, shown to the user
			$form_subh			= "please complete the form";									// Sub Name of the FORM, shown to the user
			$subtitle 			= "Use this form to send the discrepancy back to the maintenance department";	// Subt title of the FORM, shown to the user
	...
	form_new_control("disbounced"		,"Mark Bounced"			, "Checking this box will mark the discrepancy bounce","Only do this if you are sure the discrepancy is a duplicate","(checked = bounced)",5,35,4,"current",0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
			$display_submit 		= 1;															// 1: Display Submit Button,	0: No
				$submitbuttonname	= 'Save Bounce Report';											// Name of the Submit Button
	...
	// FORM NAME and Sub Title
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "Mark Discrepancy Bounced - Summary Report";					// Name of the FORM, shown to the user
			$form_subh			= "Here is the information you entered";						// Sub Name of the FORM, shown to the user
			$subtitle 			= "Here is the information about the selected Bounced Report";	// Subt title of the FORM, shown to the user
	...
	form_new_control("disbounced"	,"Mark Bounced"		, "Checking this box will mark the discrepancy as archieved"	,"Only do this if you are sure you need to archieve it"															,"(checked = archieved)"	,5				,0				,4				,'post'					,0);
	//
	// FORM FOOTER
	//------------------------------------------------------------------------------------------\\
	...
	// DO SQL Work
		...
		$sql = "INSERT INTO tbl_139_327_sub_d_b (discrepancy_bounced_inspection_id, discrepancy_bounced_by_cb_int, discrepancy_bounced_comments, discrepancy_bounced_date, discrepancy_bounced_time, discrepancy_bounced_yn)
		VALUES ( '".$_POST['recordid']."', '".$_POST['disauthor']."', '".$_POST['discomments']."', '".$sqldate."', '".$_POST['distime']."', '".$_POST['disbounced']."' )";
		...
		$dutylogevent	= "Discrepancy ID ".$_POST['recordid']." was bounced back to maintenance.";
