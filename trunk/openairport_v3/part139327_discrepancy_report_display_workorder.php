...
if (!isset($_POST["recordid"])) {
	...
	if (mysqli_connect_errno()) {
			...
			if ($objrs) {
					...
					while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {					
							...
							displaytxtonreport("Discrepancy Workorder Form. Please complete entries and return to management.",		1, 1, 50, "right", 	132, 	611, 	33, 12);
	...
	<div style="position:absolute; z-index:13; left:11; top:385; width:300; align="center" />
		<table border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse" borderCOLOR="#000000" width="100%" id="AutoNumber1" />
			...
			<tr>
				<td colspan="2" align="center" valign="middle" align="center" bgcolor="#FFFFFF" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="3" COLOR="#000000" /><b>Work Order Form</b></font>
					</td>
				</tr>
			<tr>
				<td  align="left" valign="middle" width="100" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="2" COLOR="#000000" /><b>Date Completed</b></font>
					</td>	
				<td  align="right" valign="bottom" width="*" align="center" background="images/part_139_327/cellbackground.png" height="25" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					______________________
					</td>					
				</tr>				
			<tr>
				<td  align="left" valign="middle" width="100" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="2" COLOR="#000000" /><b>Time Completed</b></font>
					</td>	
				<td  align="right" valign="bottom" width="*" align="center" background="images/part_139_327/cellbackground.png" height="25" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					______________________
					</td>					
			...
			<tr>
				<td  align="left" valign="middle" width="100" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="2" COLOR="#000000" /><b>Completed By</b></font>
					</td>	
				<td  align="right" valign="bottom" width="*" align="center" background="images/part_139_327/cellbackground.png" height="25" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					______________________
					</td>					
			...
			<tr>
				<td  align="left" valign="middle" width="100" background="images/part_139_327/cellbackground.png" height="15" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					<font size="2" COLOR="#000000" /><b>Remarks</b></font>
					</td>	
				<td  align="right" valign="bottom" width="*" align="center" background="images/part_139_327/cellbackground.png" height="50" style="border-width: 0px;padding: 1px;border-style: none;border-color: gray;-moz-border-radius: ;">
					______________________
					</td>					
				</tr>				
			</table>
					...
					part139327discrepancydisplaybox("Discrepancy Display Box", 1, 2, 30, "left", 150, $tempX, $tempY, $tmpzindex, $disid, $disname, $disremarks, $disx, $disy);
					}
			}
	}
