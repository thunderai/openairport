...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Equipment Operation Entry.php			The purpose of this page is to enter new vehicle Operations
...
*/	
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[4]			= "maintenanceeventscombobox";
		$adataselect[3]			= "inventoryequipmentcombobox";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Maintenance Equipment Operation ID:".$lastid." Was Created";
