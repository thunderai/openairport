...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "fuelflow_t_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "fuelflow_t_date";											// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_fuelflow_sub_t";											// What table  is that field part of ?
		$tbltextsortfield		= "";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_fuelflow_sub_t";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "fuelflow_t_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Fuel Tank Fuel Flow Summary Report";							// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "fuelflow_t_date";
		$adatafield[1]			= "fuelflow_t_time";
		$adatafield[2]			= "fuelflow_t_by_cb_int";
		$adatafield[3]			= "fuelflow_t_fuel_cb_int";
		$adatafield[4]			= "fuelflow_t_fuel_gallons";
		$adatafield[5]			= "fuelflow_t_fuel_costg";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_fuelflow_sub_t";
		$adatafieldtable[1]		= "tbl_fuelflow_sub_t";
		$adatafieldtable[2]		= "tbl_fuelflow_sub_t";
		$adatafieldtable[3]		= "tbl_fuelflow_sub_t";
		$adatafieldtable[4]		= "tbl_fuelflow_sub_t";
		$adatafieldtable[5]		= "tbl_fuelflow_sub_t";
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "fuelflow_t_by_cb_int";
		$adatafieldid[3]		= "fuelflow_t_fuel_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "Tank";
		$aheadername[4]			= "Gallons";
		$aheadername[5]			= "Price (/g)";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent	= "New Fuel Tank FuelFlow Operation ".$lastid." Was Created";
		
		autodutylogentry($tmpsqldate,$tmpsqltime,$tmpsqlauthor,$dutylogevent);
		
		$tankid				= $_POST[$adatafield[3]];
		$gallonsexchanged	= $_POST[$adatafield[4]];
