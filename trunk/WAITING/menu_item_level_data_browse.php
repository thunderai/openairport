...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Menu Item Level Data Browse.php		The purpose of this page is to list all of the menu items Levles and control edit, and printing of them.
...
*/	
	...
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]	="tbl_navigational_control_g_a";
		$adatafieldtable[1]	="tbl_navigational_control_g_a";
		$adatafieldtable[2]	="tbl_navigational_control_g_a";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[1]		="navigationalcombobox";
		$adataselect[2]		="";
