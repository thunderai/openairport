...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Building Operation Browse.php		The purpose of this page is to browse Building Operations
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tbldatesorttable		= "tbl_maintenance_sub_b_o";									// What table  is that field part of ?
		$tbltextsortfield		= "maintenance_sub_vo_work";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_maintenance_sub_b_o";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "maintenance_sub_ve_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Building Events Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_maintenance_sub_b_o";
		$adatafieldtable[1]		= "tbl_maintenance_sub_b_o";
		$adatafieldtable[2]		= "tbl_maintenance_sub_b_o";
		$adatafieldtable[3]		= "tbl_maintenance_sub_b_o";	
		$adatafieldtable[4]		= "tbl_maintenance_sub_b_o";
		$adatafieldtable[5]		= "tbl_maintenance_sub_b_o";
		$adatafieldtable[6]		= "tbl_maintenance_sub_b_o";
		$adatafieldtable[7]		= "tbl_maintenance_sub_b_o";		
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[4]			= "inventoryvuildingscombobox";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
		$adataselect[7]			= "";
