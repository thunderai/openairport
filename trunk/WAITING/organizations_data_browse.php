...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Organizations Data Browse.php		The purpose of this page is to list of the Oranigations
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "Organizations_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_organization_main";										// What table  is that field part of ?
		$tbltextsortfield		= "org_name";													// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_organization_main";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "org_archieved_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Oranizations Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "org_name";
		$adatafield[1]			= "org_type_cb_int";
		$adatafield[2]			= "org_address";
		$adatafield[3]			= "org_phonenumber";
		$adatafield[4]			= "org_faxnumber";
		$adatafield[5]			= "org_email";
		$adatafield[6]			= "org_image";
		$adatafield[7]			= "org_archieved_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_organization_main";
		$adatafieldtable[1]		= "tbl_organization_main";
		$adatafieldtable[2]		= "tbl_organization_main";
		$adatafieldtable[3]		= "tbl_organization_main";
		$adatafieldtable[4]		= "tbl_organization_main";
		$adatafieldtable[5]		= "tbl_organization_main";
		$adatafieldtable[6]		= "tbl_organization_main";
		$adatafieldtable[7]		= "tbl_organization_main";
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[1]		= "org_type_cb_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Name";
		$aheadername[1]			= "Type";
		$aheadername[2]			= "Address";
		$aheadername[3]			= "Phone Number";
		$aheadername[4]			= "Fax Number";
		$aheadername[5]			= "eMail";
		$aheadername[6]			= "Image";
		$aheadername[7]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "No special characters";
		$ainputcomment[1]		= "(select from the list)";
		$ainputcomment[2]		= "No special characters";
		$ainputcomment[3]		= "No special characters";
		$ainputcomment[4]		= "No special characters";
		$ainputcomment[5]		= "No special characters";
		$ainputcomment[6]		= "No special characters";
		$ainputcomment[7]		= "No special characters";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "";
		$adataselect[1]			= "organizationtypescombobox";
		$adataselect[2]			= "";
		$adataselect[3]			= "";
		$adataselect[4]			= "";
		$adataselect[5]			= "";
