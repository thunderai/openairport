			...
			if ($res) {
					...
					while ($objfields = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
							...
							if ($displaytypedata==1) {
									...
									array_push($atabledata, $objfields['activity_121_sep']);
									$chartname	= "Enplanements";
								}
							if ($displaytypedata==2) {
									//echo $objfields['activity_121_sep'];
									array_push($atabledata, $objfields['activity_121_sdp']);
									$chartname	= "Denplanements";
								}
							if ($displaytypedata==3) {
									array_push($atabledata, $objfields['activity_121_nrep']);
									$chartname	= "Non-Rev Enplanements";
								}
							if ($displaytypedata==4) {
									array_push($atabledata, $objfields['activity_121_nrdp']);
									$chartname	= "Non-Rev Denplanements";
								}
							if ($displaytypedata==7) {
									array_push($atabledata, $objfields['activity_121_avin']);
									$chartname	= "AirFrieght In";
								}
							if ($displaytypedata==8) {
									array_push($atabledata, $objfields['activity_121_avout']);
									$chartname	= "AirFrieght Out";
								}
