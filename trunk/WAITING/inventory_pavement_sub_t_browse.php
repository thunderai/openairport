...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Pavement Type Browse.php			The purpose of this page is to browse Pavement Types
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "pavement_sub_type_id";										// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_pv_sub_t";									// What table  is that field part of ?
		$tbltextsortfield		= "pavement_sub_type_name";									// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_pv_sub_t";									// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "pavement_sub_type_archived_yn";								// What is the name of the field used to mark the record archived ?
		$tblname				= "Pavement Type Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "pavement_sub_type_name";
		$adatafield[1]			= "pavement_sub_type_image";
		$adatafield[2]			= "pavement_sub_type_archived_yn";
	...
	// what do you want to name the columns
		...
		$aheadername[0]			= "Type Name";
		$aheadername[1]			= "Image";
		$aheadername[2]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the name of this type of pavement";
		$ainputcomment[1]		= "Please enter the location of the pavement type image";
		$ainputcomment[2]		= "(Checked = Archived)";
