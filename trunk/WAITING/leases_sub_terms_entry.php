...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "leases_terms_id";											// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_leases_terms";											// What table  is that field part of ?
		$tbltextsortfield		= "leases_terms_name";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_leases_terms";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "leases_terms_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Lease Terms Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "leases_terms_name";
		$adatafield[1]			= "leases_terms_archived_yn";
	...
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the name of this lease term";
