...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Inventory vehicles Browse.php		The purpose of this page is to list of the different vehicles
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "property_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_inventory_sub_p";										// What table  is that field part of ?
		$tbltextsortfield		= "property_name";												// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_inventory_sub_p";										// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "property_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Property Summary Report";									// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "property_dateacquired";
		$adatafield[1]			= "property_name";
		$adatafield[2]			= "property_typeofacquisition";
		$adatafield[3]			= "property_acres";
		$adatafield[4]			= "property_remarks";
		$adatafield[5]			= "property_documentnumber";
		$adatafield[6]			= "property_datereleased";
		$adatafield[7]			= "property_type_cb_int";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_inventory_sub_p";
		$adatafieldtable[1]		= "tbl_inventory_sub_p";
		$adatafieldtable[2]		= "tbl_inventory_sub_p";
		$adatafieldtable[3]		= "tbl_inventory_sub_p";
		$adatafieldtable[4]		= "tbl_inventory_sub_p";
		$adatafieldtable[5]		= "tbl_inventory_sub_p";
		$adatafieldtable[6]		= "tbl_inventory_sub_p";
		$adatafieldtable[7]		= "tbl_inventory_sub_p";		
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[7]		= "property_type_cb_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Year Acquired";
		$aheadername[1]			= "Name";
		$aheadername[2]			= "Type of Acquision";
		$aheadername[3]			= "Acres";
		$aheadername[4]			= "Remarks";
		$aheadername[5]			= "Document Number";
		$aheadername[6]			= "Date Released";
		$aheadername[7]			= "Type";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the date the property was acquired";
		$ainputcomment[1]		= "Please enter a name for this property";
		$ainputcomment[2]		= "Please enter the way in which the property was acquired";
		$ainputcomment[3]		= "Please enter the number of acres for the property";
		$ainputcomment[4]		= "Please enter any remarks about the property";
		$ainputcomment[5]		= "Please enter the county document number";
		$ainputcomment[6]		= "Please enter the date in which the property was released";
		$ainputcomment[7]		= "Please select the type of property this is";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[5]			= "";
		$adataselect[6]			= "";
		$adataselect[7]			= "propertytypescombobox";
	...
	// The Limiting clauses will be left off, all we want to create at this point is the basic SELECT *,*,* FROM syntax
		...
		//$sql = "SELECT * FROM ".$tbldatesorttable." ";
