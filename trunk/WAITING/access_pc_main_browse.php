...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document	:	Access Proxy Cards Main Browse.php
//
...
//		  1		    2		  3		    4		  5		    6		  7		    7	      8	
	...
	// what columns should the datagrid display?
		...
		$adatafield[7]			= "access_pc_keytype_cb_int";
		$adatafield[8]			= "access_pc_number";
		$adatafield[9]			= "access_pc_archived_yn";
	// in each array specified above, what table does that field come from?
		...
		$adatafieldtable[9]		= "tbl_access_sub_a_pc";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[7]		= "access_pc_keytype_cb_int";
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[8]		= "If this tranaction is to be archived, click the checkbox";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[5]			= "";
		$adataselect[6]			= "";
		$adataselect[7]			= "inventoryaccesspctypescombobox";
		$adataselect[8]			= "";
		$adataselect[9]			= "";
