				...
				<table cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						<td colspan="4" class="header">
							...
							<?
							// Define SQL
							$sql = "SELECT * FROM tbl_139_303_sub_c WHERE condition_type_cb_int = '".$InspCheckList."' AND condition_archived_yn = 0";
					...
					<tr>
      					<td height="28" class="formresults">
							...
							part139303facilitycombobox($tmpfacility, "all", "notused", "hide", "all");
      					...
      					<td class="formresults" align="center" valign="middle">
      						<input class="commonfieldbox" type="checkbox" name="<?=$tmpd;?>" value="1" CHECKED>
							</td>
						<td class="formresults" align="center" valign="middle">
      						<input class="commonfieldbox" type="text" ID="<?=$tmpe;?>" name="<?=$tmpe;?>" value="1" size="3">
							</td>
						</tr>
												<?
												$i = $i + 1;
