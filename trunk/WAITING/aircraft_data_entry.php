...
*/	
	...
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "( Enter the Name of the aircraft i.e. Cessna 402, etc. )";
		$ainputcomment[1]		= "( Select a type of propulsion from the list to the right )";
		$ainputcomment[2]		= "( Enter the weight of the aircraft in lbs entering only numbers )";
