...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Pavement Layers (parts) Browse.php		The purpose of this page is to browse Pavement Parts (Layers)
...
*/	
	...
	// what columns should the datagrid display?
		...
		$adatafield[6]			= "pavement_sub_dateremoved";
		$adatafield[7]			= "pavement_sub_archived_yn";
	// in each array specified above, what table does that field come from?
		...
		$adatafieldtable[6]		= "tbl_maintenance_sub_pv_p";	
		$adatafieldtable[7]		= "tbl_maintenance_sub_pv_p";	
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[6]		= "Please enter the date this layer was removed";
