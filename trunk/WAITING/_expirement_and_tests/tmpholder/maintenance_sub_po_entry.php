...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Vehicle Operation Entry.php			The purpose of this page is to enter new vehicle Operations
...
*/	
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[3]			= "maintenanceeventscomboboxwall";
...
if (!isset($_POST["formsubmit"])) {
							...
							<tr>
								<td colspan="3" bgcolor="#d8dfea" style="border-left: 1px solid #6d84b4; border-right: 1px solid #6d84b4; border-top-width: 1px; border-bottom: 1px solid #6d84b4; padding: 0" align="center" valign="top">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										<tr>
											<td colspan="2" style="font-family: arial narrow; font-size: 10pt; color: #3b5998; border: 1px solid #3b5998" align="center">
		...
		for ($i=0; $i<count($aheadername); $i=$i+1) {
						...
						case "SELECT":	// if user entered "SELECT" as the input type make a select box
								switch ($aheadername[$i]) {	
										case "Entry by":
												...
												break;								
										case "F.B.O.":
												$adataselect[$i](7, "all", $adatafield[$i], "show", "");
												break;
										default:
				...
				?>
										<tr>
											<td colspan="2" style="font-family: arial narrow; font-size: 10pt; color: #3b5998; border: 1px solid #3b5998" align="right">
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$mysqli = mysqli_connect($hostdomain, $hostusername, $passwordofdatabase, $nameofdatabase);
		//mysql_insert_id();
		...
		$dutylogevent	= "New Maintenance Vehicle Operation ID:".$lastid." Was Created";
