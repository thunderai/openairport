...
*/	
	...
	// This is just the reverse of the previouse step, and although may not be required keeps all of the pages uniform in function and appereance.
		...
		$adataselect[2]			= "organizationcombobox";										// HACK...HACK...HACK...HACK...HACK...HACK...HACK...HACK...HACK
											...
											<td colspan="2">
												<table cellspacing="0" width="100%">
													...
													<tr>
														...
														?>
														<form style="margin-bottom:0;" action="part135activity_sub_a.php" method="POST" name="summaryform" id="summaryform" target="PrinterFriendlyWindow" onsubmit="window.open('', 'PrinterFriendlyWindow', 'width=511,height=550,status=no,resizable=no,scrollbars=yes')">
														...
														<form style="margin-bottom:0;" action="part135activity_main_edit.php" method="POST" name="summaryform" id="summaryform">
														<td class="formoptionsubmit">
															<input type="hidden" name="recordid" 			value="<?=$_POST['recordid'];?>">
															<input type="hidden" name="menuitemid" 			value="<?=$_POST['menuitemid'];?>">
															<input type="hidden" name="editpage" 			value="<?=$functioneditpage;?>">
