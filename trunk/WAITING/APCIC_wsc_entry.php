...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Website Content Entry.php			The purpose of this page is to enter new duty log entries
...
if (!isset($_POST["formsubmit"])) {
		...
		?>
						<form action="<?=$_SERVER["PHP_SELF"];?>" method="post" name="edittable" id="edittable" onsubmit="return submitForm();">
							<script language="JavaScript" type="text/javascript">
								<!--
								function submitForm() {
									//make sure hidden and iframe values are in sync for all rtes before submitting form
									var intCellValue = document.getElementById('rte1').value;
									document.getElementById('website_content_content').value = intCellValue;
									updateRTEs();
						...
						?>
												<script language="JavaScript" type="text/javascript">
													...
													if (!(isset($_POST[$adatafield[$i]]))) {
														...
														$content = rteSafe($_POST[$adatafield[$i]]);
													}
													?>
													rte1.html = '<?=$content;?>';
...
<TEXTAREA class="Commonfieldbox" id="<?=$adatafield[$i];?>" name="<?=$adatafield[$i];?>" rows="10" cols="60"></TEXTAREA>
						<?	
								break;
