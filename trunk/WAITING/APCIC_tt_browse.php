...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "website_tt_id";													// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";																// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_website_traveltips";												// What table  is that field part of ?
		$tbltextsortfield		= "website_tt_name";													// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_website_traveltips";												// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "website_tt_archieved_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Travel Tips";														// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "website_tt_name";
		$adatafield[1]			= "website_tt_archieved_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_website_traveltips";
		$adatafieldtable[1]		= "tbl_website_traveltips";	
	...
	// what do you want to name the columns
		$aheadername[0]			= "Travel Tip";
		$aheadername[1]			= "Arcieved";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "( mm/dd/yyyy )";
		$ainputcomment[1]		= "Should this Travel Tip be hidden?";
