...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Timesheet Months Browse.php			The purpose of this page is to list of Aircraft
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "timesheetmonth_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_timesheets_sub_m";											// What table  is that field part of ?
		$tbltextsortfield		= "timesheetmonth_year";															// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_timesheets_sub_m";											// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "timesheetmonth_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Holiday Summary Report";											// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "timesheetmonth_month_cb_int";
		$adatafield[1]			= "timesheetmonth_year";
		$adatafield[2]			= "timesheetmonth_paystart";
		$adatafield[3]			= "timesheetmonth_payend";
		$adatafield[4]			= "timesheetmonth_has_5_weeks";
		$adatafield[5]			= "timesheetmonth_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_timesheets_sub_m";
		$adatafieldtable[1]		= "tbl_timesheets_sub_m";
		$adatafieldtable[2]		= "tbl_timesheets_sub_m";
		$adatafieldtable[3]		= "tbl_timesheets_sub_m";	
		$adatafieldtable[4]		= "tbl_timesheets_sub_m";	
		$adatafieldtable[5]		= "tbl_timesheets_sub_m";	
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[0]		= "timesheetmonth_month_cb_int";
	...
	// what do you want to name the columns
		$aheadername[0]			= "Timeshet Month";
		$aheadername[1]			= "Year";
		$aheadername[2]			= "Pay Period Start Day";
		$aheadername[3]			= "Pay Period End Day";
		$aheadername[4]			= "5 Week?";
		$aheadername[5]			= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please select from the list to the right, the month this holiday is in";
		$ainputcomment[1]		= "Please enter the year this month belongs in, use four digits";
		$ainputcomment[2]		= "Please enter the day of the month the pay period start on";
		$ainputcomment[3]		= "Please enter the day of the month the pay period ends on, dont worry about the fact that its the next month, just enter the day";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		$adataselect[0]			= "gs_monthscombobox";
		$adataselect[1]			= "";
		$adataselect[2]			= "";
		$adataselect[3]			= "";
		$adataselect[4]			= "";
	...
	<tr>
		<td colspan="3" class="tablesubcontent">
			<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
				...
				is for joined: <input class="combobox" type="text" size="4" name="intfrmjoined" value="<?=$intfrmjoined;?>" >
				string sql: <input class="combobox" type="text" size="40" name="strsqlwhereaddon" value="<?=$strsqlwhereaddon;?>" >
				how many strings: <input class="combobox" type="text" size="4" name="intsqlwhereaddon" id="intsqlwhereaddon" value="<?=$intsqlwhereaddon;?>" >
				<tr>
