...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "training_id";										// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "training_date";															// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_training_sm_main";							// What table  is that field part of ?
		$tbltextsortfield		= "training_subjectmatter";										// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_training_sm_main";							// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "training_archived_yn";									// What is the name of the field used to mark the record archived ?
		$tblname				= "Safety Meetings Summary Report";								// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "training_date";
		$adatafield[1]			= "training_time";
		$adatafield[2]			= "training_by_cb_int";
		$adatafield[3]			= "training_subject";
		$adatafield[4]			= "training_subjectmatter";
		$adatafield[5]			= "training_duration";
		$adatafield[6]			= "training_a1";
		$adatafield[7]			= "training_a2";
		$adatafield[8]			= "training_a3";
		$adatafield[9]			= "training_a4";
		$adatafield[10]			= "training_a5";
		$adatafield[11]			= "training_archived_yn";

	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_training_sm_main";
		$adatafieldtable[1]		= "tbl_training_sm_main";	
		$adatafieldtable[2]		= "tbl_training_sm_main";	
		$adatafieldtable[3]		= "tbl_training_sm_main";	
		$adatafieldtable[4]		= "tbl_training_sm_main";
		$adatafieldtable[5]		= "tbl_training_sm_main";
		$adatafieldtable[6]		= "tbl_training_sm_main";	
		$adatafieldtable[7]		= "tbl_training_sm_main";	
		$adatafieldtable[8]		= "tbl_training_sm_main";	
		$adatafieldtable[9]		= "tbl_training_sm_main";
		$adatafieldtable[10]		= "tbl_training_sm_main";
		$adatafieldtable[11]		= "tbl_training_sm_main";
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "training_by_cb_int";
		$adatafieldid[3]		= "justsort";	
		$adatafieldid[4]		= "justsort";			
		$adatafieldid[5]		= "justsort";
		$adatafieldid[6]		= "training_a1";
		$adatafieldid[7]		= "training_a2";
		$adatafieldid[8]		= "training_a3";
		$adatafieldid[9]		= "training_a4";	
		$adatafieldid[10]		= "training_a5";
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "Subject";	
		$aheadername[4]			= "Subject Matter";	
		$aheadername[5]			= "Duration";
		$aheadername[6]			= "Employee";
		$aheadername[7]			= "Employee";
		$aheadername[8]			= "Employee";	
		$aheadername[9]			= "Employee";	
		$aheadername[10]		= "Employee";
		$aheadername[11]		= "Archived";
	// Any special comments to make after the input box?
		$ainputcomment[0]		= "Please enter the date of the meeting";
		$ainputcomment[1]		= "Please enter the time of the meeting";
		$ainputcomment[2]		= "Please select who taught the meeting";
		$ainputcomment[3]		= "Please enter the subject of the meeting";
		$ainputcomment[4]		= "Please enter the topics covered in the meeting";
		$ainputcomment[5]		= "Please enter how long the meeting lasted";
		$ainputcomment[6]		= "Please select an attendee from the list to the right";
		$ainputcomment[7]		= "Please select an attendee from the list to the right";
		$ainputcomment[8]		= "Please select an attendee from the list to the right";
		$ainputcomment[9]		= "Please select an attendee from the list to the right";
		$ainputcomment[10]		= "Please select an attendee from the list to the right";
		$ainputcomment[11]		= "Checked = Archived";
	// what type of input is this field?
		...
		$ainputtype[2]			= "SELECT";
		$ainputtype[3]			= "TEXT";
		$ainputtype[4]			= "TEXTAREA";
		$ainputtype[5]			= "TEXT";
		$ainputtype[6]			= "SELECT";
		$ainputtype[7]			= "SELECT";
		$ainputtype[8]			= "SELECT";
		$ainputtype[9]			= "SELECT";
		$ainputtype[10]			= "SELECT";
		$ainputtype[11]			= "CHECKBOX";
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[4]			= "";
		$adataselect[5]			= "";
		$adataselect[6]			= "systemusercomboboxwall";
		$adataselect[7]			= "systemusercomboboxwall";
		$adataselect[8]			= "systemusercomboboxwall";
		$adataselect[9]			= "systemusercomboboxwall";
		$adataselect[10]		= "systemusercomboboxwall";
		$adataselect[11]		= "";
...
if (!isset($_POST["formsubmit"])) {
						...
						case "SELECT":	// if user entered "SELECT" as the input type make a select box
								...
								switch ($aheadername[$i]) {	
										case "Entry by":
												...
												break;
										case "Employee":
												$adataselect[$i]("all", 0, $adatafield[$i], "show", "");
												break;														
										case "PAPI":
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$subject	= "Watertown Regional Airport - Safety Meeting Completed";
		$emailbody = "A New Safety Meeting was conducted on ".$_POST[$adatafield[0]]." at ".$_POST[$adatafield[1]]." \n 
		\n 		
		Subject : ".$_POST[$adatafield[3]]." \n 
		\n
		Meeting Topics : ".$_POST[$adatafield[4]]." \n 
		\n
		Class Duration : ".$_POST[$adatafield[5]]." hours \n ";
