...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	System Users Data Browse.php			The purpose of this page is to list of the system users
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblname				= "Systemuser Summary Report";									// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[3]			= "emp_organiation_cb_int";
		$adatafield[4]			= "emp_username";
		$adatafield[5]			= "emp_password";
		$adatafield[6]			= "emp_archieved_yn";
	// in each array specified above, what table does that field come from?
		...
		$adatafieldtable[6]		= "tbl_systemusers";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[3]		= "emp_organiation_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "Organization";
		$aheadername[4]			= "Username";
		$aheadername[5]			= "Password";
	...
	// Any special comments to make after the input box?
		...
		$ainputcomment[4]		= "(case sensitive)";
		$ainputcomment[5]		= "(case sensitive)";
	...
	// Start the Real Fun	
		...
		$i 							= 0;														//just in case we dont define it latter, set a default here.
		$uisize						= "60";														//just in case we dont define it latter, set a default here.
		$tblheadersortfirstselected ="yes";														//just in case we dont define it latter, set a default here.
