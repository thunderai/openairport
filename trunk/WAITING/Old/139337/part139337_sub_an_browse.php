...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "139337_sub_an_id";													// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "";																// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_139_337_sub_an";													// What table  is that field part of ?
		$tbltextsortfield		= "139337_sub_an_name";													// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_139_337_sub_an";													// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "13337_sub_an_archived_yn";											// What is the name of the field used to mark the record archived ?
		$tblname				= "Action Types Summary Report";										// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "139337_sub_an_name";
		$adatafield[1]			= "139337_sub_an_archived_yn";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_139_337_sub_an";
		$adatafieldtable[1]		= "tbl_139_337_sub_an";			
