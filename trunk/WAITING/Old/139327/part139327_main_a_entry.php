...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.327 Main A Entry.php		The purpose of this page is to enter new Discrepancies Archived information.
...
<HTML>
	<HEAD>
		...
		<title>Mark Inspection Archived</title>
...
if (!isset($_POST["formsubmit"])) {
		...
		$sql = "INSERT INTO tbl_139_327_sub_a (archived_inspection_id, archived_by_cb_int, archived_reason, archived_date, archived_time, archived_yn)
							...
							<tr>
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										<tr>
											<td colspan="2" class="formoptionsavilabletop">
												The Following Inspection was sucsessfully archived in the Database, you may close this window now.
												</td>
											</tr>
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
		...
		$dutylogevent		= "Inspection ID ".$_POST['inspectionid']." was archived.";
