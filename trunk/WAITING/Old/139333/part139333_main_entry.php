...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.333 Main Entry.php			The purpose of this page is to enter new Part 139.327 Airport Safety Self Inspections
...
*/	
	...
	$dutylogevent	= "Added New Navaid Inspection";
		...
		//mysql_insert_id();
				...
				if (mysqli_connect_errno()) {
						...
						while ($objfields = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {
							...
							$tmpe			= $tmpstring."ze";														// Value in Field
							$tmpee 			= $tmpstring."zee";
							$tmpeee 		= $tmpstring."zeee";
							...
							$tmpe				= $_POST[$tmpe];
							$tmpe				= $tmpe."/".$_POST[$tmpee]."/".$_POST[$tmpeee]."";
							...
							$sql = "INSERT INTO tbl_139_333_sub_c_c (conditions_checklists_condition_cb_int,conditions_checklists_inspection_cb_int,conditions_checklist_discrepancy_yn,conditions_checklist_hours ) VALUES ( '".$tmpid."', '".$lastid."', '".$tmpvalue."','".$tmpe."' )";
									...
									if (mysqli_connect_errno()) {
										...
										<tr>
											<td class="formresults">
												<?
												part139333facilitycombobox($tmpfacilityid, "all", "notused", "hide", "all");
												?>
												</td>
											<td class="formresults">
												<?=$tmpcondname;?>
												</td>
											<form style="margin-bottom:0;" action="part139333_sub_d.php" method="POST" name="dform" id="dform" target="AddDiscrepancy" onsubmit="window.open('', 'AddDiscrepancy', 'width=550,height=550,status=no,resizable=no,scrollbars=yes')">
											...
											<td colspan="3" align="right">
												<table class="tablesubcontent" width="100%" cellspacing="0" cellpadding="0" border="0" height="32">
													<tr>
														...
														<form style="margin-bottom:0;" action="part139333_main_report.php" method="POST" name="printform" id="printform" target="PrinterFriendlyReport" onsubmit="window.open('', 'PrinterFriendlyReport', 'width=717,height=962,status=no,resizable=no,scrollbars=yes')">
