...
<HTML>
	<HEAD>
		...
		<title>Mark Discrepancy Archived</title>
...
if (!isset($_POST["formsubmit"])) {
		...
		VALUES ( '".$_POST['discrepancyid']."', '".$_POST['disauthor']."', '".$_POST['discomments']."', '".$sqldate."', '".$_POST['distime']."', '".$_POST['disarchive']."' )";
		...
		$dutylogevent	= "Discrepancy ID ".$_POST['discrepancyid']." was archived.";
