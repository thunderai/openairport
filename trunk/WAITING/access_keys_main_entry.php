...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Duty Data Entry.php				The purpose of this page is to enter new duty log entries
...
*/	
	...
	// this information is needed to program the datafields and sql statements on the fly without any user interuption
		...
		$tblkeyfield			= "access_keys_id";												// What is the Auto Increment Field for this table ?
		$tbldatesortfield		= "access_keys_date";												// What is the name of field use in date sorting ?
		$tbldatesorttable		= "tbl_access_sub_a_k";												// What table  is that field part of ?
		$tbltextsortfield		= "";											// What is the name of the field used in text sorting ?
		$tbltextsorttable		= "tbl_access_sub_a_k";												// What is the name of the table used for text sorting ?
		$tblarchivedfield		= "access_keys_archived_yn";										// What is the name of the field used to mark the record archived ?
		$tblname				= "Access Control Key Summary Log";									// What is the name of the table ? (used on edit/summary/printer report pages)
	...
	// what columns should the datagrid display?
		...
		$adatafield[0]			= "access_keys_date";
		$adatafield[1]			= "access_keys_time";
		$adatafield[2]			= "access_keys_by_cb_int";
		$adatafield[3]			= "access_keys_towhom_cb_int";
		$adatafield[4]			= "access_keys_fromwhom_cb_int";
		$adatafield[5]			= "access_keys_numberkeys_in";
		$adatafield[6]			= "access_keys_numberkeys_out";
		$adatafield[7]			= "access_keys_keytype_cb_int";
	// in each array specified above, what table does that field come from?
		$adatafieldtable[0]		= "tbl_access_sub_a_k";
		$adatafieldtable[1]		= "tbl_access_sub_a_k";
		$adatafieldtable[2]		= "tbl_access_sub_a_k";
		$adatafieldtable[3]		= "tbl_access_sub_a_k";
		$adatafieldtable[4]		= "tbl_access_sub_a_k";
		$adatafieldtable[5]		= "tbl_access_sub_a_k";
		$adatafieldtable[6]		= "tbl_access_sub_a_k";
		$adatafieldtable[7]		= "tbl_access_sub_a_k";			
	// do you want the user ot be able to click on the information and have something happen?
		...
		$adatafieldid[2]		= "access_keys_by_cb_int";
		$adatafieldid[3]		= "access_keys_towhom_cb_int";
		$adatafieldid[0]		= "access_keys_fromwhom_cb_int";
		$adatafieldid[1]		= "notjoined";
		$adatafieldid[2]		= "notjoined";
		$adatafieldid[3]		= "access_keys_keytype_cb_int";
	...
	// what do you want to name the columns
		...
		$aheadername[3]			= "Keys To";
		$aheadername[4]			= "Keys From";
		$aheadername[5]			= "# Keys In";
		$aheadername[6]			= "# Keys Out";
		$aheadername[7]			= "Type of Keys";
	// Any special comments to make after the input box?
		...
		$ainputcomment[3]		= "Please select from the list to the right who these keys were given to";
		$ainputcomment[0]		= "Please select from the list to the right who these keys were received from";
		$ainputcomment[1]		= "Please enter the number of keys provided to the person selected";
		$ainputcomment[2]		= "Please enter the number of keys received from the person selected";
		$ainputcomment[3]		= "Please select from the list to the right, the type of keys in the transaction";
	...
	// if the input type is a SELECT type you should define the name of the function you want to call to load into that select statement
		...
		$adataselect[3]			= "systemusercomboboxwall";
		$adataselect[4]			= "systemusercomboboxwall";
		$adataselect[5]			= "";
		$adataselect[6]			= "";
		$adataselect[7]			= "inventoryaccesskeystypescombobox";
...
if (!isset($_POST["formsubmit"])) {
	...
	$sadataselect			= str_replace("\"","|",$sadataselect);									// Dont Touch
		...
		$dutylogevent		= "New Access Key Transaction ID:".$lastid." Was Created";
		autodutylogentry($tmpsqldate,$tmpsqltime,$tmpsqlauthor,$dutylogevent);

		//Now take the information from this entry and make an auto entry related to how this entry went
		//echo $_POST["formsubmit"];
		$tmpsqldate		= AmerDate2SqlDateTime(date('m/d/Y'));
		$tmpsqltime		= date("H:i:s");
		$tmpsqlauthor		= $_SESSION["user_id"];
		$tmpsqltype		= $_POST[$adatafield[7]];
		$tmp_keys			= ($_POST[$adatafield[6]] * -1);
		$tmpsqlnumbkeys		= ($tmp_keys + $_POST[$adatafield[5]]);
		$dutylogevent		= "Auto Entry to adjust the amount of keys in inventory. Total adjusted".$tmpsqlnumbkeys."";
		autoinventoryaccesskeysentry($tmpsqldate,$tmpsqltime,$tmpsqlauthor,$dutylogevent,$tmpsqltype,$tmpsqlnumbkeys);
		?>
