...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.327 D D Entry.php			The purpose of this page is to enter new Discrepancies Duplicate information.
...
*/	
	// Load Required Include Files
		...
		$tblname		= "Mark Discrepancy Archived";
...
<HTML>
	<HEAD>
		...
		<title>Mark Discrepancy Duplicate</title>
...
if (!isset($_POST["formsubmit"])) {
		...
		?>
						<form style="margin-top:-3px;" action="<?=$_SERVER["PHP_SELF"];?>" method="post" name="edittable" id="edittable">
							...
							<input type="hidden" name="discrepancyid" 		value="<?=$_POST['discrepancyid'];?>">
							...
							<tr>
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(Select one from the list)')"; onMouseout="hideddrivetip()">
												Duplicate of
												</td>
											<td class="formanswers">
												<?
												discrepancycombobox("all", "all", "disduplicate", "show", "");
												?>
												</td>
											</tr>
										<tr>
											...
											<td class="formanswers">
												<input type="checkbox" class="commonfieldbox" name="disduplicate" CHECKED value="1">
												</td>
											</tr>												
										<tr>
		...
		VALUES ( '".$_POST['discrepancyid']."', '".$_POST['disauthor']."', '".$_POST['discomments']."', '".$sqldate."', '".$_POST['distime']."', '".$_POST['disduplicate']."', '".$_POST['disduplicate']."' )";
							...
							<tr>
								<td colspan="3" class="tablesubcontent">
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										<tr>
											<td colspan="2" class="formoptionsavilabletop">
												The Following Discrepancy was sucsessfully marked as a duplicate in the Database, you may close this window now.
												</td>
											</tr>
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
										...
										<tr>
											...
											<td class="formanswers">
												<?
												discrepancycombobox($_POST['disduplicate'], "all", "disauthor", "hide", "");
												?>
												</td>
											</tr>	
										<tr>
		...
		$dutylogevent	= "Discrepancy ID ".$_POST['discrepancyid']." was marked as duplicate.";
