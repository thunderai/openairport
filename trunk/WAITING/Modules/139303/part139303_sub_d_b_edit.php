...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.327 D B Edit.php			The purpose of this page is to edit bounce history of a discrepancy
	
								Usage:
								For use only with pat139327_sub_d_b.php
...
*/	
	// Load Required Include Files
		...
		$sql = "SELECT * FROM tbl_139_327_sub_d_b ";
...
<HTML>
	<HEAD>
		...
		<title>Edit Discrepancy Bounce History</title>
...
if (!isset($_POST["recordid"])) {
		...
		// Connect to Database
		$nsql =" WHERE discrepancy_bounced_id = ".$_POST["recordid"]."";
									...
									<table border="0" width="100%" cellspacing="3" cellpadding="5" id="table2" height="10">
										...
										<tr>
											...
											<td class="formanswers">
												<?
												$uidate = sqldate2amerdate($objarray['discrepancy_bounced_date']);
												?>											
										...
										<tr>
											...
											<td class="formanswers">
												<input class="Commonfieldbox" type="text" name="distime" size="10" value="<?=$objarray['discrepancy_bounced_time'];?>">
												</td>
											</tr>	
										<tr>
											<td align="center" valign="middle" class="formoptions" onMouseover="ddrivetip('(no special charactors)')"; onMouseout="hideddrivetip()">
											...
											<td class="formanswers">
												<?
												systemusercombobox("all", "all", "disauthor", "show", $objarray['discrepancy_bounced_by_cb_int']);
												?>
												</td>
											</tr>											
										<tr>
											...
											<td class="formanswers">
												<TEXTAREA class="Commonfieldbox" name="discomments" rows="10" cols="60"><?=$objarray['discrepancy_bounced_comments'];?></TEXTAREA>
												</td>
											</tr>
										<tr>
											...
											<td class="formanswers">
												...
												<?
												if ($objarray['discrepancy_bounced_yn'] == 1) {
													?>
													CHECKED
													<?
													}
										...
										<tr>
											...
											<td class="formanswers">
												...
												<?
												if ($objarray['discrepancy_bounced_archived_yn'] == 1) {
													?>
													CHECKED
													<?
													}
		...
		$sql = "UPDATE tbl_139_327_sub_d_b SET ";
		
		if (!isset($_POST['disarchived'])) {
				//variable not set
				}
			else {
				$sql = $sql."discrepancy_bounced_archived_yn='".$_POST['disarchived']."', ";
			}
			
		$sql = $sql."discrepancy_bounced_by_cb_int='".$_POST['disauthor']."', discrepancy_bounced_comments='".$_POST['discomments']."', discrepancy_bounced_date='".$sqldate."', discrepancy_bounced_time='".$_POST['distime']."' WHERE discrepancy_bounced_id = ".$_POST['recordid']." ";
		...
		$dutylogevent	= "Made Changed to a Discrepancy Bounce Record for Discrepancy ID ".$_POST['recordid'];
