...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 139.327 Sub_D_R.php			The purpose of this page is to manage discrepancies that are repaired, and why
...
*/	
	// Load Required Include Files
		...
		$tblname	= "Discrepancy Repaired History";
...
<HTML>
	<HEAD>
		...
		<title>Discrepancy Repaired History</title>
	...
	<body>
			...
			<?
						...
						//make connection to database
						$sql = "SELECT * FROM tbl_139_327_sub_d_r WHERE discrepancy_repaired_inspection_id = '".$_POST['recordid']."' AND discrepancy_repaired_archived_yn = '0'";
									...
									<table cellspacing="0" width="100%">
										...
										<tr>
											<td class="formoptionsavilablebottom">
												<table>
													<tr>
														<form style="margin-bottom:0;" action="part139327_sub_d_r_entry.php" method="POST" name="addform" id="addform" target="AddRecordWindow" onsubmit="window.open('', 'AddRecordWindow', 'width=600,height=510,status=no,resizable=no,scrollbars=yes')">
														<td class="formoptionsubmit">
															<input type="hidden" name="did" 				value="<?=$_POST['recordid'];?>">
															<input type="submit" value="Add New Repair" name="b1" class="formsubmit">
															</td>
															</form>
									...
									<table border="0" width="100%" id="table1" cellpadding="0" cellspacing="1"  style="border-collapse: collapse">
										...
										<tr>
											<td height="32" align="center" class="formresults">
												<?=$objarray['discrepancy_repaired_id'];?>
												</td>
											<td align="center" class="formresults">
												<table border="1" width="50" cellspacing="0" id="table1" class="formsubmit cellpadding="0">
													<tr>
														<form style="margin-bottom:0;" action="part139327_sub_d_r_edit.php" method="POST" name="editform" id="editform" target="EditRecordWindow" onsubmit="window.open('', 'EditRecordWindow', 'width=600,height=550,status=no,resizable=no,scrollbars=yes')">
														<td class="formoptionsubmit">
															<input type="hidden" name="recordid" 			value="<?=$objarray['discrepancy_repaired_id'];?>">
															<input type="hidden" name="did" 				value="<?=$_POST['recordid'];?>">
															<input type="submit" value="E" name="b1" class="formsubmit">
															</td>
														</form>
														<form style="margin-bottom:0;" action="part139327_sub_d_r_summary.php" method="POST" name="summaryform" id="summarytform" target="SummaryRecordWindow" onsubmit="window.open('', 'SummaryRecordWindow', 'width=600,height=550,status=no,resizable=no,scrollbars=yes')">
														<td class="formoptionsubmit">
															<input type="hidden" name="recordid" 			value="<?=$objarray['discrepancy_repaired_id'];?>">
															<input type="hidden" name="did" 				value="<?=$_POST['recordid'];?>">
														...
														<form style="margin-bottom:0;" action="part139327_sub_d_r_report.php" method="POST" name="reportform" id="reportform" target="ReportRecordWindow" onsubmit="window.open('', 'ReportRecordWindow', 'width=750,height=550,status=no,resizable=no,scrollbars=yes')">
														<td class="formoptionsubmit">
															<input type="hidden" name="recordid" 			value="<?=$objarray['discrepancy_repaired_id'];?>">
															<input type="hidden" name="did" 				value="<?=$_POST['recordid'];?>">
