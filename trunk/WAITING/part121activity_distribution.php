...
/*	= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	...
	Page Name						Purpose :
	Part 121 Activity Distribution.php		The purpose of this page is to view activity in a Distribution format according to specified data
...
*/	
	// Load Required Include Files
		...
		$tblname			= "Part 121 Activity Distribution";
...
if (!isset($_POST["formsubmit"])) {
		...
		?>
		<form name="Show" action="part121activity_distribution_report.php" method="POST" name="linechartform" id="linechartform" target="linechartWindow" onsubmit="window.open('', 'linechartWindow', 'width=750,height=550,status=no,resizable=yes,scrollbars=yes')">
