...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139339_b_report_display_archieved.php
//
//	Purpose of Page			:	View Part 139.339 (b) NOTAM Archieved History
//
...
//	Start Form Set Variables
	...
	//------------------------------------------------------------------------------------------\\
			$form_menu			= "NOTAM Report - Archieved Summary";							// Name of the FORM, shown to the user
	...
	//------------------------------------------------------------------------------------------\\
		...
		$dutylogevent	= "NOTAM Report Archieved Record ID ".$_POST['recordid']." summary was viewed.";
