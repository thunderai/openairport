...
function preflights_tbl_139_327_main_a_yn($recordid,$tblarchivedsort) {

		$isarchived = 0;

		$sql2 = "SELECT * FROM tbl_139_327_main_a WHERE inspection_archived_inspection_id = '".$recordid."' ";
