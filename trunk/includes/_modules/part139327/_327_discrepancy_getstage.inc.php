...
function part139327discrepancy_getstage($discrepancy_id,$inspection_date = 0, $inspection_time = 0, $array_workorder = 0,$detail) {
	...
	// OUTPUT	
		...
		if($detail == 1) {
				...
				$tablename	= 'discrepancy';
				$sql2		= "SELECT * FROM tbl_139_327_sub_d_r WHERE discrepancy_repaired_inspection_id = '".$discrepancy_id."' AND discrepancy_repaired_date <= '".$inspection_date."' AND discrepancy_repaired_time <= '".$inspection_time."' ORDER BY discrepancy_repaired_date, discrepancy_repaired_time";
		...
		if($detail == 1) {
				// Work from a known Inspection Date and Time
				$tablename	= 'discrepancy';
				$sql2 		= "SELECT * FROM tbl_139_327_sub_d_b WHERE discrepancy_bounced_inspection_id = '".$discrepancy_id."' AND discrepancy_bounced_date <= '".$inspection_date."' AND discrepancy_bounced_time <= '".$inspection_time."' ORDER BY discrepancy_bounced_date, discrepancy_bounced_time";
