	...
	if (mysqli_connect_errno()) {
			...
			if ($objrs) {
					...
					while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {	
							...
							displaytxtonreport("Discrepancy Information", 			1, 5, 30, "center", 713, 	0, 		0, 	4);	
							...
							displaytxtonreport("Here is the Discrepancy Record you requested. All information is aviable here to review.",		1, 1, 50, "right", 	132, 	611, 	33, 12);
							?>
