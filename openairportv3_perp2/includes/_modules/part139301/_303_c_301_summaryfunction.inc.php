<?php
function _303_c_301_summaryfunction($systemuser = 0) {
	...
	$sql =" SELECT * FROM tbl_139_303_c_main WHERE 139_303_by_cb_int = ".$systemuser." ORDER BY 139_303_date DESC, 139_303_time DESC";
		...
		if (mysqli_connect_errno()) {
				...
				if ($objrs) {
						...
						while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {
								...
								$record_date = $objarray['139_303_date'];
								$record_time = $objarray['139_303_time'];
							}
					}
			}
