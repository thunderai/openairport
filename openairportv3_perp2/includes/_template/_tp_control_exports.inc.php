...
//
	...
	$function_fprintout	= $array_settings[8][0];
	$function_fpo_url 	= $array_settings[8][1];
	$function_fpo_page 	= $array_settings[8][2];
	$function_fpo_lang 	= $array_settings[8][3];
	...
	if ($function_fprintout != '') {
			
			$fieldname 			= 'fprintout';
			$function_cal 		= $function_fprintout;
			$function_cal_icon 	= 'icon_report';
			$function_url 		= $function_fpo_url;
			$function_page 		= $function_fpo_page;
