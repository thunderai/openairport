										...
										$counter = $counter + 1;
											...
											if ($displayrow == 1) {
													$innercell = $innercell."<tr>
																				<form style='margin-bottom:0;float:left;' action='part139327_report_display_new.php' method='POST' name='reportform' id='reportform' target='DiscrepancyWindow' onsubmit='window.open('', 'DiscrepancyWindow', 'width=800,height=600,status=no,resizable=no,scrollbars=yes')'>
