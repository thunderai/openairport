...
// Start Procedures	
	...
	// Setup Function	
		...
		function calendar($date) {
	         ...
	         $calendar_html = $calendar_html."<tr>	<td class='perp_report_header' colspan=\"7\" align=\"center\"> Month: ".$month_name." / Year: ".$year."</td>
													</tr>";
			...
			// I forget!				
	         ...
	         for($day_counter = 1; $day_counter <= $days_in_this_month; $day_counter++) {
					...
					if (mysqli_connect_errno()) {
							...
							$sql = "SELECT * FROM tbl_139_327_sub_d WHERE Discrepancy_date = '".$datetopull."' ORDER BY Discrepancy_time";
										...
										$counter = $counter + 1;
											...
											if ($displayrow == 1) {
													$innercell = $innercell."<tr>
																				<form style='margin-bottom:0;' action='part139327_discrepancy_report_display.php' method='POST' name='reportform' id='reportform' target='DiscrepancyWindow' onsubmit='window.open('', 'DiscrepancyWindow', 'width=800,height=600,status=no,resizable=no,scrollbars=yes')'>
																				<td colspan='2' class='perp_report_subheaderubmit'>
