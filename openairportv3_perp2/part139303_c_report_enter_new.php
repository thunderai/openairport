...
if (!isset($_POST["formsubmit"])) {
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblbrowseformtable" />
		...
		$sql = "SELECT * FROM tbl_139_303_c_sub_c 
				...
				ORDER BY tbl_139_303_c_sub_c_f.facility_id, tbl_139_303_c_sub_c.condition_type_order_int, tbl_139_303_c_sub_c.condition_name";
