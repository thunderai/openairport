...
for ($i = 1; $i <=$length; $i++) {
							...
							<td height="<?php echo $max;?>" width="35" align="left" valign="bottom">
									...
									?>
									<img src="images/Part_139_339/barchart_04.png" width="35" height="<?php echo $graph_array[$i][2];?>" alt="<?php echo $graph_array[$i][0];?>,<?php echo $graph_array[$i][1];?>(<?php echo $graph_array[$i][2];?>) minutes" />
