...
//	~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//	
//	Name of Document		:	part139339_c_report_calendar.php
//
//	Purpose of Page			:	Display's Part 139.339 c in Calendar Format
//
			...
			// I forget!				
	         ...
	         for($day_counter = 1; $day_counter <= $days_in_this_month; $day_counter++) {
					...
					if (mysqli_connect_errno()) {
							...
							$sql = "SELECT * FROM tbl_139_339_main WHERE tbl_139_339_main.139339_date = '".$datetopull."' ORDER BY 139339_time";
							...
							if ($objrs) {
									...
									while ($objarray = mysqli_fetch_array($objrs, MYSQLI_ASSOC)) {
										$counter = $counter + 1;
											...
											$tmpdiscrepancyid			= $objarray['139339_main_id'];
											
											$displayrow_a				= preflights_tbl_139_339_sub_n_a_yn($tmpdiscrepancyid,0);
